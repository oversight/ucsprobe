...
PROPERTY_DICT = {
	...
	"CpuId":UcsPropertyMeta("CpuId", "cpuId", "uint", _VersionMeta.Version101e, UcsPropertyMeta.ReadOnly, None, None, None, None, [], ["0-4294967295"]),
	"CurrCapacity":UcsPropertyMeta("CurrCapacity", "currCapacity", "string", _VersionMeta.Version101e, UcsPropertyMeta.ReadOnly, None, None, None, None, ["unspecified"], ["0-4294967295"]),
	"Dn":UcsPropertyMeta("Dn", "dn", "string", _VersionMeta.Version101e, UcsPropertyMeta.ReadOnly, 0x2L, 0, 256, None, [], ["0-4294967295"]),
	"ErrorCorrection":UcsPropertyMeta("ErrorCorrection", "errorCorrection", "string", _VersionMeta.Version101e, UcsPropertyMeta.ReadOnly, None, None, None, None, ["CRC", "multi-bit-ECC", "none", "other", "parity", "single-bit-ECC", "undiscovered", "unknown"], ["0-4294967295"]),
	...
	"MaxCapacity":UcsPropertyMeta("MaxCapacity", "maxCapacity", "string", _VersionMeta.Version101e, UcsPropertyMeta.ReadOnly, None, None, None, None, ["unspecified"], ["0-4294967295"]),
	"MaxDevices":UcsPropertyMeta("MaxDevices", "maxDevices", "string", _VersionMeta.Version101e, UcsPropertyMeta.ReadOnly, None, None, None, None, ["unspecified"], ["0-4294967295"]),
	...
	"Populated":UcsPropertyMeta("Populated", "populated", "string", _VersionMeta.Version101e, UcsPropertyMeta.ReadOnly, None, None, None, None, ["unspecified"], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("MemoryArray", "memoryArray", "memarray-[Id]", _VersionMeta.Version101e, "InputOutput", 0x1fL, [], [u'faultInst', u'memoryArrayEnvStats', u'memoryUnit'], ["Get"], ["read-only"])
}
