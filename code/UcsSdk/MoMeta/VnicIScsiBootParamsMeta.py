...
PROPERTY_DICT = {
	...
	"Meta":UcsMoMeta("VnicIScsiBootParams", "vnicIScsiBootParams", "iscsi-boot-params", _VersionMeta.Version211a, "InputOutput", 0x3fL, [], [u'vnicIScsiBootVnic'], ["Add", "Get", "Remove", "Set"], ["admin", "ls-compute", "ls-config", "ls-network", "ls-server", "ls-storage"])
}
