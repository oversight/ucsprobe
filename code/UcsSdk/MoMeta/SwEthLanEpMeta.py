...
PROPERTY_DICT = {
	"AdminSpeed":UcsPropertyMeta("AdminSpeed", "adminSpeed", "string", _VersionMeta.Version111j, UcsPropertyMeta.ReadOnly, None, None, None, None, ["10gbps", "1gbps", "20gbps", "40gbps", "indeterminate"], ["0-4294967295"]),
	...
	"PcId":UcsPropertyMeta("PcId", "pcId", "uint", _VersionMeta.Version101e, UcsPropertyMeta.ReadOnly, None, None, None, None, [], ["0-4294967295"]),
	...
	"PortId":UcsPropertyMeta("PortId", "portId", "uint", _VersionMeta.Version101e, UcsPropertyMeta.Naming, 0x10L, None, None, None, [], ["0-4294967295"]),
	"PriorityFlowCtrl":UcsPropertyMeta("PriorityFlowCtrl", "priorityFlowCtrl", "string", _VersionMeta.Version101e, UcsPropertyMeta.ReadOnly, None, None, None, None, ["auto", "on"], ["0-4294967295"]),
	"RecvFlowCtrl":UcsPropertyMeta("RecvFlowCtrl", "recvFlowCtrl", "string", _VersionMeta.Version101e, UcsPropertyMeta.ReadOnly, None, None, None, None, ["off", "on"], ["0-4294967295"]),
	"Rn":UcsPropertyMeta("Rn", "rn", "string", _VersionMeta.Version101e, UcsPropertyMeta.ReadOnly, 0x20L, 0, 256, None, [], ["0-4294967295"]),
	"SendFlowCtrl":UcsPropertyMeta("SendFlowCtrl", "sendFlowCtrl", "string", _VersionMeta.Version101e, UcsPropertyMeta.ReadOnly, None, None, None, None, ["off", "on"], ["0-4294967295"]),
	"SlotId":UcsPropertyMeta("SlotId", "slotId", "uint", _VersionMeta.Version101e, UcsPropertyMeta.Naming, 0x40L, None, None, None, [], ["0-4294967295"]),
	...
	"UdldAdminState":UcsPropertyMeta("UdldAdminState", "udldAdminState", "string", _VersionMeta.Version221b, UcsPropertyMeta.ReadOnly, None, None, None, None, ["disabled", "enabled"], ["0-4294967295"]),
	"UdldMode":UcsPropertyMeta("UdldMode", "udldMode", "string", _VersionMeta.Version221b, UcsPropertyMeta.ReadOnly, None, None, None, None, ["aggressive", "normal"], ["0-4294967295"]),
	"Meta":UcsMoMeta("SwEthLanEp", "swEthLanEp", "ep-slot-[SlotId]port-[PortId]", _VersionMeta.Version101e, "InputOutput", 0xffL, [], [u'swVlan'], ["Get"], ["read-only"])
}
