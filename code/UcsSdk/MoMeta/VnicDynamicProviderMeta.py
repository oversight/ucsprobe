...
PROPERTY_DICT = {
	...
	"Meta":UcsMoMeta("VnicDynamicProvider", "vnicDynamicProvider", "dynamic-provider-[Name]", _VersionMeta.Version101e, "InputOutput", 0x1fL, [], [u'vnicDynamicProviderEp'], ["Get"], ["read-only"])
}
