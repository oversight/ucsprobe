...
PROPERTY_DICT = {
	...
	"IpmiOverLan":UcsPropertyMeta("IpmiOverLan", "ipmiOverLan", "string", _VersionMeta.Version222c, UcsPropertyMeta.ReadWrite, 0x8L, None, None, None, ["disable", "enable"], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("AaaEpAuthProfile", "aaaEpAuthProfile", "auth-profile-[Name]", _VersionMeta.Version101e, "InputOutput", 0xffL, [], [u'aaaEpUser'], ["Add", "Get", "Remove", "Set"], ["aaa", "admin", "ls-security", "ls-security-policy"])
}
