...
PROPERTY_DICT = {
	...
	"Mode":UcsPropertyMeta("Mode", "mode", "string", _VersionMeta.Version141i, UcsPropertyMeta.ReadOnly, None, None, None, None, ["end-host", "switch"], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("FabricLanMonCloud", "fabricLanMonCloud", "lanmon", _VersionMeta.Version141i, "InputOutput", 0xfL, [], [u'fabricEthLanFlowMonitoring', u'fabricEthMonLan', u'statsThresholdPolicy'], ["Get"], ["admin", "ext-lan-config", "ext-lan-policy"])
}
