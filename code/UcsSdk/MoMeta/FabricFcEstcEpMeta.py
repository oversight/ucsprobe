...
PROPERTY_DICT = {
	...
	"Meta":UcsMoMeta("FabricFcEstcEp", "fabricFcEstcEp", "phys-fc-slot-[SlotId]-port-[PortId]", _VersionMeta.Version141i, "InputOutput", 0x3ffL, [], [u'fabricFcMonSrcEp', u'fabricVsanEp', u'faultInst'], ["Add", "Get", "Remove", "Set"], ["admin", "ext-san-config", "ext-san-policy"])
}
