...
class FabricLanCloud(ManagedObject):
	def __init__(self):
		ManagedObject.__init__(self,"FabricLanCloud")
	...
	CONST_MAC_AGING_MODE_DEFAULT = "mode-default"
	CONST_MAC_AGING_NEVER = "never"
	CONST_MODE_END_HOST = "end-host"
	CONST_MODE_SWITCH = "switch"
	CONST_VLAN_COMPRESSION_DISABLED = "disabled"
	CONST_VLAN_COMPRESSION_ENABLED = "enabled"
