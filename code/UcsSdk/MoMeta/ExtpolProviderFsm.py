...
class ExtpolProviderFsm(ManagedObject):
	def __init__(self):
		ManagedObject.__init__(self,"ExtpolProviderFsm")

	@staticmethod
	def ClassId():
		return "extpolProviderFsm"
	...
	CONST_CURRENT_FSM_REPORT_CONFIG_IMPORT = "ReportConfigImport"
