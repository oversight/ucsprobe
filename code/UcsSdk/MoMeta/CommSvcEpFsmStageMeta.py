...
PROPERTY_DICT = {
	...
	"Meta":UcsMoMeta("CommSvcEpFsmStage", "commSvcEpFsmStage", "stage-[Name]", _VersionMeta.Version211a, "OutputOnly", 0x0L, [], [], [None], [""])
}
