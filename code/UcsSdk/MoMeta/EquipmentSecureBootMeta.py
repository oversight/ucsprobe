...
PROPERTY_DICT = {
	...
	"Name":UcsPropertyMeta("Name", "name", "string", _VersionMeta.Version222c, UcsPropertyMeta.ReadWrite, 0x8L, None, None, """[\-\.:_a-zA-Z0-9]{0,16}""", [], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("EquipmentSecureBoot", "equipmentSecureBoot", "secBoot", _VersionMeta.Version221b, "InputOutput", 0x7fL, [], [], ["Get"], [""])
}
