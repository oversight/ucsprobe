...
PROPERTY_DICT = {
	...
	"PoolName":UcsPropertyMeta("PoolName", "poolName", "string", _VersionMeta.Version141i, UcsPropertyMeta.ReadWrite, 0x20L, None, None, None, [], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("VnicBootIpPolicy", "vnicBootIpPolicy", "", _VersionMeta.Version141i, "InputOutput", 0xffL, [], [], ["Get"], ["admin", "ls-config", "ls-network", "ls-server"])
}
