...
PROPERTY_DICT = {
	...
	"Meta":UcsMoMeta("EquipmentHostIfCapProvider", "equipmentHostIfCapProvider", "manufacturer-[Vendor]-model-[Model]-revision-[Revision]", _VersionMeta.Version101e, "InputOutput", 0xffL, [], [u'equipmentManufacturingDef', u'equipmentPhysicalDef', u'equipmentPicture', u'equipmentServiceDef', u'equipmentSlotArrayRef', u'firmwareType', u'firmwareUpgradeConstraint'], ["Get"], [""])
}
