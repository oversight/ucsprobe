...
PROPERTY_DICT = {
	...
	"Item":UcsPropertyMeta("Item", "item", "string", _VersionMeta.Version211a, UcsPropertyMeta.Naming, None, None, None, None, ["Mount", "Unmount", "nop"], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("NfsMountInstFsmTask", "nfsMountInstFsmTask", "task-[Item]", _VersionMeta.Version211a, "OutputOnly", 0x0L, [], [], [None], [""])
}
