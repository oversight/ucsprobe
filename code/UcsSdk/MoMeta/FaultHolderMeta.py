...
PROPERTY_DICT = {
	...
	"TotalFaults":UcsPropertyMeta("TotalFaults", "totalFaults", "ulong", _VersionMeta.Version101e, UcsPropertyMeta.ReadOnly, None, None, None, None, [], ["0-4294967295"]),
	"Meta":UcsMoMeta("FaultHolder", "faultHolder", "fault", _VersionMeta.Version101e, "InputOutput", 0xfL, [], [u'faultLocalTypedHolder', u'faultPolicy', u'faultSuppressPolicy', u'faultSuppressTask'], ["Get"], ["admin", "fault"])
}
