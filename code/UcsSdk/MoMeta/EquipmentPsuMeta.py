...
PROPERTY_DICT = {
	"Type":UcsPropertyMeta("Type", "Type", "string", _VersionMeta.Version201m, UcsPropertyMeta.ReadOnly, None, None, None, None, ["ac", "dc"], ["0-4294967295"]),
	...
	"Id":UcsPropertyMeta("Id", "id", "uint", _VersionMeta.Version101e, UcsPropertyMeta.Naming, 0x4L, None, None, None, [], ["1-4"]),
	...
	"PowerStateQualifier":UcsPropertyMeta("PowerStateQualifier", "powerStateQualifier", "string", _VersionMeta.Version201m, UcsPropertyMeta.ReadOnly, None, None, None, None, ["ambient-temperature-warning", "failure", "fan-failure", "input-current-warning", "input-loss", "input-voltage-warning", "output-current-warning", "over-current", "over-temperature", "unknown"], ["0-4294967295"]),
	...
	"PsuFirmwareVersion":UcsPropertyMeta("PsuFirmwareVersion", "psuFirmwareVersion", "string", _VersionMeta.Version211a, UcsPropertyMeta.ReadOnly, None, 0, 510, None, [], ["0-4294967295"]),
