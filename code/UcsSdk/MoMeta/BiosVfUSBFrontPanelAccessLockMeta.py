...
PROPERTY_DICT = {
	...
	"VpUSBFrontPanelLock":UcsPropertyMeta("VpUSBFrontPanelLock", "vpUSBFrontPanelLock", "string", _VersionMeta.Version142b, UcsPropertyMeta.ReadWrite, 0x10L, None, None, None, ["disabled", "enabled", "platform-default", "platform-recommended"], ["0-4294967295"]),
	"Meta":UcsMoMeta("BiosVfUSBFrontPanelAccessLock", "biosVfUSBFrontPanelAccessLock", "USB-Front-Panel-Access-Lock", _VersionMeta.Version142b, "InputOutput", 0x1fL, [], [], ["Get", "Set"], ["admin", "ls-compute", "ls-config", "ls-server", "ls-server-policy", "pn-policy"])
}
