...
class EtherSwitchIntFIoPcEp(ManagedObject):
	def __init__(self):
		ManagedObject.__init__(self,"EtherSwitchIntFIoPcEp")

	@staticmethod
	def ClassId():
		return "etherSwitchIntFIoPcEp"
	...
	CONST_ACK_STATE_ACK_IN_PROGRESS = "ack-in-progress"
	CONST_ACK_STATE_ACKNOWLEDGED = "acknowledged"
	CONST_ACK_STATE_AUTO_ACK = "auto-ack"
	CONST_ACK_STATE_EVALUATION = "evaluation"
	CONST_ACK_STATE_OK = "ok"
	CONST_ACK_STATE_REMOVING = "removing"
	CONST_ACK_STATE_UN_ACKNOWLEDGED = "un-acknowledged"
	CONST_ACK_STATE_UN_INITIALIZED = "un-initialized"
	CONST_ACK_STATE_UNSUPPORTED_CONNECTIVITY = "unsupported-connectivity"
