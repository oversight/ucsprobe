...
PROPERTY_DICT = {
	...
	"Id":UcsPropertyMeta("Id", "id", "uint", _VersionMeta.Version201m, UcsPropertyMeta.Naming, 0x4L, None, None, None, [], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("EtherPortChanIdElem", "etherPortChanIdElem", "pchanid-[Id]", _VersionMeta.Version201m, "InputOutput", 0x1fL, [], [], ["Get"], ["read-only"])
}
