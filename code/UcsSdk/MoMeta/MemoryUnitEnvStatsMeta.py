...
PROPERTY_DICT = {
	...
	"Meta":UcsMoMeta("MemoryUnitEnvStats", "memoryUnitEnvStats", "dimm-env-stats", _VersionMeta.Version111j, "OutputOnly", 0x0L, [], [u'memoryUnitEnvStatsHist'], ["Get"], ["admin", "operations", "read-only"])
}
