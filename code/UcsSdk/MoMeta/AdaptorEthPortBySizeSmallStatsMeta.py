...
PROPERTY_DICT = {
	...
	"Meta":UcsMoMeta("AdaptorEthPortBySizeSmallStats", "adaptorEthPortBySizeSmallStats", "eth-port-by-size-small-stats-[TrafficDirection]", _VersionMeta.Version111j, "OutputOnly", 0x0L, [], [u'adaptorEthPortBySizeSmallStatsHist'], ["Get"], ["admin", "operations", "read-only"])
}
