...
class NfsMountInstFsm(ManagedObject):
	def __init__(self):
		ManagedObject.__init__(self,"NfsMountInstFsm")

	@staticmethod
	def ClassId():
		return "nfsMountInstFsm"
	...
	CONST_CURRENT_FSM_MOUNT = "Mount"
	CONST_CURRENT_FSM_UNMOUNT = "Unmount"
