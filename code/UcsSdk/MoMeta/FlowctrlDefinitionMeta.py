...
PROPERTY_DICT = {
	...
	"Meta":UcsMoMeta("FlowctrlDefinition", "flowctrlDefinition", "flowctrl", _VersionMeta.Version101e, "InputOutput", 0x3fL, [], [u'flowctrlItem'], ["Get", "Set"], ["admin", "ls-network", "ls-network-policy", "ls-qos-policy"])
}
