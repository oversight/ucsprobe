...
PROPERTY_DICT = {
	...
	"DefaultZoning":UcsPropertyMeta("DefaultZoning", "defaultZoning", "string", _VersionMeta.Version141i, UcsPropertyMeta.ReadWrite, 0x2L, None, None, None, ["disabled", "enabled"], ["0-4294967295"]),
	...
	"FcZoneSharingMode":UcsPropertyMeta("FcZoneSharingMode", "fcZoneSharingMode", "string", _VersionMeta.Version211a, UcsPropertyMeta.ReadOnly, None, None, None, None, ["clear-unmanaged-zone-all", "coalesce"], ["0-4294967295"]),
	...
	"Id":UcsPropertyMeta("Id", "id", "uint", _VersionMeta.Version101e, UcsPropertyMeta.Naming, 0x8L, None, None, None, [], ["1-4093"]),
	...
	"Meta":UcsMoMeta("SwVsan", "swVsan", "vsan-[Id]", _VersionMeta.Version101e, "InputOutput", 0xffL, [], [u'swFcZoneSet'], ["Get"], ["read-only"])
}
