...
PROPERTY_DICT = {
	...
	"Use2Factor":UcsPropertyMeta("Use2Factor", "use2Factor", "string", _VersionMeta.Version221b, UcsPropertyMeta.ReadWrite, 0x100L, None, None, None, ["false", "no", "true", "yes"], ["0-4294967295"]),
	"Meta":UcsMoMeta("AaaConsoleAuth", "aaaConsoleAuth", "console-auth", _VersionMeta.Version141i, "InputOutput", 0x1ffL, [], [u'faultInst'], ["Get", "Set"], ["aaa", "admin"])
}
