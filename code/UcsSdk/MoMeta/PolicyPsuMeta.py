...
PROPERTY_DICT = {
	...
	"Meta":UcsMoMeta("PolicyPsu", "policyPsu", "psu-ctrl", _VersionMeta.Version211a, "InputOutput", 0x1fL, [], [u'policyControlledInstance', u'policyControlledType'], ["Add", "Get", "Set"], ["admin", "pn-equipment", "pn-policy"])
}
