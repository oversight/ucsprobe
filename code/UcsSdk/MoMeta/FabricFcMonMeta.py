...
PROPERTY_DICT = {
	...
	"Meta":UcsMoMeta("FabricFcMon", "fabricFcMon", "fc-mon-[Name]", _VersionMeta.Version141i, "InputOutput", 0x7fL, [], [u'fabricFcMonDestEp', u'fabricFcMonFiltRef', u'fabricFcMonSrcRef', u'faultInst'], ["Add", "Get", "Remove", "Set"], ["admin", "ext-san-config", "ext-san-policy"])
}
