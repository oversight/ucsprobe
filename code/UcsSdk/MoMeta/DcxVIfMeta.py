...
PROPERTY_DICT = {
	...
	"ProtPeerId":UcsPropertyMeta("ProtPeerId", "protPeerId", "uint", _VersionMeta.Version101e, UcsPropertyMeta.ReadOnly, None, None, None, None, [], ["0-4294967295"]),
	"ProtRole":UcsPropertyMeta("ProtRole", "protRole", "string", _VersionMeta.Version101e, UcsPropertyMeta.ReadOnly, None, None, None, None, ["backup", "primary", "unprotected"], ["0-4294967295"]),
	...
	"QosControl":UcsPropertyMeta("QosControl", "qosControl", "string", _VersionMeta.Version111j, UcsPropertyMeta.ReadOnly, None, None, None, None, ["full", "full-with-exception", "none"], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("DcxVIf", "dcxVIf", "vif-[Id]", _VersionMeta.Version101e, "InputOutput", 0x3fL, [], [u'faultInst'], ["Get"], ["read-only"])
}
