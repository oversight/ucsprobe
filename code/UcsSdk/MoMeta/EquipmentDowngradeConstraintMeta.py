...
PROPERTY_DICT = {
	...
	"MinVer":UcsPropertyMeta("MinVer", "minVer", "string", _VersionMeta.Version213a, UcsPropertyMeta.ReadOnly, None, 0, 510, None, [], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("EquipmentDowngradeConstraint", "equipmentDowngradeConstraint", "fw-dngrd-constr", _VersionMeta.Version213a, "InputOutput", 0xfL, [], [], ["Get"], [""])
}
