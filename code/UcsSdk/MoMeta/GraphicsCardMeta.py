...
PROPERTY_DICT = {
	...
	"Meta":UcsMoMeta("GraphicsCard", "graphicsCard", "graphics-card-[Id]", _VersionMeta.Version213a, "InputOutput", 0x1fL, [], [u'firmwareBootDefinition', u'firmwareRunning', u'graphicsController'], ["Get"], ["read-only"])
}
