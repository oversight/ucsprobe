...
PROPERTY_DICT = {
	...
	"IsSupported":UcsPropertyMeta("IsSupported", "isSupported", "string", _VersionMeta.Version222c, UcsPropertyMeta.ReadOnly, None, None, None, None, ["false", "no", "true", "yes"], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("EquipmentBladeAggregationCapRef", "equipmentBladeAggregationCapRef", "blade-aggr", _VersionMeta.Version222c, "InputOutput", 0xfL, [], [u'equipmentPhysDevicesPerBoard'], [None], [""])
}
