...
PROPERTY_DICT = {
	...
	"Configuration":UcsPropertyMeta("Configuration", "configuration", "string", _VersionMeta.Version141i, UcsPropertyMeta.ReadOnly, None, None, None, None, ["not-supported", "supported", "unknown"], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("StorageLocalDiskSlotEp", "storageLocalDiskSlotEp", "disk-[Id]", _VersionMeta.Version141i, "InputOutput", 0x1fL, [], [u'faultInst'], ["Get"], ["read-only"])
}
