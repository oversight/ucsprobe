...
class SysdebugLogExportPolicyFsm(ManagedObject):
	def __init__(self):
		ManagedObject.__init__(self,"SysdebugLogExportPolicyFsm")

	@staticmethod
	def ClassId():
		return "sysdebugLogExportPolicyFsm"
	...
	CONST_CURRENT_FSM_CONFIGURE = "Configure"
