...
PROPERTY_DICT = {
	...
	"OperFnDefName":UcsPropertyMeta("OperFnDefName", "operFnDefName", "string", _VersionMeta.Version221b, UcsPropertyMeta.ReadOnly, None, 0, 256, None, [], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("ExtvmmFNDReference", "extvmmFNDReference", "fnd-ref-[Name]", _VersionMeta.Version221b, "InputOutput", 0xffL, [], [u'faultInst'], ["Add", "Get", "Remove"], ["admin", "ls-config", "ls-config-policy", "ls-network", "pn-policy"])
}
