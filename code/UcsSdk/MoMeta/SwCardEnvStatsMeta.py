...
PROPERTY_DICT = {
	...
	"Meta":UcsMoMeta("SwCardEnvStats", "swCardEnvStats", "cardenvstats", _VersionMeta.Version211a, "OutputOnly", 0x0L, [], [u'swCardEnvStatsHist'], ["Get"], ["admin", "operations", "read-only"])
}
