...
PROPERTY_DICT = {
	...
	"Wwpn":UcsPropertyMeta("Wwpn", "wwpn", "string", _VersionMeta.Version211a, UcsPropertyMeta.Naming, 0x20L, 0, 256, """(([A-Fa-f0-9][A-Fa-f0-9]:){7}[A-Fa-f0-9][A-Fa-f0-9])|0""", [], ["0-4294967295"]),
	"Meta":UcsMoMeta("SwZoneTargetMember", "swZoneTargetMember", "target-[Wwpn]", _VersionMeta.Version211a, "InputOutput", 0x3fL, [], [], [None], ["read-only"])
}
