...
PROPERTY_DICT = {
	...
	"Id":UcsPropertyMeta("Id", "id", "uint", _VersionMeta.Version131c, UcsPropertyMeta.ReadWrite, 0x4L, None, None, None, [], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("ComputeBoardController", "computeBoardController", "boardController", _VersionMeta.Version131c, "InputOutput", 0x1fL, [], [u'mgmtController'], ["Get"], ["read-only"])
}
