...
PROPERTY_DICT = {
	...
	"Name":UcsPropertyMeta("Name", "name", "string", _VersionMeta.Version211a, UcsPropertyMeta.Naming, None, None, None, None, ["DownloadBegin", "DownloadCopyRemote", "DownloadDeleteLocal", "DownloadDeleteRemote", "DownloadFail", "DownloadLocal", "DownloadSuccess", "DownloadValidateLocal", "DownloadValidateRemote", "nop"], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("LicenseDownloaderFsmStage", "licenseDownloaderFsmStage", "stage-[Name]", _VersionMeta.Version211a, "OutputOnly", 0x0L, [], [], [None], [""])
}
