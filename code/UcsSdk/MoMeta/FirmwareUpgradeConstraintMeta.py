...
PROPERTY_DICT = {
	...
	"MinVer":UcsPropertyMeta("MinVer", "minVer", "string", _VersionMeta.Version202m, UcsPropertyMeta.ReadOnly, None, 0, 510, None, [], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("FirmwareUpgradeConstraint", "firmwareUpgradeConstraint", "fw-upgrd-constr", _VersionMeta.Version202m, "InputOutput", 0xfL, [], [], ["Get"], [""])
}
