...
PROPERTY_DICT = {
	...
	"Meta":UcsMoMeta("EquipmentPOSTCodeTemplate", "equipmentPOSTCodeTemplate", "POST-[Name]", _VersionMeta.Version141i, "InputOutput", 0x1fL, [], [u'equipmentPOSTCode'], ["Get"], ["read-only"])
}
