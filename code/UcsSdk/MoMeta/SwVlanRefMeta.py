...
PROPERTY_DICT = {
	...
	"ConfigStatus":UcsPropertyMeta("ConfigStatus", "configStatus", "string", _VersionMeta.Version211a, UcsPropertyMeta.ReadOnly, None, None, None, None, ["applied", "unApplied"], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("SwVlanRef", "swVlanRef", "vlanref-[Id]", _VersionMeta.Version211a, "InputOutput", 0x1fL, [], [], [None], ["read-only"])
}
