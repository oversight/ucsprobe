...
class SysdebugLogControlEpFsm(ManagedObject):
	def __init__(self):
		ManagedObject.__init__(self,"SysdebugLogControlEpFsm")

	@staticmethod
	def ClassId():
		return "sysdebugLogControlEpFsm"
	...
	CONST_CURRENT_FSM_LOG_CONTROL_PERSIST = "LogControlPersist"
