...
PROPERTY_DICT = {
	...
	"Meta":UcsMoMeta("PolicyDiscovery", "policyDiscovery", "discovery-ctrl", _VersionMeta.Version211a, "InputOutput", 0x1fL, [], [u'policyControlledInstance', u'policyControlledType'], [None], ["admin", "pn-policy"])
}
