...
PROPERTY_DICT = {
	...
	"PortId":UcsPropertyMeta("PortId", "portId", "uint", _VersionMeta.Version201m, UcsPropertyMeta.Naming, 0x10L, None, None, None, [], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("SwPhysEtherEp", "swPhysEtherEp", "phys-eth-slot-[SlotId]port-[PortId]", _VersionMeta.Version201m, "InputOutput", 0xffL, [], [], ["Get"], ["read-only"])
}
