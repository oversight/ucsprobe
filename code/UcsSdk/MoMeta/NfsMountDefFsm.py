...
class NfsMountDefFsm(ManagedObject):
	def __init__(self):
		ManagedObject.__init__(self,"NfsMountDefFsm")

	@staticmethod
	def ClassId():
		return "nfsMountDefFsm"
	...
	CONST_CURRENT_FSM_REPORT_NFS_MOUNT_SUSPEND = "ReportNfsMountSuspend"
