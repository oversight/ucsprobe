...
PROPERTY_DICT = {
	...
	"Support":UcsPropertyMeta("Support", "support", "string", _VersionMeta.Version141i, UcsPropertyMeta.ReadWrite, 0x10L, None, None, None, ["full", "none"], ["0-4294967295"]),
	"Meta":UcsMoMeta("AdaptorLldpCap", "adaptorLldpCap", "lldp", _VersionMeta.Version141i, "InputOutput", 0x1fL, [], [], ["Get"], ["read-only"])
}
