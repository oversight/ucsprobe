...
PROPERTY_DICT = {
	...
	"ZoningType":UcsPropertyMeta("ZoningType", "zoningType", "string", _VersionMeta.Version211a, UcsPropertyMeta.ReadWrite, 0x80L, None, None, None, ["none", "simt", "sist"], ["0-4294967295"]),
	"Meta":UcsMoMeta("StorageConnectionDef", "storageConnectionDef", "storage-conndef", _VersionMeta.Version211a, "InputOutput", 0xffL, [], [u'faultInst', u'storageFcTargetEp'], ["Add", "Get", "Remove", "Set"], ["admin", "ext-san-config", "ext-san-policy", "ls-config", "ls-server", "ls-storage", "ls-storage-policy"])
}
