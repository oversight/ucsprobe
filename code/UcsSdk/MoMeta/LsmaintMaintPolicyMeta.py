...
PROPERTY_DICT = {
	...
	"OperSchedName":UcsPropertyMeta("OperSchedName", "operSchedName", "string", _VersionMeta.Version141i, UcsPropertyMeta.ReadOnly, None, None, None, """[\-\.:_a-zA-Z0-9]{0,16}""", [], ["0-4294967295"]),
	...
	"SchedName":UcsPropertyMeta("SchedName", "schedName", "string", _VersionMeta.Version141i, UcsPropertyMeta.ReadWrite, 0x40L, None, None, """[\-\.:_a-zA-Z0-9]{0,16}""", [], ["0-4294967295"]),
	...
	"UptimeDisr":UcsPropertyMeta("UptimeDisr", "uptimeDisr", "string", _VersionMeta.Version141i, UcsPropertyMeta.ReadWrite, 0x100L, None, None, None, ["immediate", "timer-automatic", "user-ack"], ["0-4294967295"]),
	"Meta":UcsMoMeta("LsmaintMaintPolicy", "lsmaintMaintPolicy", "maint-[Name]", _VersionMeta.Version141i, "InputOutput", 0x1ffL, [], [u'faultInst'], ["Add", "Get", "Remove", "Set"], ["admin", "ls-compute", "ls-config-policy", "ls-server-policy"])
}
