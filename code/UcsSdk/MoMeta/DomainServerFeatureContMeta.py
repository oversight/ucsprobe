...
PROPERTY_DICT = {
	...
	"Meta":UcsMoMeta("DomainServerFeatureCont", "domainServerFeatureCont", "server-feature-cont", _VersionMeta.Version221b, "InputOutput", 0xfL, [], [u'domainEnvironmentFeature', u'domainNetworkFeature', u'domainServerFeature', u'domainStorageFeature'], [None], ["admin"])
}
