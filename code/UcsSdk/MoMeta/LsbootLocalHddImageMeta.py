...
PROPERTY_DICT = {
	...
	"Meta":UcsMoMeta("LsbootLocalHddImage", "lsbootLocalHddImage", "local-hdd", _VersionMeta.Version221b, "InputOutput", 0x1fL, [], [], ["Add", "Get", "Remove", "Set"], ["admin", "ls-compute", "ls-config", "ls-config-policy", "ls-server", "ls-server-policy", "ls-storage", "ls-storage-policy"])
}
