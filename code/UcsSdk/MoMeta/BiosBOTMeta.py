...
PROPERTY_DICT = {
	...
	"LastUpdate":UcsPropertyMeta("LastUpdate", "lastUpdate", "string", _VersionMeta.Version101e, UcsPropertyMeta.ReadOnly, None, None, None, """([0-9]){4}-([0-9]){2}-([0-9]){2}T([0-9]){2}:([0-9]){2}:([0-9]){2}((\.([0-9]){3})){0,1}""", ["never"], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("BiosBOT", "biosBOT", "bdgep", _VersionMeta.Version101e, "InputOutput", 0xfL, [], [u'biosBootDevGrp'], ["Get"], ["read-only"])
}
