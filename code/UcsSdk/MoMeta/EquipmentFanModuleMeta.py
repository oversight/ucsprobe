...
PROPERTY_DICT = {
	...
	"Tray":UcsPropertyMeta("Tray", "tray", "uint", _VersionMeta.Version101e, UcsPropertyMeta.Naming, 0x20L, None, None, None, [], ["1-1"]),
	...
	"Meta":UcsMoMeta("EquipmentFanModule", "equipmentFanModule", "fan-module-[Tray]-[Id]", _VersionMeta.Version101e, "InputOutput", 0x3fL, [], [u'equipmentBeaconLed', u'equipmentFan', u'equipmentFanModuleStats', u'equipmentHealthLed', u'equipmentIndicatorLed', u'equipmentLocatorLed', u'faultInst'], ["Get"], ["read-only"])
}
