...
PROPERTY_DICT = {
	...
	"State":UcsPropertyMeta("State", "state", "string", _VersionMeta.Version141i, UcsPropertyMeta.ReadOnly, None, None, None, None, ["trusted", "untrusted"], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("PortTrustMode", "portTrustMode", "trust-mode", _VersionMeta.Version141i, "InputOutput", 0xfL, [], [], ["Get"], ["read-only"])
}
