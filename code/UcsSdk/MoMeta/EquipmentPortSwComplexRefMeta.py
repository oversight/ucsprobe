...
PROPERTY_DICT = {
	...
	"MaxPortId":UcsPropertyMeta("MaxPortId", "maxPortId", "uint", _VersionMeta.Version201m, UcsPropertyMeta.ReadOnly, None, None, None, None, [], ["0-4294967295"]),
	"MinPortId":UcsPropertyMeta("MinPortId", "minPortId", "uint", _VersionMeta.Version201m, UcsPropertyMeta.ReadOnly, None, None, None, None, [], ["0-4294967295"]),
	...
	"SwComplexId":UcsPropertyMeta("SwComplexId", "swComplexId", "ushort", _VersionMeta.Version201m, UcsPropertyMeta.Naming, 0x80L, None, None, None, [], ["0-4294967295"]),
	"Meta":UcsMoMeta("EquipmentPortSwComplexRef", "equipmentPortSwComplexRef", "port-sw-complex-ref-[SwComplexId]", _VersionMeta.Version201m, "InputOutput", 0xffL, [], [], ["Get"], [""])
}
