...
PROPERTY_DICT = {
	...
	"Type":UcsPropertyMeta("Type", "type", "string", _VersionMeta.Version101e, UcsPropertyMeta.Naming, 0x20L, None, None, None, ["adaptor-ext", "adaptor-pc", "fabric", "fabric-pc", "host", "host-pc", "server-pc", "switch-ether", "switch-fc"], ["0-4294967295"]),
	"Meta":UcsMoMeta("PortGroup", "portGroup", "[Type]", _VersionMeta.Version101e, "InputOutput", 0x3fL, [], [u'etherPIo', u'etherServerIntFIo', u'etherServerIntFIoPc', u'etherSwitchIntFIo', u'etherSwitchIntFIoPc', u'fcPIo'], ["Get"], ["read-only"])
}
