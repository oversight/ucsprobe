...
PROPERTY_DICT = {
	...
	"VpLoad":UcsPropertyMeta("VpLoad", "vpLoad", "string", _VersionMeta.Version141i, UcsPropertyMeta.ReadOnly, None, None, None, None, ["disabled", "enabled", "platform-default", "platform-recommended"], ["0-4294967295"]),
	"Meta":UcsMoMeta("BiosVfOptionROMLoad", "biosVfOptionROMLoad", "OptionROM-load", _VersionMeta.Version141i, "InputOutput", 0xfL, [], [], ["Get"], ["admin", "ls-compute", "ls-config", "ls-server", "ls-server-policy", "pn-policy"])
}
