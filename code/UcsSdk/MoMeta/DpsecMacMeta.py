...
PROPERTY_DICT = {
	...
	"Forge":UcsPropertyMeta("Forge", "forge", "string", _VersionMeta.Version101e, UcsPropertyMeta.ReadWrite, 0x8L, None, None, None, ["allow", "deny"], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("DpsecMac", "dpsecMac", "mac-sec", _VersionMeta.Version101e, "InputOutput", 0xffL, [], [], ["Add", "Get", "Remove", "Set"], ["admin", "ls-network", "ls-network-policy"])
}
