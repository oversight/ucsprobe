...
PROPERTY_DICT = {
	...
	"Wwn":UcsPropertyMeta("Wwn", "wwn", "string", _VersionMeta.Version101e, UcsPropertyMeta.ReadWrite, 0x20L, 0, 256, """(([A-Fa-f0-9][A-Fa-f0-9]:){7}[A-Fa-f0-9][A-Fa-f0-9])|0""", [], ["0-4294967295"]),
	"Meta":UcsMoMeta("VnicBootTarget", "vnicBootTarget", "boot-target", _VersionMeta.Version101e, "InputOutput", 0x3fL, [], [], ["Get"], ["admin", "ls-config", "ls-server", "ls-storage"])
}
