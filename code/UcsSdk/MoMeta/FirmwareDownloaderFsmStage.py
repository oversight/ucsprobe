...
class FirmwareDownloaderFsmStage(ManagedObject):
	def __init__(self):
		ManagedObject.__init__(self,"FirmwareDownloaderFsmStage")

	@staticmethod
	def ClassId():
		return "firmwareDownloaderFsmStage"
	...
	CONST_NAME_DOWNLOAD_UNPACK_LOCAL = "DownloadUnpackLocal"
	CONST_NAME_NOP = "nop"
