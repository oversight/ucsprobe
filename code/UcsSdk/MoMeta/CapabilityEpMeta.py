...
PROPERTY_DICT = {
	...
	"Meta":UcsMoMeta("CapabilityEp", "capabilityEp", "ep", _VersionMeta.Version131c, "InputOutput", 0xfL, [], [u'capabilityMgmtExtension', u'capabilityUpdate', u'capabilityUpdater'], ["Get"], ["read-only"])
}
