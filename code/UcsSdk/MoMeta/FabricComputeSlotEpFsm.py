...
class FabricComputeSlotEpFsm(ManagedObject):
	def __init__(self):
		ManagedObject.__init__(self,"FabricComputeSlotEpFsm")

	@staticmethod
	def ClassId():
		return "fabricComputeSlotEpFsm"
	...
	CONST_CURRENT_FSM_IDENTIFY = "Identify"
