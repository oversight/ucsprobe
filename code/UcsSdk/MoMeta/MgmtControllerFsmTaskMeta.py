...
PROPERTY_DICT = {
	...
	"Item":UcsPropertyMeta("Item", "item", "string", _VersionMeta.Version111j, UcsPropertyMeta.Naming, None, None, None, None, ["ActivateBMC", "ActivateIOM", "ExtMgmtIfConfig", "ExtMgmtInterfaceConfig", "Online", "RegistryConfig", "SysConfig", "UpdateBMC", "UpdateIOM", "UpdateSwitch", "UpdateUCSManager", "nop"], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("MgmtControllerFsmTask", "mgmtControllerFsmTask", "task-[Item]", _VersionMeta.Version111j, "OutputOnly", 0x0L, [], [], [None], [""])
}
