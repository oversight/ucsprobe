...
PROPERTY_DICT = {
	...
	"VpProcessorCState":UcsPropertyMeta("VpProcessorCState", "vpProcessorCState", "string", _VersionMeta.Version201m, UcsPropertyMeta.ReadWrite, 0x10L, None, None, None, ["disabled", "enabled", "platform-default", "platform-recommended"], ["0-4294967295"]),
	"Meta":UcsMoMeta("BiosVfProcessorCState", "biosVfProcessorCState", "Processor-C-State", _VersionMeta.Version201m, "InputOutput", 0x1fL, [], [], ["Get", "Set"], ["admin", "ls-compute", "ls-config", "ls-server", "ls-server-policy", "pn-policy"])
}
