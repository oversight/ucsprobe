...
class VmLifeCyclePolicyFsmStage(ManagedObject):
	def __init__(self):
		ManagedObject.__init__(self,"VmLifeCyclePolicyFsmStage")

	@staticmethod
	def ClassId():
		return "vmLifeCyclePolicyFsmStage"
	...
	CONST_NAME_CONFIG_LOCAL = "configLocal"
	CONST_NAME_CONFIG_PEER = "configPeer"
