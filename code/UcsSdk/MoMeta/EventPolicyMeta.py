...
PROPERTY_DICT = {
	...
	"RetentionInterval":UcsPropertyMeta("RetentionInterval", "retentionInterval", "string", _VersionMeta.Version101e, UcsPropertyMeta.ReadWrite, 0x20L, None, None, """(([1-9]*[0-9]{2}:)|)([0-1][0-9]||[2][0-3]):([0-5][0-9]):([0-5][0-9])||(([0-5][0-9]):|)([0-5][0-9])""", ["forever"], ["0-4294967295"]),
	"Rn":UcsPropertyMeta("Rn", "rn", "string", _VersionMeta.Version101e, UcsPropertyMeta.ReadOnly, 0x40L, 0, 256, None, [], ["0-4294967295"]),
	"SizeLimit":UcsPropertyMeta("SizeLimit", "sizeLimit", "string", _VersionMeta.Version101e, UcsPropertyMeta.ReadWrite, 0x80L, None, None, None, ["max"], ["0-20000"]),
	...
	"Meta":UcsMoMeta("EventPolicy", "eventPolicy", "event-policy", _VersionMeta.Version101e, "InputOutput", 0x1ffL, [], [], ["Get"], ["admin", "read-only"])
}
