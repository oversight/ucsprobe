...
PROPERTY_DICT = {
	...
	"VpNUMAOptimized":UcsPropertyMeta("VpNUMAOptimized", "vpNUMAOptimized", "string", _VersionMeta.Version111j, UcsPropertyMeta.ReadWrite, 0x10L, None, None, None, ["disabled", "enabled", "platform-default", "platform-recommended"], ["0-4294967295"]),
	"Meta":UcsMoMeta("BiosVfNUMAOptimized", "biosVfNUMAOptimized", "NUMA-optimized", _VersionMeta.Version111j, "InputOutput", 0x1fL, [], [], ["Get", "Set"], ["admin", "ls-compute", "ls-config", "ls-server", "ls-server-policy", "pn-policy"])
}
