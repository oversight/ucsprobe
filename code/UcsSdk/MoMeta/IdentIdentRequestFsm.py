...
class IdentIdentRequestFsm(ManagedObject):
	def __init__(self):
		ManagedObject.__init__(self,"IdentIdentRequestFsm")

	@staticmethod
	def ClassId():
		return "identIdentRequestFsm"
	...
	CONST_CURRENT_FSM_UPDATE_IDENT = "updateIdent"
