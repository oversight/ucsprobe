...
class ComputeRackUnitFsm(ManagedObject):
	def __init__(self):
		ManagedObject.__init__(self,"ComputeRackUnitFsm")

	@staticmethod
	def ClassId():
		return "computeRackUnitFsm"
	...
	CONST_CURRENT_FSM_ADAPTER_RESET = "AdapterReset"
	...
	CONST_CURRENT_FSM_CREATE_DHCP_ENTRY = "CreateDhcpEntry"
