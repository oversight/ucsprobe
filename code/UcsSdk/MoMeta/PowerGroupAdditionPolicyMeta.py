...
PROPERTY_DICT = {
	"Action":UcsPropertyMeta("Action", "action", "string", _VersionMeta.Version141i, UcsPropertyMeta.ReadWrite, 0x1L, None, None, None, ["nothing", "stop-blade-disc", "throttle-blade-disc"], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("PowerGroupAdditionPolicy", "powerGroupAdditionPolicy", "group-add-policy", _VersionMeta.Version141i, "InputOutput", 0xffL, [], [], ["Get"], ["admin", "power-mgmt"])
}
