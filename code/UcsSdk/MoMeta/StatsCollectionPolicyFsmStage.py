...
class StatsCollectionPolicyFsmStage(ManagedObject):
	def __init__(self):
		ManagedObject.__init__(self,"StatsCollectionPolicyFsmStage")

	@staticmethod
	def ClassId():
		return "statsCollectionPolicyFsmStage"
	...
	CONST_NAME_UPDATE_EP_SET_EP_A = "updateEpSetEpA"
	CONST_NAME_UPDATE_EP_SET_EP_B = "updateEpSetEpB"
