...
PROPERTY_DICT = {
	...
	"Revision":UcsPropertyMeta("Revision", "revision", "string", _VersionMeta.Version131c, UcsPropertyMeta.Naming, 0x10L, 1, 510, None, [], ["0-4294967295"]),
	...
	"Vendor":UcsPropertyMeta("Vendor", "vendor", "string", _VersionMeta.Version131c, UcsPropertyMeta.Naming, 0x80L, 1, 510, None, [], ["0-4294967295"]),
	"Meta":UcsMoMeta("EquipmentCatalogCapProvider", "equipmentCatalogCapProvider", "manufacturer-[Vendor]-model-[Model]-revision-[Revision]", _VersionMeta.Version131c, "InputOutput", 0xffL, [], [u'equipmentManufacturingDef', u'equipmentPhysicalDef', u'equipmentPicture', u'equipmentServiceDef', u'equipmentSlotArray', u'equipmentSlotArrayRef', u'firmwareType', u'firmwareUpgradeConstraint'], ["Get"], [""])
}
