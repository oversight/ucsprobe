...
PROPERTY_DICT = {
	...
	"NumberOfPingRequests":UcsPropertyMeta("NumberOfPingRequests", "numberOfPingRequests", "uint", _VersionMeta.Version141i, UcsPropertyMeta.ReadWrite, 0x8L, None, None, None, [], ["1-5"]),
	...
	"Meta":UcsMoMeta("ExtmgmtGatewayPing", "extmgmtGatewayPing", "gw-ping-policy", _VersionMeta.Version141i, "InputOutput", 0x3fL, [], [], ["Get"], ["admin", "ext-lan-config"])
}
