...
PROPERTY_DICT = {
	...
	"FillPattern":UcsPropertyMeta("FillPattern", "fillPattern", "string", _VersionMeta.Version222c, UcsPropertyMeta.ReadWrite, 0x10L, None, None, None, ["arbff", "idle"], ["0-4294967295"]),
	...
	"PortId":UcsPropertyMeta("PortId", "portId", "uint", _VersionMeta.Version101e, UcsPropertyMeta.Naming, 0x40L, None, None, None, [], ["1-48"]),
	"Rn":UcsPropertyMeta("Rn", "rn", "string", _VersionMeta.Version101e, UcsPropertyMeta.ReadOnly, 0x80L, 0, 256, None, [], ["0-4294967295"]),
	"SlotId":UcsPropertyMeta("SlotId", "slotId", "uint", _VersionMeta.Version101e, UcsPropertyMeta.Naming, 0x100L, None, None, None, [], ["1-5"]),
	...
	"Meta":UcsMoMeta("FabricFcSanPcEp", "fabricFcSanPcEp", "ep-slot-[SlotId]-port-[PortId]", _VersionMeta.Version101e, "InputOutput", 0x3ffL, [], [u'faultInst'], ["Add", "Get", "Remove", "Set"], ["admin", "ext-san-config", "ext-san-policy"])
}
