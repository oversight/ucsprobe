...
PROPERTY_DICT = {
	...
	"VpState":UcsPropertyMeta("VpState", "vpState", "string", _VersionMeta.Version202m, UcsPropertyMeta.ReadOnly, None, None, None, None, ["disabled", "enabled", "platform-default", "platform-recommended"], ["0-4294967295"]),
	"Meta":UcsMoMeta("BiosVfOptionROMEnable", "biosVfOptionROMEnable", "OptionROM-Enable", _VersionMeta.Version202m, "InputOutput", 0xfL, [], [], ["Get"], ["admin", "ls-compute", "ls-config", "ls-server", "ls-server-policy", "pn-policy"])
}
