...
PROPERTY_DICT = {
	...
	"SchedName":UcsPropertyMeta("SchedName", "schedName", "string", _VersionMeta.Version141i, UcsPropertyMeta.Naming, 0x80L, None, None, """[\-\.:_a-zA-Z0-9]{1,256}""", [], ["0-4294967295"]),
	...
	"TrigTime":UcsPropertyMeta("TrigTime", "trigTime", "string", _VersionMeta.Version141i, UcsPropertyMeta.ReadOnly, None, None, None, """([0-9]){4}-([0-9]){2}-([0-9]){2}T([0-9]){2}:([0-9]){2}:([0-9]){2}((\.([0-9]){3})){0,1}""", [], ["0-4294967295"]),
	"WindowDn":UcsPropertyMeta("WindowDn", "windowDn", "string", _VersionMeta.Version141i, UcsPropertyMeta.ReadOnly, None, 0, 256, None, [], ["0-4294967295"]),
	"Meta":UcsMoMeta("TrigMeta", "trigMeta", "meta-trig-[SchedName]", _VersionMeta.Version141i, "InputOutput", 0x1ffL, [], [u'trigTriggered'], ["Get"], ["read-only"])
}
