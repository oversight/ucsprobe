...
PROPERTY_DICT = {
	...
	"OperPrio":UcsPropertyMeta("OperPrio", "operPrio", "string", _VersionMeta.Version141i, UcsPropertyMeta.ReadOnly, None, None, None, None, ["no-cap", "utility"], ["1-10"]),
	...
	"Prio":UcsPropertyMeta("Prio", "prio", "string", _VersionMeta.Version141i, UcsPropertyMeta.ReadWrite, 0x20L, None, None, None, ["no-cap", "utility"], ["1-10"]),
	...
	"Meta":UcsMoMeta("PowerPolicy", "powerPolicy", "power-policy-[Name]", _VersionMeta.Version141i, "InputOutput", 0xffL, [], [u'faultInst'], ["Add", "Get", "Remove", "Set"], ["admin", "ls-compute", "ls-config", "ls-server", "ls-server-policy"])
}
