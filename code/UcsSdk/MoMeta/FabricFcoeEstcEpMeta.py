...
PROPERTY_DICT = {
	...
	"FcoeState":UcsPropertyMeta("FcoeState", "fcoeState", "string", _VersionMeta.Version211a, UcsPropertyMeta.ReadOnly, None, None, None, None, ["down", "error-misconfigured", "unknown", "up"], ["0-4294967295"]),
	...
	"PortId":UcsPropertyMeta("PortId", "portId", "uint", _VersionMeta.Version141i, UcsPropertyMeta.Naming, 0x10L, None, None, None, [], ["1-48"]),
	"Rn":UcsPropertyMeta("Rn", "rn", "string", _VersionMeta.Version141i, UcsPropertyMeta.ReadOnly, 0x20L, 0, 256, None, [], ["0-4294967295"]),
	"SlotId":UcsPropertyMeta("SlotId", "slotId", "uint", _VersionMeta.Version141i, UcsPropertyMeta.Naming, 0x40L, None, None, None, [], ["1-4"]),
	...
	"UsrLbl":UcsPropertyMeta("UsrLbl", "usrLbl", "string", _VersionMeta.Version141i, UcsPropertyMeta.ReadWrite, 0x100L, None, None, """[ !#$%&\(\)\*\+,\-\./:;\?@\[\]_\{\|\}~a-zA-Z0-9]{0,32}""", [], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("FabricFcoeEstcEp", "fabricFcoeEstcEp", "phys-fcoe-slot-[SlotId]-port-[PortId]", _VersionMeta.Version141i, "InputOutput", 0x1ffL, [], [u'etherFcoeInterfaceStats', u'fabricEthMonSrcEp', u'fabricVsanEp', u'fabricVsanMembership', u'faultInst'], ["Add", "Get", "Remove", "Set"], ["admin", "ext-san-config", "ext-san-policy"])
}
