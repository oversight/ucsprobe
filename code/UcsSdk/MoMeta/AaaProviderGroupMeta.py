...
PROPERTY_DICT = {
	...
	"Name":UcsPropertyMeta("Name", "name", "string", _VersionMeta.Version141i, UcsPropertyMeta.Naming, 0x8L, 1, 127, None, [], ["0-4294967295"]),
	"Rn":UcsPropertyMeta("Rn", "rn", "string", _VersionMeta.Version141i, UcsPropertyMeta.ReadOnly, 0x10L, 0, 256, None, [], ["0-4294967295"]),
	"Size":UcsPropertyMeta("Size", "size", "uint", _VersionMeta.Version221b, UcsPropertyMeta.ReadOnly, None, None, None, None, [], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("AaaProviderGroup", "aaaProviderGroup", "providergroup-[Name]", _VersionMeta.Version141i, "InputOutput", 0x3fL, [], [u'aaaProviderRef', u'faultInst'], ["Add", "Get", "Remove", "Set"], ["aaa", "admin"])
}
