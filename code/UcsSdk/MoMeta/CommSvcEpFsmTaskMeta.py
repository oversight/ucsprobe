...
PROPERTY_DICT = {
	...
	"Item":UcsPropertyMeta("Item", "item", "string", _VersionMeta.Version111j, UcsPropertyMeta.Naming, None, None, None, None, ["nop", "restartWebSvc", "updateSvcEp"], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("CommSvcEpFsmTask", "commSvcEpFsmTask", "task-[Item]", _VersionMeta.Version111j, "OutputOnly", 0x0L, [], [], [None], [""])
}
