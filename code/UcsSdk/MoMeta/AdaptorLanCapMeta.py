...
PROPERTY_DICT = {
	...
	"DefaultVlan":UcsPropertyMeta("DefaultVlan", "defaultVlan", "string", _VersionMeta.Version101e, UcsPropertyMeta.ReadWrite, 0x2L, None, None, None, ["default-vlan", "native-vlan"], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("AdaptorLanCap", "adaptorLanCap", "lan", _VersionMeta.Version101e, "InputOutput", 0x1fL, [], [], ["Get"], ["read-only"])
}
