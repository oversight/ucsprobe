...
class FirmwareDownloader(ManagedObject):
	def __init__(self):
		ManagedObject.__init__(self,"FirmwareDownloader")
	...
	CONST_FSM_PREV_DOWNLOAD_UNPACK_LOCAL = "DownloadUnpackLocal"
	...
	CONST_FSM_STATUS_DOWNLOAD_UNPACK_LOCAL = "DownloadUnpackLocal"
