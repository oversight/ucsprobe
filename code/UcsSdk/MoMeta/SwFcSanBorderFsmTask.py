...
class SwFcSanBorderFsmTask(ManagedObject):
	def __init__(self):
		ManagedObject.__init__(self,"SwFcSanBorderFsmTask")

	@staticmethod
	def ClassId():
		return "swFcSanBorderFsmTask"
	...
	CONST_ITEM_ACTIVATE_ZONE_SET = "ActivateZoneSet"
