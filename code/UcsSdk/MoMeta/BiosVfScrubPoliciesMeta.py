...
PROPERTY_DICT = {
	...
	"VpDemandScrub":UcsPropertyMeta("VpDemandScrub", "vpDemandScrub", "string", _VersionMeta.Version222c, UcsPropertyMeta.ReadWrite, 0x10L, None, None, None, ["disabled", "enabled", "platform-default", "platform-recommended"], ["0-4294967295"]),
	"VpPatrolScrub":UcsPropertyMeta("VpPatrolScrub", "vpPatrolScrub", "string", _VersionMeta.Version222c, UcsPropertyMeta.ReadWrite, 0x20L, None, None, None, ["disabled", "enabled", "platform-default", "platform-recommended"], ["0-4294967295"]),
	"Meta":UcsMoMeta("BiosVfScrubPolicies", "biosVfScrubPolicies", "Scrub-Policies", _VersionMeta.Version222c, "InputOutput", 0x3fL, [], [], [None], ["admin", "ls-compute", "ls-config", "ls-server", "ls-server-policy", "pn-policy"])
}
