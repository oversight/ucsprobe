...
PROPERTY_DICT = {
	...
	"MacAddress":UcsPropertyMeta("MacAddress", "macAddress", "string", _VersionMeta.Version141i, UcsPropertyMeta.ReadWrite, 0x8L, None, None, """(([0-9a-fA-F][0-9a-fA-F]:){5}([0-9a-fA-F][0-9a-fA-F]))|0""", [], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("FabricEthTargetEp", "fabricEthTargetEp", "eth-target-ep-[Name]", _VersionMeta.Version141i, "InputOutput", 0x7fL, [], [u'faultInst'], ["Add", "Get", "Remove", "Set"], ["admin", "ext-lan-config", "ext-lan-policy"])
}
