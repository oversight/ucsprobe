...
PROPERTY_DICT = {
	...
	"PoolDn":UcsPropertyMeta("PoolDn", "poolDn", "string", _VersionMeta.Version101e, UcsPropertyMeta.ReadWrite, 0x20L, 0, 256, None, [], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("ComputePoolingPolicy", "computePoolingPolicy", "pooling-policy-[Name]", _VersionMeta.Version101e, "InputOutput", 0x1ffL, [], [], ["Add", "Get", "Remove", "Set"], ["admin", "pn-policy"])
}
