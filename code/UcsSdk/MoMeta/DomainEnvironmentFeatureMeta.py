...
PROPERTY_DICT = {
	...
	"Meta":UcsMoMeta("DomainEnvironmentFeature", "domainEnvironmentFeature", "env-feature-[Name]", _VersionMeta.Version221b, "InputOutput", 0x3fL, [], [u'domainEnvironmentParam', u'domainNetworkParam', u'domainServerParam', u'domainStorageParam'], [None], ["admin"])
}
