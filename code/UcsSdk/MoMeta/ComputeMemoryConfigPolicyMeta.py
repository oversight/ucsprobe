...
PROPERTY_DICT = {
	"BlackListing":UcsPropertyMeta("BlackListing", "blackListing", "string", _VersionMeta.Version221b, UcsPropertyMeta.ReadWrite, 0x1L, None, None, None, ["disabled", "enabled"], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("ComputeMemoryConfigPolicy", "computeMemoryConfigPolicy", "memory-config-[Name]", _VersionMeta.Version221b, "InputOutput", 0xffL, [], [], ["Get", "Set"], ["admin", "ls-server-policy", "pn-policy"])
}
