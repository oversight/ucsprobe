...
PROPERTY_DICT = {
	...
	"Meta":UcsMoMeta("AdaptorHostFcIfProfile", "adaptorHostFcIfProfile", "fc-profile-[Name]", _VersionMeta.Version101e, "InputOutput", 0x7fL, [], [u'adaptorFcCdbWorkQueueProfile', u'adaptorFcErrorRecoveryProfile', u'adaptorFcInterruptProfile', u'adaptorFcPortFLogiProfile', u'adaptorFcPortPLogiProfile', u'adaptorFcPortProfile', u'adaptorFcRecvQueueProfile', u'adaptorFcWorkQueueProfile'], ["Add", "Get", "Remove", "Set"], ["admin", "ls-config-policy", "ls-server-policy", "ls-storage"])
}
