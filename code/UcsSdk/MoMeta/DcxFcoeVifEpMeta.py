...
PROPERTY_DICT = {
	...
	"Id":UcsPropertyMeta("Id", "id", "uint", _VersionMeta.Version222c, UcsPropertyMeta.Naming, 0x4L, None, None, None, [], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("DcxFcoeVifEp", "dcxFcoeVifEp", "fcoevif-[Id]", _VersionMeta.Version222c, "InputOutput", 0x1fL, [], [u'swVsan'], [None], ["read-only"])
}
