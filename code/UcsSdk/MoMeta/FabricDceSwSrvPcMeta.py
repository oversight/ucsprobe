...
PROPERTY_DICT = {
	"AdminState":UcsPropertyMeta("AdminState", "adminState", "string", _VersionMeta.Version201m, UcsPropertyMeta.ReadOnly, None, None, None, None, ["disabled", "enabled"], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("FabricDceSwSrvPc", "fabricDceSwSrvPc", "pc-[PortId]", _VersionMeta.Version201m, "InputOutput", 0x7fL, [], [u'fabricDceSwSrvPcEp', u'faultInst'], ["Get"], ["admin", "ls-network", "ls-network-policy"])
}
