...
PROPERTY_DICT = {
	"AirflowDirection":UcsPropertyMeta("AirflowDirection", "airflowDirection", "string", _VersionMeta.Version201m, UcsPropertyMeta.ReadOnly, None, None, None, None, ["BackToFront", "FrontToBack", "unknown"], ["0-4294967295"]),
	...
	"Intervals":UcsPropertyMeta("Intervals", "intervals", "uint", _VersionMeta.Version201m, UcsPropertyMeta.ReadOnly, None, None, None, None, [], ["0-4294967295"]),
	...
	"Update":UcsPropertyMeta("Update", "update", "uint", _VersionMeta.Version201m, UcsPropertyMeta.ReadOnly, None, None, None, None, [], ["0-4294967295"]),
	"Meta":UcsMoMeta("EquipmentNetworkElementFanStats", "equipmentNetworkElementFanStats", "stats", _VersionMeta.Version201m, "OutputOnly", 0x0L, [], [u'equipmentNetworkElementFanStatsHist'], ["Get"], ["admin", "operations", "read-only"])
}
