...
PROPERTY_DICT = {
	...
	"Temp":UcsPropertyMeta("Temp", "temp", "string", _VersionMeta.Version131c, UcsPropertyMeta.ReadOnly, None, None, None, None, ["not-applicable"], ["0-4294967295"]),
	"TempAvg":UcsPropertyMeta("TempAvg", "tempAvg", "string", _VersionMeta.Version131c, UcsPropertyMeta.ReadOnly, None, None, None, None, ["not-applicable"], ["0-4294967295"]),
	"TempMax":UcsPropertyMeta("TempMax", "tempMax", "string", _VersionMeta.Version131c, UcsPropertyMeta.ReadOnly, None, None, None, None, ["not-applicable"], ["0-4294967295"]),
	"TempMin":UcsPropertyMeta("TempMin", "tempMin", "string", _VersionMeta.Version131c, UcsPropertyMeta.ReadOnly, None, None, None, None, ["not-applicable"], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("EquipmentIOCardStats", "equipmentIOCardStats", "stats", _VersionMeta.Version111j, "OutputOnly", 0x0L, [], [u'equipmentIOCardStatsHist'], ["Get"], ["admin", "operations", "read-only"])
}
