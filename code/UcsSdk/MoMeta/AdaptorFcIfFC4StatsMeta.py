...
PROPERTY_DICT = {
	...
	"Meta":UcsMoMeta("AdaptorFcIfFC4Stats", "adaptorFcIfFC4Stats", "fc-if-fc4-stats", _VersionMeta.Version111j, "OutputOnly", 0x0L, [], [u'adaptorFcIfFC4StatsHist'], ["Get"], ["admin", "operations", "read-only"])
}
