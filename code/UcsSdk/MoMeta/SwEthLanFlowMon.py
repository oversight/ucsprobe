...
class SwEthLanFlowMon(ManagedObject):
	def __init__(self):
		ManagedObject.__init__(self,"SwEthLanFlowMon")

	@staticmethod
	def ClassId():
		return "swEthLanFlowMon"
	...
	CONST_FSM_PREV_DEPLOY_UPDATE_ETH_FLOW_MON = "DeployUpdateEthFlowMon"
	...
	CONST_FSM_STATUS_DEPLOY_UPDATE_ETH_FLOW_MON = "DeployUpdateEthFlowMon"
