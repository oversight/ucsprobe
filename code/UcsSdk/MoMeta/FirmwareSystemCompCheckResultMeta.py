...
PROPERTY_DICT = {
	...
	"KeyDescr":UcsPropertyMeta("KeyDescr", "keyDescr", "string", _VersionMeta.Version211a, UcsPropertyMeta.ReadOnly, None, 0, 510, None, [], ["0-4294967295"]),
	"KeyDn":UcsPropertyMeta("KeyDn", "keyDn", "string", _VersionMeta.Version211a, UcsPropertyMeta.Naming, 0x4L, 1, 510, None, [], ["0-4294967295"]),
	"NonCompDescr":UcsPropertyMeta("NonCompDescr", "nonCompDescr", "string", _VersionMeta.Version211a, UcsPropertyMeta.ReadOnly, None, 0, 510, None, [], ["0-4294967295"]),
	"NonCompDns":UcsPropertyMeta("NonCompDns", "nonCompDns", "string", _VersionMeta.Version211a, UcsPropertyMeta.ReadOnly, None, 0, 510, None, [], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("FirmwareSystemCompCheckResult", "firmwareSystemCompCheckResult", "fw-sys-CompCheckRes-[KeyDn]", _VersionMeta.Version211a, "InputOutput", 0x1fL, [], [], ["Get"], ["admin"])
}
