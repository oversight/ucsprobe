...
PROPERTY_DICT = {
	...
	"Meta":UcsMoMeta("StorageIScsiTargetIf", "storageIScsiTargetIf", "iscsi-tgt-[Name]", _VersionMeta.Version211a, "InputOutput", 0x1fL, [], [u'initiatorLunEp', u'storageAuthKey', u'storageEtherIf'], [None], ["admin"])
}
