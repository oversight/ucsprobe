...
PROPERTY_DICT = {
	...
	"SessionsPerUser":UcsPropertyMeta("SessionsPerUser", "sessionsPerUser", "ushort", _VersionMeta.Version141i, UcsPropertyMeta.ReadWrite, 0x40L, None, None, None, [], ["1-32"]),
	...
	"TotalSessions":UcsPropertyMeta("TotalSessions", "totalSessions", "ushort", _VersionMeta.Version141i, UcsPropertyMeta.ReadWrite, 0x100L, None, None, None, [], ["1-32"]),
	"Meta":UcsMoMeta("CommShellSvcLimits", "commShellSvcLimits", "shell-svc-limits", _VersionMeta.Version141i, "InputOutput", 0x1ffL, [], [], ["Get"], ["aaa", "admin"])
}
