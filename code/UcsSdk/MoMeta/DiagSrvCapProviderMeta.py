...
PROPERTY_DICT = {
	...
	"Model":UcsPropertyMeta("Model", "model", "string", _VersionMeta.Version111j, UcsPropertyMeta.Naming, 0x4L, 1, 510, None, [], ["0-4294967295"]),
	...
	"Revision":UcsPropertyMeta("Revision", "revision", "string", _VersionMeta.Version111j, UcsPropertyMeta.Naming, 0x10L, 1, 510, None, [], ["0-4294967295"]),
	...
	"Vendor":UcsPropertyMeta("Vendor", "vendor", "string", _VersionMeta.Version111j, UcsPropertyMeta.Naming, 0x80L, 1, 510, None, [], ["0-4294967295"]),
	"Meta":UcsMoMeta("DiagSrvCapProvider", "diagSrvCapProvider", "manufacturer-[Vendor]-model-[Model]-revision-[Revision]", _VersionMeta.Version111j, "InputOutput", 0xffL, [], [u'equipmentManufacturingDef', u'equipmentPhysicalDef', u'equipmentPicture', u'equipmentServiceDef', u'equipmentSlotArray', u'equipmentSlotArrayRef', u'firmwareType', u'firmwareUpgradeConstraint'], ["Get"], [""])
}
