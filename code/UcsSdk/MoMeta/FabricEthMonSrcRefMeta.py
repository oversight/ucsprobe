...
PROPERTY_DICT = {
	...
	"SourceType":UcsPropertyMeta("SourceType", "sourceType", "string", _VersionMeta.Version141i, UcsPropertyMeta.ReadOnly, None, None, None, None, ["fcoeuplink-port", "fcoeuplink-portchannel", "host-port", "nas-port", "nas-port-channel", "port-channel", "server-port", "storage", "uplink-port", "vhba", "vlan", "vm-nic", "vnic"], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("FabricEthMonSrcRef", "fabricEthMonSrcRef", "src-ref-[Id]", _VersionMeta.Version141i, "InputOutput", 0x1fL, [], [], ["Get"], ["admin", "ext-lan-config", "ext-lan-policy"])
}
