...
class SysfileMutationFsm(ManagedObject):
	def __init__(self):
		ManagedObject.__init__(self,"SysfileMutationFsm")

	@staticmethod
	def ClassId():
		return "sysfileMutationFsm"
	...
	CONST_CURRENT_FSM_GLOBAL = "Global"
	CONST_CURRENT_FSM_SINGLE = "Single"
