...
PROPERTY_DICT = {
	...
	"Initiator":UcsPropertyMeta("Initiator", "initiator", "string", _VersionMeta.Version101e, UcsPropertyMeta.ReadWrite, 0x4L, 0, 256, """(([A-Fa-f0-9][A-Fa-f0-9]:){7}[A-Fa-f0-9][A-Fa-f0-9])|0""", [], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("VnicFcOEIf", "vnicFcOEIf", "fcoe", _VersionMeta.Version101e, "InputOutput", 0x3fL, [], [], ["Get"], ["admin", "ext-lan-config", "ext-lan-policy", "ext-san-config", "ext-san-policy", "ls-config", "ls-server", "ls-storage"])
}
