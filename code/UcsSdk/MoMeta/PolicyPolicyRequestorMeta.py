...
PROPERTY_DICT = {
	...
	"OnBehalfOfIdent":UcsPropertyMeta("OnBehalfOfIdent", "onBehalfOfIdent", "string", _VersionMeta.Version211a, UcsPropertyMeta.CreateOnly, 0x8L, 0, 510, None, [], ["0-4294967295"]),
	"OnBehalfOfType":UcsPropertyMeta("OnBehalfOfType", "onBehalfOfType", "string", _VersionMeta.Version211a, UcsPropertyMeta.ReadOnly, None, 0, 510, None, [], ["0-4294967295"]),
	"ResolvedClassType":UcsPropertyMeta("ResolvedClassType", "resolvedClassType", "string", _VersionMeta.Version221b, UcsPropertyMeta.ReadOnly, None, 0, 510, None, [], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("PolicyPolicyRequestor", "policyPolicyRequestor", "requestor-[Name]", _VersionMeta.Version211a, "InputOutput", 0x3fL, [], [], [None], ["admin"])
}
