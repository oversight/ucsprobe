...
PROPERTY_DICT = {
	...
	"Name":UcsPropertyMeta("Name", "name", "string", _VersionMeta.Version211a, UcsPropertyMeta.Naming, None, None, None, None, ["ResolveScrubPolicyBegin", "ResolveScrubPolicyFail", "ResolveScrubPolicyResolve", "ResolveScrubPolicySuccess", "nop"], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("ComputeServerDiscPolicyFsmStage", "computeServerDiscPolicyFsmStage", "stage-[Name]", _VersionMeta.Version211a, "OutputOnly", 0x0L, [], [], [None], [""])
}
