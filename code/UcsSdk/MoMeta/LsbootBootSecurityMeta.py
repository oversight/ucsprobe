...
PROPERTY_DICT = {
	...
	"SecureBoot":UcsPropertyMeta("SecureBoot", "secureBoot", "string", _VersionMeta.Version221b, UcsPropertyMeta.ReadWrite, 0x8L, None, None, None, ["false", "no", "true", "yes"], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("LsbootBootSecurity", "lsbootBootSecurity", "boot-security", _VersionMeta.Version221b, "InputOutput", 0x1fL, [], [], ["Add", "Get", "Remove", "Set"], ["admin", "ls-config-policy", "ls-server-policy", "ls-storage-policy"])
}
