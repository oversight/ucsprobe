...
PROPERTY_DICT = {
	...
	"DstDn":UcsPropertyMeta("DstDn", "dstDn", "string", _VersionMeta.Version101e, UcsPropertyMeta.ReadWrite, 0x8L, 0, 256, None, [], ["0-4294967295"]),
	...
	"SrcTemplName":UcsPropertyMeta("SrcTemplName", "srcTemplName", "string", _VersionMeta.Version101e, UcsPropertyMeta.ReadWrite, 0x100L, None, None, None, [], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("ComputeAutoconfigPolicy", "computeAutoconfigPolicy", "autoconfig-[Name]", _VersionMeta.Version101e, "InputOutput", 0x3ffL, [], [], ["Get", "Set"], ["admin", "pn-policy"])
}
