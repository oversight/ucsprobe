...
PROPERTY_DICT = {
	"AdminSpeed":UcsPropertyMeta("AdminSpeed", "adminSpeed", "string", _VersionMeta.Version141i, UcsPropertyMeta.ReadOnly, None, None, None, None, ["1gbps", "2gbps", "4gbps", "8gbps", "auto", "indeterminate"], ["0-4294967295"]),
	...
	"FillPattern":UcsPropertyMeta("FillPattern", "fillPattern", "string", _VersionMeta.Version212a, UcsPropertyMeta.ReadOnly, None, None, None, None, ["arbff", "idle"], ["0-4294967295"]),
	...
	"PortVsanId":UcsPropertyMeta("PortVsanId", "portVsanId", "uint", _VersionMeta.Version101e, UcsPropertyMeta.ReadOnly, None, None, None, None, [], ["1-4093"]),
	...
	"Meta":UcsMoMeta("SwFcSanEp", "swFcSanEp", "ep-slot-[SlotId]port-[PortId]", _VersionMeta.Version101e, "InputOutput", 0xffL, [], [], ["Get"], ["read-only"])
}
