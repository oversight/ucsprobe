...
class EpqosDefinitionDelTaskFsm(ManagedObject):
	def __init__(self):
		ManagedObject.__init__(self,"EpqosDefinitionDelTaskFsm")

	@staticmethod
	def ClassId():
		return "epqosDefinitionDelTaskFsm"
	...
	CONST_CURRENT_FSM_REMOVE = "Remove"
