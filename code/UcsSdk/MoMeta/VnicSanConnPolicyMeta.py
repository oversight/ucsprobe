...
PROPERTY_DICT = {
	...
	"Meta":UcsMoMeta("VnicSanConnPolicy", "vnicSanConnPolicy", "san-conn-pol-[Name]", _VersionMeta.Version211a, "InputOutput", 0x7fL, [], [u'storageIniGroup', u'vnicFc', u'vnicFcNode'], ["Add", "Get", "Remove", "Set"], ["admin", "ls-config", "ls-server", "ls-storage"])
}
