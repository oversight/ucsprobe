...
PROPERTY_DICT = {
	"Action":UcsPropertyMeta("Action", "action", "string", _VersionMeta.Version102d, UcsPropertyMeta.ReadOnly, None, None, None, None, ["setRev", "setRevStrict", "setRevToOne", "unknown"], ["0-4294967295"]),
	...
	"ConstraintType":UcsPropertyMeta("ConstraintType", "constraintType", "string", _VersionMeta.Version102d, UcsPropertyMeta.ReadOnly, None, None, None, None, ["kit", "unknown"], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("EquipmentMemoryUnitDiscoveryModifierDef", "equipmentMemoryUnitDiscoveryModifierDef", "discmod-[Name]", _VersionMeta.Version102d, "InputOutput", 0x7fL, [], [], ["Get"], [""])
}
