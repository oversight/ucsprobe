...
PROPERTY_DICT = {
	...
	"Port":UcsPropertyMeta("Port", "port", "uint", _VersionMeta.Version101e, UcsPropertyMeta.ReadWrite, 0x40L, None, None, None, [], ["1-65535"]),
	...
	"RedirectState":UcsPropertyMeta("RedirectState", "redirectState", "string", _VersionMeta.Version141i, UcsPropertyMeta.ReadWrite, 0x80L, None, None, None, ["disabled", "enabled"], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("CommHttp", "commHttp", "http-svc", _VersionMeta.Version101e, "InputOutput", 0x3ffL, [], [], ["Get", "Set"], ["aaa", "admin"])
}
