...
PROPERTY_DICT = {
	...
	"Meta":UcsMoMeta("TopSysDefaults", "topSysDefaults", "sys-defaults", _VersionMeta.Version142b, "InputOutput", 0xfL, [], [u'capabilityNetworkLimits', u'capabilityStorageLimits', u'capabilitySystemLimits', u'swFabricZoneNsOverride', u'swVlanPortNsOverride'], ["Get"], ["read-only"])
}
