...
PROPERTY_DICT = {
	...
	"Meta":UcsMoMeta("CapabilityNetworkLimits", "capabilityNetworkLimits", "network-limits", _VersionMeta.Version211a, "InputOutput", 0xfL, [], [u'capabilityFeatureLimits'], [None], ["read-only"])
}
