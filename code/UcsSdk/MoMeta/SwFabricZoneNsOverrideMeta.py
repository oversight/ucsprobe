...
PROPERTY_DICT = {
	...
	"Limit":UcsPropertyMeta("Limit", "limit", "uint", _VersionMeta.Version211a, UcsPropertyMeta.ReadWrite, 0x4L, None, None, None, [], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("SwFabricZoneNsOverride", "swFabricZoneNsOverride", "fabric-zone-override", _VersionMeta.Version211a, "InputOutput", 0x1fL, [], [], [None], ["admin"])
}
