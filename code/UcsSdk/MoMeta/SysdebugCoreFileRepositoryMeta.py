...
PROPERTY_DICT = {
	...
	"Meta":UcsMoMeta("SysdebugCoreFileRepository", "sysdebugCoreFileRepository", "corefiles", _VersionMeta.Version101e, "InputOutput", 0xfL, [], [u'sysdebugCore', u'sysfileMutation'], ["Get"], ["admin", "operations"])
}
