...
PROPERTY_DICT = {
	"Astring":UcsPropertyMeta("Astring", "astring", "string", _VersionMeta.Version101e, UcsPropertyMeta.ReadWrite, 0x1L, None, None, """[\-\.:_a-zA-Z0-9]{6,93}""", [], ["0-4294967295"]),
	...
	"Name":UcsPropertyMeta("Name", "name", "string", _VersionMeta.Version101e, UcsPropertyMeta.ReadWrite, 0x10L, None, None, """[abcdefghijklmnoprstuvwyA-Z0-9]{1,20}""", [], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("ClitestTypeTestChild", "clitestTypeTestChild", "tt-child", _VersionMeta.Version101e, "InputOutput", 0xffL, [], [], ["Get"], ["admin"])
}
