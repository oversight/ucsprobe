...
class PolicyControlledType(ManagedObject):
	def __init__(self):
		ManagedObject.__init__(self,"PolicyControlledType")

	@staticmethod
	def ClassId():
		return "policyControlledType"
	...
	CONST_FSM_PREV_OPERATE_RESOLVE_ALL = "OperateResolveAll"
	...
	CONST_FSM_STATUS_OPERATE_RESOLVE_ALL = "OperateResolveAll"
