...
PROPERTY_DICT = {
	...
	"ReceiveSideScaling":UcsPropertyMeta("ReceiveSideScaling", "receiveSideScaling", "string", _VersionMeta.Version101e, UcsPropertyMeta.ReadWrite, 0x4L, None, None, None, ["disabled", "enabled"], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("AdaptorRssProfile", "adaptorRssProfile", "rss", _VersionMeta.Version101e, "InputOutput", 0x1fL, [], [], ["Get", "Set"], ["admin", "ls-config-policy", "ls-network", "ls-server-policy"])
}
