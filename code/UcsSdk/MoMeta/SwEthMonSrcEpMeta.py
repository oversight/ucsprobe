...
PROPERTY_DICT = {
	...
	"ChassisId":UcsPropertyMeta("ChassisId", "chassisId", "string", _VersionMeta.Version141i, UcsPropertyMeta.Naming, 0x2L, None, None, None, ["N/A"], ["0-255"]),
	...
	"Meta":UcsMoMeta("SwEthMonSrcEp", "swEthMonSrcEp", "mon-src-[ChassisId]-[SlotId]-[PortId]", _VersionMeta.Version141i, "InputOutput", 0x1ffL, [], [], ["Get"], ["read-only"])
}
