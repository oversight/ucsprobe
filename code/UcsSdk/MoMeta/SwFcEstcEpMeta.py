...
PROPERTY_DICT = {
	...
	"PortVsanId":UcsPropertyMeta("PortVsanId", "portVsanId", "uint", _VersionMeta.Version141i, UcsPropertyMeta.ReadWrite, 0x20L, None, None, None, [], ["1-4093"]),
	...
	"Meta":UcsMoMeta("SwFcEstcEp", "swFcEstcEp", "fcestc-ep-slot-[SlotId]port-[PortId]", _VersionMeta.Version141i, "InputOutput", 0x1ffL, [], [], ["Get"], ["read-only"])
}
