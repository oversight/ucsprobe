...
PROPERTY_DICT = {
	...
	"Meta":UcsMoMeta("AdaptorIpV4RssHashProfile", "adaptorIpV4RssHashProfile", "ipv4-rss-hash", _VersionMeta.Version101e, "InputOutput", 0xfL, [], [], ["Get"], ["admin", "ls-config-policy", "ls-network", "ls-server-policy"])
}
