...
PROPERTY_DICT = {
	...
	"Meta":UcsMoMeta("FabricLanPinGroup", "fabricLanPinGroup", "lan-pin-group-[Name]", _VersionMeta.Version101e, "InputOutput", 0x7fL, [], [u'fabricLanPinTarget', u'faultInst'], ["Add", "Get", "Remove", "Set"], ["admin", "ext-lan-config", "ext-lan-policy"])
}
