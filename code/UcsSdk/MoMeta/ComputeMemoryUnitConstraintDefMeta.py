...
PROPERTY_DICT = {
	...
	"RevisionModifier":UcsPropertyMeta("RevisionModifier", "revisionModifier", "string", _VersionMeta.Version131i, UcsPropertyMeta.ReadOnly, None, 0, 510, None, [], ["0-4294967295"]),
	...
	"Type":UcsPropertyMeta("Type", "type", "string", _VersionMeta.Version102d, UcsPropertyMeta.ReadOnly, None, None, None, None, ["kit", "unknown"], ["0-4294967295"]),
	"Meta":UcsMoMeta("ComputeMemoryUnitConstraintDef", "computeMemoryUnitConstraintDef", "dc-[Name]", _VersionMeta.Version102d, "InputOutput", 0x7fL, [], [], ["Get"], [""])
}
