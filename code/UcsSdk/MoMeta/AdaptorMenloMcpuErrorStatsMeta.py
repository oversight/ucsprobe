...
PROPERTY_DICT = {
	...
	"MenloMcpuIndex":UcsPropertyMeta("MenloMcpuIndex", "menloMcpuIndex", "string", _VersionMeta.Version111j, UcsPropertyMeta.Naming, None, None, None, None, ["0", "0_A", "0_B", "1", "1_A", "1_B", "unknown"], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("AdaptorMenloMcpuErrorStats", "adaptorMenloMcpuErrorStats", "menlo-mcpu-error-stats-[MenloMcpuIndex]", _VersionMeta.Version111j, "OutputOnly", 0x0L, [], [u'adaptorMenloMcpuErrorStatsHist'], ["Get"], ["admin", "operations", "read-only"])
}
