...
PROPERTY_DICT = {
	...
	"GroupName":UcsPropertyMeta("GroupName", "groupName", "string", _VersionMeta.Version141i, UcsPropertyMeta.Naming, 0x4L, None, None, """[\-\.:_a-zA-Z0-9]{1,16}""", [], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("PowerGroupQual", "powerGroupQual", "power-group-[GroupName]", _VersionMeta.Version141i, "InputOutput", 0x1fL, [], [], ["Add", "Get", "Remove"], ["admin", "pn-policy"])
}
