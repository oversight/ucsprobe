...
PROPERTY_DICT = {
	...
	"Meta":UcsMoMeta("AdaptorHostIscsiIfProfile", "adaptorHostIscsiIfProfile", "iscsi-profile-[Name]", _VersionMeta.Version201m, "InputOutput", 0x7fL, [], [u'adaptorProtocolProfile'], ["Add", "Get", "Remove", "Set"], ["admin", "ls-config-policy", "ls-network", "ls-server-policy"])
}
