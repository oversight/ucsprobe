...
class FabricFcoeEstcEp(ManagedObject):
	def __init__(self):
		ManagedObject.__init__(self,"FabricFcoeEstcEp")

	@staticmethod
	def ClassId():
		return "fabricFcoeEstcEp"
	...
	CONST_FCOE_STATE_DOWN = "down"
	CONST_FCOE_STATE_ERROR_MISCONFIGURED = "error-misconfigured"
	CONST_FCOE_STATE_UNKNOWN = "unknown"
