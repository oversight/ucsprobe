...
PROPERTY_DICT = {
	"Action":UcsPropertyMeta("Action", "action", "string", _VersionMeta.Version211a, UcsPropertyMeta.ReadWrite, 0x1L, None, None, None, ["auto-acknowledged", "user-acknowledged"], ["0-4294967295"]),
	...
	"Qualifier":UcsPropertyMeta("Qualifier", "qualifier", "string", _VersionMeta.Version211a, UcsPropertyMeta.ReadWrite, 0x40L, None, None, """[\-\.:_a-zA-Z0-9]{0,16}""", [], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("ComputeServerMgmtPolicy", "computeServerMgmtPolicy", "server-mgmt-policy", _VersionMeta.Version211a, "InputOutput", 0x1ffL, [], [], ["Get", "Set"], ["admin", "pn-policy"])
}
