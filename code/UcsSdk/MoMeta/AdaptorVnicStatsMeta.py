...
PROPERTY_DICT = {
	...
	"DroppedRx":UcsPropertyMeta("DroppedRx", "droppedRx", "ulong", _VersionMeta.Version111j, UcsPropertyMeta.ReadOnly, None, None, None, None, [], ["0-4294967295"]),
	"DroppedRxDelta":UcsPropertyMeta("DroppedRxDelta", "droppedRxDelta", "ulong", _VersionMeta.Version111j, UcsPropertyMeta.ReadOnly, None, None, None, None, [], ["0-4294967295"]),
	"DroppedRxDeltaAvg":UcsPropertyMeta("DroppedRxDeltaAvg", "droppedRxDeltaAvg", "ulong", _VersionMeta.Version111j, UcsPropertyMeta.ReadOnly, None, None, None, None, [], ["0-4294967295"]),
	"DroppedRxDeltaMax":UcsPropertyMeta("DroppedRxDeltaMax", "droppedRxDeltaMax", "ulong", _VersionMeta.Version111j, UcsPropertyMeta.ReadOnly, None, None, None, None, [], ["0-4294967295"]),
	"DroppedRxDeltaMin":UcsPropertyMeta("DroppedRxDeltaMin", "droppedRxDeltaMin", "ulong", _VersionMeta.Version111j, UcsPropertyMeta.ReadOnly, None, None, None, None, [], ["0-4294967295"]),
	"DroppedTx":UcsPropertyMeta("DroppedTx", "droppedTx", "ulong", _VersionMeta.Version111j, UcsPropertyMeta.ReadOnly, None, None, None, None, [], ["0-4294967295"]),
	"DroppedTxDelta":UcsPropertyMeta("DroppedTxDelta", "droppedTxDelta", "ulong", _VersionMeta.Version111j, UcsPropertyMeta.ReadOnly, None, None, None, None, [], ["0-4294967295"]),
	"DroppedTxDeltaAvg":UcsPropertyMeta("DroppedTxDeltaAvg", "droppedTxDeltaAvg", "ulong", _VersionMeta.Version111j, UcsPropertyMeta.ReadOnly, None, None, None, None, [], ["0-4294967295"]),
	"DroppedTxDeltaMax":UcsPropertyMeta("DroppedTxDeltaMax", "droppedTxDeltaMax", "ulong", _VersionMeta.Version111j, UcsPropertyMeta.ReadOnly, None, None, None, None, [], ["0-4294967295"]),
	"DroppedTxDeltaMin":UcsPropertyMeta("DroppedTxDeltaMin", "droppedTxDeltaMin", "ulong", _VersionMeta.Version111j, UcsPropertyMeta.ReadOnly, None, None, None, None, [], ["0-4294967295"]),
	"ErrorsRx":UcsPropertyMeta("ErrorsRx", "errorsRx", "ulong", _VersionMeta.Version111j, UcsPropertyMeta.ReadOnly, None, None, None, None, [], ["0-4294967295"]),
	"ErrorsRxDelta":UcsPropertyMeta("ErrorsRxDelta", "errorsRxDelta", "ulong", _VersionMeta.Version111j, UcsPropertyMeta.ReadOnly, None, None, None, None, [], ["0-4294967295"]),
	"ErrorsRxDeltaAvg":UcsPropertyMeta("ErrorsRxDeltaAvg", "errorsRxDeltaAvg", "ulong", _VersionMeta.Version111j, UcsPropertyMeta.ReadOnly, None, None, None, None, [], ["0-4294967295"]),
	"ErrorsRxDeltaMax":UcsPropertyMeta("ErrorsRxDeltaMax", "errorsRxDeltaMax", "ulong", _VersionMeta.Version111j, UcsPropertyMeta.ReadOnly, None, None, None, None, [], ["0-4294967295"]),
	"ErrorsRxDeltaMin":UcsPropertyMeta("ErrorsRxDeltaMin", "errorsRxDeltaMin", "ulong", _VersionMeta.Version111j, UcsPropertyMeta.ReadOnly, None, None, None, None, [], ["0-4294967295"]),
	"ErrorsTx":UcsPropertyMeta("ErrorsTx", "errorsTx", "ulong", _VersionMeta.Version111j, UcsPropertyMeta.ReadOnly, None, None, None, None, [], ["0-4294967295"]),
	"ErrorsTxDelta":UcsPropertyMeta("ErrorsTxDelta", "errorsTxDelta", "ulong", _VersionMeta.Version111j, UcsPropertyMeta.ReadOnly, None, None, None, None, [], ["0-4294967295"]),
	"ErrorsTxDeltaAvg":UcsPropertyMeta("ErrorsTxDeltaAvg", "errorsTxDeltaAvg", "ulong", _VersionMeta.Version111j, UcsPropertyMeta.ReadOnly, None, None, None, None, [], ["0-4294967295"]),
	"ErrorsTxDeltaMax":UcsPropertyMeta("ErrorsTxDeltaMax", "errorsTxDeltaMax", "ulong", _VersionMeta.Version111j, UcsPropertyMeta.ReadOnly, None, None, None, None, [], ["0-4294967295"]),
	"ErrorsTxDeltaMin":UcsPropertyMeta("ErrorsTxDeltaMin", "errorsTxDeltaMin", "ulong", _VersionMeta.Version111j, UcsPropertyMeta.ReadOnly, None, None, None, None, [], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("AdaptorVnicStats", "adaptorVnicStats", "vnic-stats", _VersionMeta.Version111j, "OutputOnly", 0x0L, [], [u'adaptorVnicStatsHist'], ["Get"], ["admin", "operations", "read-only"])
}
