...
class SysdebugTechSupportFsm(ManagedObject):
	def __init__(self):
		ManagedObject.__init__(self,"SysdebugTechSupportFsm")

	@staticmethod
	def ClassId():
		return "sysdebugTechSupportFsm"
	...
	CONST_CURRENT_FSM_DELETE_TECH_SUP_FILE = "DeleteTechSupFile"
	CONST_CURRENT_FSM_DOWNLOAD = "Download"
	CONST_CURRENT_FSM_INITIATE = "Initiate"
