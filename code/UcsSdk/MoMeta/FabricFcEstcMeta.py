...
PROPERTY_DICT = {
	...
	"Meta":UcsMoMeta("FabricFcEstc", "fabricFcEstc", "[Id]", _VersionMeta.Version141i, "InputOutput", 0x3fL, [], [u'fabricFcEstcEp', u'fabricFcoeEstcEp', u'fabricVsan'], ["Get"], ["admin", "ext-san-config", "ext-san-policy"])
}
