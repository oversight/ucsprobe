...
PROPERTY_DICT = {
	...
	"Inst":UcsPropertyMeta("Inst", "inst", "ushort", _VersionMeta.Version111j, UcsPropertyMeta.Naming, 0x4L, None, None, None, [], ["0-4294967295"]),
	"Key":UcsPropertyMeta("Key", "key", "string", _VersionMeta.Version111j, UcsPropertyMeta.ReadOnly, None, 1, 33, None, [], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("ExtvmmKeyInst", "extvmmKeyInst", "key-[Inst]", _VersionMeta.Version111j, "InputOutput", 0x1fL, [], [], ["Get"], ["read-only"])
}
