...
PROPERTY_DICT = {
	...
	"ConfigStatus":UcsPropertyMeta("ConfigStatus", "configStatus", "string", _VersionMeta.Version141i, UcsPropertyMeta.ReadOnly, None, None, None, None, ["applied", "incompatible-speed"], ["0-4294967295"]),
	...
	"OperSpeed":UcsPropertyMeta("OperSpeed", "operSpeed", "uint", _VersionMeta.Version141i, UcsPropertyMeta.ReadOnly, None, None, None, None, [], ["0-4294967295"]),
	...
	"PortId":UcsPropertyMeta("PortId", "portId", "uint", _VersionMeta.Version101e, UcsPropertyMeta.Naming, 0x40L, None, None, None, [], ["1-256"]),
	...
	"Meta":UcsMoMeta("FabricFcSanPc", "fabricFcSanPc", "pc-[PortId]", _VersionMeta.Version101e, "InputOutput", 0x1ffL, [], [u'fabricFcMonSrcEp', u'fabricFcSanPcEp', u'fabricVsanEp', u'fabricVsanMembership', u'faultInst', u'fcErrStats', u'fcStats'], ["Add", "Get", "Remove", "Set"], ["admin", "ext-san-config", "ext-san-policy"])
}
