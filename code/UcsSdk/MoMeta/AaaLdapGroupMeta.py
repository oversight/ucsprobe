...
PROPERTY_DICT = {
	...
	"Name":UcsPropertyMeta("Name", "name", "string", _VersionMeta.Version141i, UcsPropertyMeta.Naming, 0x8L, None, None, """[\t\n\x0b\x0c\r !""#$%&'\(\)\*\+,\-\./:;<=>\?@\[\\\]\^_`\{\|\}~a-zA-Z0-9]{1,240}""", [], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("AaaLdapGroup", "aaaLdapGroup", "ldapgroup-[Name]", _VersionMeta.Version141i, "InputOutput", 0x3fL, [], [u'aaaUserLocale', u'aaaUserRole'], ["Add", "Get", "Remove", "Set"], ["aaa", "admin"])
}
