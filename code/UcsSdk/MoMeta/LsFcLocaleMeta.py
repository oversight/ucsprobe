...
PROPERTY_DICT = {
	...
	"SwitchId":UcsPropertyMeta("SwitchId", "switchId", "string", _VersionMeta.Version211a, UcsPropertyMeta.Naming, 0x10L, None, None, None, ["A", "B", "NONE"], ["0-4294967295"]),
	"Meta":UcsMoMeta("LsFcLocale", "lsFcLocale", "fc-local-[SwitchId]", _VersionMeta.Version211a, "InputOutput", 0x1fL, [], [u'lsFcZoneGroup'], [None], ["admin", "ls-storage"])
}
