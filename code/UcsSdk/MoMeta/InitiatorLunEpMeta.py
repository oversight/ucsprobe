...
PROPERTY_DICT = {
	"Bootable":UcsPropertyMeta("Bootable", "bootable", "string", _VersionMeta.Version211a, UcsPropertyMeta.ReadOnly, None, None, None, None, ["false", "no", "true", "yes"], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("InitiatorLunEp", "initiatorLunEp", "lun-[Id]", _VersionMeta.Version211a, "InputOutput", 0x1fL, [], [], [None], ["read-only"])
}
