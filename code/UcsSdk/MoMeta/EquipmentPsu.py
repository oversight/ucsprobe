...
class EquipmentPsu(ManagedObject):
	...
	CONST_POWER_STATE_QUALIFIER_AMBIENT_TEMPERATURE_WARNING = "ambient-temperature-warning"
	CONST_POWER_STATE_QUALIFIER_FAILURE = "failure"
	CONST_POWER_STATE_QUALIFIER_FAN_FAILURE = "fan-failure"
	CONST_POWER_STATE_QUALIFIER_INPUT_CURRENT_WARNING = "input-current-warning"
	CONST_POWER_STATE_QUALIFIER_INPUT_LOSS = "input-loss"
	CONST_POWER_STATE_QUALIFIER_INPUT_VOLTAGE_WARNING = "input-voltage-warning"
	CONST_POWER_STATE_QUALIFIER_OUTPUT_CURRENT_WARNING = "output-current-warning"
	CONST_POWER_STATE_QUALIFIER_OVER_CURRENT = "over-current"
	CONST_POWER_STATE_QUALIFIER_OVER_TEMPERATURE = "over-temperature"
	CONST_POWER_STATE_QUALIFIER_UNKNOWN = "unknown"
