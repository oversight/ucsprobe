...
PROPERTY_DICT = {
	...
	"Meta":UcsMoMeta("LsbootUsbFlashStorageImage", "lsbootUsbFlashStorageImage", "sd-card", _VersionMeta.Version221b, "InputOutput", 0x1fL, [], [], ["Add", "Get", "Remove", "Set"], ["admin", "ls-compute", "ls-config", "ls-config-policy", "ls-server", "ls-server-policy", "ls-storage", "ls-storage-policy"])
}
