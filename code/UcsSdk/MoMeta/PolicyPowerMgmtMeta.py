...
PROPERTY_DICT = {
	...
	"Meta":UcsMoMeta("PolicyPowerMgmt", "policyPowerMgmt", "powermgmt-ctrl", _VersionMeta.Version211a, "InputOutput", 0x1fL, [], [u'policyControlledInstance', u'policyControlledType'], ["Add", "Get", "Set"], ["admin", "power-mgmt"])
}
