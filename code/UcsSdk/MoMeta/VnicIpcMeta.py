...
PROPERTY_DICT = {
	...
	"Meta":UcsMoMeta("VnicIpc", "vnicIpc", "ipc-[Name]", _VersionMeta.Version101e, "InputOutput", 0x1ffffL, [], [u'fabricEthMonSrcEp', u'fabricFcMonSrcEp', u'fabricNetflowMonSrcEp', u'faultInst', u'vnicEtherIf', u'vnicFcOEIf'], ["Get"], ["admin", "ls-config", "ls-network", "ls-server"])
}
