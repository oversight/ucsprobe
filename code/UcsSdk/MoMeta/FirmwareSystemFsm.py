...
class FirmwareSystemFsm(ManagedObject):
	def __init__(self):
		ManagedObject.__init__(self,"FirmwareSystemFsm")

	@staticmethod
	def ClassId():
		return "firmwareSystemFsm"
	...
	CONST_CURRENT_FSM_APPLY_CATALOG_PACK = "ApplyCatalogPack"
