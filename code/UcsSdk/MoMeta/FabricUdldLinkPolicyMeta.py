...
PROPERTY_DICT = {
	...
	"Mode":UcsPropertyMeta("Mode", "mode", "string", _VersionMeta.Version221b, UcsPropertyMeta.ReadWrite, 0x10L, None, None, None, ["aggressive", "normal"], ["0-4294967295"]),
	...
	"Protocol":UcsPropertyMeta("Protocol", "protocol", "string", _VersionMeta.Version221b, UcsPropertyMeta.ReadOnly, None, None, None, None, ["cdp", "udld", "unknown"], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("FabricUdldLinkPolicy", "fabricUdldLinkPolicy", "udld-link-pol-[Name]", _VersionMeta.Version221b, "InputOutput", 0x1ffL, [], [], ["Add", "Get", "Remove", "Set"], ["admin", "ext-lan-config", "ext-lan-policy", "read-only"])
}
