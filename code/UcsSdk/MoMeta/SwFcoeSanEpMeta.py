...
PROPERTY_DICT = {
	"AdminSpeed":UcsPropertyMeta("AdminSpeed", "adminSpeed", "string", _VersionMeta.Version211a, UcsPropertyMeta.ReadOnly, None, None, None, None, ["1gbps", "2gbps", "4gbps", "8gbps", "auto", "indeterminate"], ["0-4294967295"]),
	...
	"Lc":UcsPropertyMeta("Lc", "lc", "string", _VersionMeta.Version211a, UcsPropertyMeta.ReadOnly, None, None, None, None, ["allocated", "available", "deallocated", "pending", "repurposed"], ["0-4294967295"]),
	...
	"PcId":UcsPropertyMeta("PcId", "pcId", "uint", _VersionMeta.Version211a, UcsPropertyMeta.ReadOnly, None, None, None, None, [], ["0-4294967295"]),
	...
	"PortId":UcsPropertyMeta("PortId", "portId", "uint", _VersionMeta.Version211a, UcsPropertyMeta.Naming, 0x10L, None, None, None, [], ["0-4294967295"]),
	"PortVsanId":UcsPropertyMeta("PortVsanId", "portVsanId", "uint", _VersionMeta.Version211a, UcsPropertyMeta.ReadOnly, None, None, None, None, [], ["1-4093"]),
	"Rn":UcsPropertyMeta("Rn", "rn", "string", _VersionMeta.Version211a, UcsPropertyMeta.ReadOnly, 0x20L, 0, 256, None, [], ["0-4294967295"]),
	"SlotId":UcsPropertyMeta("SlotId", "slotId", "uint", _VersionMeta.Version211a, UcsPropertyMeta.Naming, 0x40L, None, None, None, [], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("SwFcoeSanEp", "swFcoeSanEp", "fcoesan-ep-slot-[SlotId]port-[PortId]", _VersionMeta.Version211a, "InputOutput", 0xffL, [], [u'dcxFcoeVifEp', u'dcxVifEp', u'swVlan'], ["Add", "Get", "Remove", "Set"], ["read-only"])
}
