...
PROPERTY_DICT = {
	...
	"GroupPolicyName":UcsPropertyMeta("GroupPolicyName", "groupPolicyName", "string", _VersionMeta.Version211a, UcsPropertyMeta.ReadWrite, 0x8L, None, None, """[\-\.:_a-zA-Z0-9]{0,16}""", [], ["0-4294967295"]),
	...
	"Name":UcsPropertyMeta("Name", "name", "string", _VersionMeta.Version211a, UcsPropertyMeta.Naming, 0x10L, None, None, """[\-\.:_a-zA-Z0-9]{1,16}""", [], ["0-4294967295"]),
	"OperProtocol":UcsPropertyMeta("OperProtocol", "operProtocol", "string", _VersionMeta.Version211a, UcsPropertyMeta.ReadOnly, None, None, None, None, ["derived", "fc", "iscsi"], ["0-4294967295"]),
	"OperState":UcsPropertyMeta("OperState", "operState", "string", _VersionMeta.Version212a, UcsPropertyMeta.ReadOnly, None, None, None, None, ["misconfigured", "ok"], ["0-4294967295"]),
	...
	"PolicyName":UcsPropertyMeta("PolicyName", "policyName", "string", _VersionMeta.Version211a, UcsPropertyMeta.ReadWrite, 0x20L, None, None, """[\-\.:_a-zA-Z0-9]{0,16}""", [], ["0-4294967295"]),
	...
	"Protocol":UcsPropertyMeta("Protocol", "protocol", "string", _VersionMeta.Version211a, UcsPropertyMeta.CreateOnly, 0x80L, None, None, None, ["derived", "fc", "iscsi"], ["0-4294967295"]),
	"RmtDiskCfgName":UcsPropertyMeta("RmtDiskCfgName", "rmtDiskCfgName", "string", _VersionMeta.Version211a, UcsPropertyMeta.ReadWrite, 0x100L, None, None, """[\-\.:_a-zA-Z0-9]{0,16}""", [], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("StorageIniGroup", "storageIniGroup", "grp-[Name]", _VersionMeta.Version211a, "InputOutput", 0x7ffL, [], [u'faultInst', u'storageInitiator', u'vnicFcGroupDef'], ["Add", "Get", "Remove", "Set"], ["admin", "ls-compute", "ls-config", "ls-server", "ls-storage"])
}
