...
PROPERTY_DICT = {
	...
	"Meta":UcsMoMeta("EtherPIoFsmStage", "etherPIoFsmStage", "stage-[Name]", _VersionMeta.Version211a, "OutputOnly", 0x0L, [], [], [None], [""])
}
