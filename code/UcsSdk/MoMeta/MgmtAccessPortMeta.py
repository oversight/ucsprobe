...
PROPERTY_DICT = {
	...
	"Port":UcsPropertyMeta("Port", "port", "string", _VersionMeta.Version101e, UcsPropertyMeta.Naming, 0x4L, None, None, None, ["none"], ["0-65536"]),
	"Protocol":UcsPropertyMeta("Protocol", "protocol", "string", _VersionMeta.Version101e, UcsPropertyMeta.Naming, 0x8L, None, None, None, ["TCP", "UDP"], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("MgmtAccessPort", "mgmtAccessPort", "[Protocol]-port-[Port]", _VersionMeta.Version101e, "InputOutput", 0x3fL, [], [], ["Get"], ["read-only"])
}
