...
PROPERTY_DICT = {
	...
	"Meta":UcsMoMeta("ImgprovTarget", "imgprovTarget", "target-[Name]", _VersionMeta.Version141i, "InputOutput", 0x1fL, [], [u'imgsecKey'], ["Get"], ["admin", "ls-compute", "ls-config", "ls-config-policy", "ls-server"])
}
