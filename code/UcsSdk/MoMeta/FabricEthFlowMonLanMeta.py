...
PROPERTY_DICT = {
	...
	"ExporterSourceMac":UcsPropertyMeta("ExporterSourceMac", "exporterSourceMac", "string", _VersionMeta.Version221b, UcsPropertyMeta.ReadOnly, None, None, None, """(([0-9a-fA-F][0-9a-fA-F]:){5}([0-9a-fA-F][0-9a-fA-F]))|0""", [], ["0-4294967295"]),
	"Id":UcsPropertyMeta("Id", "id", "string", _VersionMeta.Version221b, UcsPropertyMeta.Naming, 0x4L, None, None, None, ["A", "B", "NONE"], ["0-4294967295"]),
	...
	"Name":UcsPropertyMeta("Name", "name", "string", _VersionMeta.Version221b, UcsPropertyMeta.CreateOnly, 0x8L, None, None, """[\-\.:_a-zA-Z0-9]{0,16}""", [], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("FabricEthFlowMonLan", "fabricEthFlowMonLan", "[Id]", _VersionMeta.Version221b, "InputOutput", 0x3fL, [], [], [None], ["admin", "ext-lan-config", "ext-lan-policy"])
}
