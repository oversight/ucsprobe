...
PROPERTY_DICT = {
	...
	"Item":UcsPropertyMeta("Item", "item", "string", _VersionMeta.Version111j, UcsPropertyMeta.Naming, None, None, None, None, ["DisableVip", "EnableHA", "EnableVip", "SwMgmtInbandIfConfig", "SwMgmtOobIfConfig", "VirtualIfConfig", "nop"], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("MgmtIfFsmTask", "mgmtIfFsmTask", "task-[Item]", _VersionMeta.Version111j, "OutputOnly", 0x0L, [], [], [None], [""])
}
