...
class MgmtIPv6IfAddrFsm(ManagedObject):
	def __init__(self):
		ManagedObject.__init__(self,"MgmtIPv6IfAddrFsm")

	@staticmethod
	def ClassId():
		return "mgmtIPv6IfAddrFsm"
	...
	CONST_CURRENT_FSM_SW_MGMT_OOB_IPV6_IF_CONFIG = "SwMgmtOobIpv6IfConfig"
