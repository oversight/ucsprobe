...
PROPERTY_DICT = {
	"AdminSpeed":UcsPropertyMeta("AdminSpeed", "adminSpeed", "string", _VersionMeta.Version202m, UcsPropertyMeta.ReadWrite, 0x1L, None, None, None, ["1gbps", "2gbps", "4gbps", "8gbps", "auto", "indeterminate"], ["0-4294967295"]),
	...
	"SlotId":UcsPropertyMeta("SlotId", "slotId", "uint", _VersionMeta.Version141i, UcsPropertyMeta.Naming, 0x100L, None, None, None, [], ["1-5"]),
	...
	"Meta":UcsMoMeta("FabricFcMonDestEp", "fabricFcMonDestEp", "dest-slot-[SlotId]-port-[PortId]", _VersionMeta.Version141i, "InputOutput", 0x3ffL, [], [u'faultInst'], ["Add", "Get", "Remove", "Set"], ["admin", "ext-san-config", "ext-san-policy"])
}
