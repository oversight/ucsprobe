...
PROPERTY_DICT = {
	...
	"IdCount":UcsPropertyMeta("IdCount", "idCount", "uint", _VersionMeta.Version211a, UcsPropertyMeta.ReadOnly, None, None, None, None, [], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("ObserveObservedCont", "observeObservedCont", "observe", _VersionMeta.Version211a, "InputOutput", 0xfL, [], [u'observeObserved'], [None], ["admin"])
}
