...
PROPERTY_DICT = {
	...
	"Password":UcsPropertyMeta("Password", "password", "string", _VersionMeta.Version201m, UcsPropertyMeta.ReadOnly, None, 0, 510, None, [], ["0-4294967295"]),
	...
	"UserId":UcsPropertyMeta("UserId", "userId", "string", _VersionMeta.Version201m, UcsPropertyMeta.ReadOnly, None, 0, 510, None, [], ["0-4294967295"]),
	"Meta":UcsMoMeta("AdaptorIscsiAuth", "adaptorIscsiAuth", "iscsi-auth", _VersionMeta.Version201m, "InputOutput", 0xfL, [], [], ["Get"], ["read-only"])
}
