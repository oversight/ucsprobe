...
PROPERTY_DICT = {
	...
	"VpUEFIBootMode":UcsPropertyMeta("VpUEFIBootMode", "vpUEFIBootMode", "string", _VersionMeta.Version213a, UcsPropertyMeta.ReadOnly, None, None, None, None, ["disabled", "enabled", "platform-default", "platform-recommended"], ["0-4294967295"]),
	"Meta":UcsMoMeta("BiosVfUCSMBootModeControl", "biosVfUCSMBootModeControl", "UCSM-Boot-Mode-Control", _VersionMeta.Version213a, "InputOutput", 0xfL, [], [], ["Get"], ["admin", "ls-compute", "ls-config", "ls-server", "ls-server-policy", "pn-policy"])
}
