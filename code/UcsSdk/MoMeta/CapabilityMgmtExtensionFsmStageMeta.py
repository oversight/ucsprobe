...
PROPERTY_DICT = {
	...
	"Name":UcsPropertyMeta("Name", "name", "string", _VersionMeta.Version211a, UcsPropertyMeta.Naming, None, None, None, None, ["ActivateMgmtExtApplyCatalog", "ActivateMgmtExtBegin", "ActivateMgmtExtCopyRemote", "ActivateMgmtExtEvaluateStatus", "ActivateMgmtExtFail", "ActivateMgmtExtRescanImages", "ActivateMgmtExtSuccess", "ActivateMgmtExtUnpackLocal", "nop"], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("CapabilityMgmtExtensionFsmStage", "capabilityMgmtExtensionFsmStage", "stage-[Name]", _VersionMeta.Version211a, "OutputOnly", 0x0L, [], [], [None], [""])
}
