...
PROPERTY_DICT = {
	...
	"Meta":UcsMoMeta("AdaptorMenloEthStats", "adaptorMenloEthStats", "menlo-eth-stats-[MenloEthIndex]", _VersionMeta.Version111j, "OutputOnly", 0x0L, [], [u'adaptorMenloEthStatsHist'], ["Get"], ["admin", "operations", "read-only"])
}
