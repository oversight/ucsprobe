...
class MgmtInterface(ManagedObject):
	def __init__(self):
		ManagedObject.__init__(self,"MgmtInterface")
	...
	CONST_IS_DEFAULT_DERIVED_FALSE = "false"
	CONST_IS_DEFAULT_DERIVED_NO = "no"
	CONST_IS_DEFAULT_DERIVED_TRUE = "true"
	CONST_IS_DEFAULT_DERIVED_YES = "yes"
