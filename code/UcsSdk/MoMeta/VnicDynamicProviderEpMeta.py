...
PROPERTY_DICT = {
	...
	"SwitchId":UcsPropertyMeta("SwitchId", "switchId", "string", _VersionMeta.Version101e, UcsPropertyMeta.Naming, 0x80L, None, None, None, ["A", "B", "NONE"], ["0-4294967295"]),
	"Meta":UcsMoMeta("VnicDynamicProviderEp", "vnicDynamicProviderEp", "ep-[SwitchId]-[ChassisId]:[SlotId]:[PortId]", _VersionMeta.Version101e, "InputOutput", 0xffL, [], [], ["Get"], ["read-only"])
}
