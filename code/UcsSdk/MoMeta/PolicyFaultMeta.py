...
PROPERTY_DICT = {
	...
	"Meta":UcsMoMeta("PolicyFault", "policyFault", "fault-ctrl", _VersionMeta.Version211a, "InputOutput", 0x1fL, [], [u'policyControlledInstance', u'policyControlledType'], ["Add", "Get", "Set"], ["admin", "fault"])
}
