...
PROPERTY_DICT = {
	...
	"Current":UcsPropertyMeta("Current", "current", "float", _VersionMeta.Version141i, UcsPropertyMeta.ReadOnly, None, None, None, None, [], ["0-4294967295"]),
	"CurrentAvg":UcsPropertyMeta("CurrentAvg", "currentAvg", "float", _VersionMeta.Version141i, UcsPropertyMeta.ReadOnly, None, None, None, None, [], ["0-4294967295"]),
	"CurrentMax":UcsPropertyMeta("CurrentMax", "currentMax", "float", _VersionMeta.Version141i, UcsPropertyMeta.ReadOnly, None, None, None, None, [], ["0-4294967295"]),
	"CurrentMin":UcsPropertyMeta("CurrentMin", "currentMin", "float", _VersionMeta.Version141i, UcsPropertyMeta.ReadOnly, None, None, None, None, [], ["0-4294967295"]),
	...
	"Voltage":UcsPropertyMeta("Voltage", "voltage", "float", _VersionMeta.Version141i, UcsPropertyMeta.ReadOnly, None, None, None, None, [], ["0-4294967295"]),
	"VoltageAvg":UcsPropertyMeta("VoltageAvg", "voltageAvg", "float", _VersionMeta.Version141i, UcsPropertyMeta.ReadOnly, None, None, None, None, [], ["0-4294967295"]),
	"VoltageMax":UcsPropertyMeta("VoltageMax", "voltageMax", "float", _VersionMeta.Version141i, UcsPropertyMeta.ReadOnly, None, None, None, None, [], ["0-4294967295"]),
	"VoltageMin":UcsPropertyMeta("VoltageMin", "voltageMin", "float", _VersionMeta.Version141i, UcsPropertyMeta.ReadOnly, None, None, None, None, [], ["0-4294967295"]),
	"Meta":UcsMoMeta("EquipmentFexPsuInputStats", "equipmentFexPsuInputStats", "fex-psu-input-stats", _VersionMeta.Version141i, "OutputOnly", 0x0L, [], [u'equipmentFexPsuInputStatsHist'], ["Get"], ["admin", "operations", "read-only"])
}
