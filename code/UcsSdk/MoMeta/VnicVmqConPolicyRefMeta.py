...
PROPERTY_DICT = {
	...
	"Meta":UcsMoMeta("VnicVmqConPolicyRef", "vnicVmqConPolicyRef", "vmq-con-ref", _VersionMeta.Version221b, "InputOutput", 0x1fL, [], [u'faultInst'], ["Add", "Get", "Remove"], ["admin", "ls-config", "ls-network", "ls-server"])
}
