...
PROPERTY_DICT = {
	...
	"Id":UcsPropertyMeta("Id", "id", "ulong", _VersionMeta.Version131c, UcsPropertyMeta.Naming, None, None, None, None, [], ["0-4294967295"]),
	"MostRecent":UcsPropertyMeta("MostRecent", "mostRecent", "string", _VersionMeta.Version131c, UcsPropertyMeta.ReadOnly, None, None, None, None, ["false", "no", "true", "yes"], ["0-4294967295"]),
	...
	"Temperature":UcsPropertyMeta("Temperature", "temperature", "float", _VersionMeta.Version131c, UcsPropertyMeta.ReadOnly, None, None, None, None, [], ["0-4294967295"]),
	"TemperatureAvg":UcsPropertyMeta("TemperatureAvg", "temperatureAvg", "float", _VersionMeta.Version131c, UcsPropertyMeta.ReadOnly, None, None, None, None, [], ["0-4294967295"]),
	"TemperatureMax":UcsPropertyMeta("TemperatureMax", "temperatureMax", "float", _VersionMeta.Version131c, UcsPropertyMeta.ReadOnly, None, None, None, None, [], ["0-4294967295"]),
	"TemperatureMin":UcsPropertyMeta("TemperatureMin", "temperatureMin", "float", _VersionMeta.Version131c, UcsPropertyMeta.ReadOnly, None, None, None, None, [], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("MemoryBufferUnitEnvStatsHist", "memoryBufferUnitEnvStatsHist", "[Id]", _VersionMeta.Version131c, "OutputOnly", 0x0L, [], [], ["Get"], ["read-only"])
}
