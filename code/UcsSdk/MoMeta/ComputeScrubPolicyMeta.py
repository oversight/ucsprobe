...
PROPERTY_DICT = {
	"BiosSettingsScrub":UcsPropertyMeta("BiosSettingsScrub", "biosSettingsScrub", "string", _VersionMeta.Version101e, UcsPropertyMeta.ReadWrite, 0x1L, None, None, None, ["no", "yes"], ["0-4294967295"]),
	...
	"DiskScrub":UcsPropertyMeta("DiskScrub", "diskScrub", "string", _VersionMeta.Version101e, UcsPropertyMeta.ReadWrite, 0x8L, None, None, None, ["no", "yes"], ["0-4294967295"]),
	"Dn":UcsPropertyMeta("Dn", "dn", "string", _VersionMeta.Version101e, UcsPropertyMeta.ReadOnly, 0x10L, 0, 256, None, [], ["0-4294967295"]),
	"FlexFlashScrub":UcsPropertyMeta("FlexFlashScrub", "flexFlashScrub", "string", _VersionMeta.Version221b, UcsPropertyMeta.ReadWrite, 0x20L, None, None, None, ["no", "yes"], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("ComputeScrubPolicy", "computeScrubPolicy", "scrub-[Name]", _VersionMeta.Version101e, "InputOutput", 0x3ffL, [], [], ["Add", "Get", "Remove", "Set"], ["admin", "pn-policy"])
}
