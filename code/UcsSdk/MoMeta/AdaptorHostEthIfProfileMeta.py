...
PROPERTY_DICT = {
	...
	"Meta":UcsMoMeta("AdaptorHostEthIfProfile", "adaptorHostEthIfProfile", "eth-profile-[Name]", _VersionMeta.Version101e, "InputOutput", 0x7fL, [], [u'adaptorEthArfsProfile', u'adaptorEthCompQueueProfile', u'adaptorEthFailoverProfile', u'adaptorEthInterruptProfile', u'adaptorEthOffloadProfile', u'adaptorEthRecvQueueProfile', u'adaptorEthWorkQueueProfile', u'adaptorExtIpV6RssHashProfile', u'adaptorIpV4RssHashProfile', u'adaptorIpV6RssHashProfile', u'adaptorRssProfile'], ["Add", "Get", "Remove", "Set"], ["admin", "ls-config-policy", "ls-network", "ls-server-policy"])
}
