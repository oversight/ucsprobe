...
PROPERTY_DICT = {
	...
	"Style":UcsPropertyMeta("Style", "style", "string", _VersionMeta.Version141i, UcsPropertyMeta.ReadWrite, 0x80L, None, None, None, ["intelligent-policy-driven", "manual-per-blade"], ["0-4294967295"]),
	"Meta":UcsMoMeta("PowerMgmtPolicy", "powerMgmtPolicy", "pwr-mgmt-policy", _VersionMeta.Version141i, "InputOutput", 0xffL, [], [], ["Get", "Set"], ["admin", "power-mgmt"])
}
