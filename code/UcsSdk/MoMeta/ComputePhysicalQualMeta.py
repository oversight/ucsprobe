...
PROPERTY_DICT = {
	...
	"Model":UcsPropertyMeta("Model", "model", "string", _VersionMeta.Version131c, UcsPropertyMeta.ReadWrite, 0x4L, None, None, """[ !#$%\(\)\*\+,\-\./:;\?@\[\\\]\^_\{\|\}~a-zA-Z0-9]{0,256}""", [], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("ComputePhysicalQual", "computePhysicalQual", "physical", _VersionMeta.Version131c, "InputOutput", 0x1fL, [], [], ["Add", "Get", "Remove", "Set"], ["admin", "pn-policy"])
}
