...
PROPERTY_DICT = {
	...
	"Id":UcsPropertyMeta("Id", "id", "string", _VersionMeta.Version101e, UcsPropertyMeta.Naming, 0x4L, 0, 256, """(([A-Fa-f0-9][A-Fa-f0-9]:){7}[A-Fa-f0-9][A-Fa-f0-9])|0""", [], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("FcpoolAddr", "fcpoolAddr", "[Id]", _VersionMeta.Version101e, "InputOutput", 0x1fL, [], [u'fcpoolPoolable'], ["Get"], ["read-only"])
}
