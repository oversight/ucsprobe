...
PROPERTY_DICT = {
	...
	"SupportedAlgorithm":UcsPropertyMeta("SupportedAlgorithm", "supportedAlgorithm", "string", _VersionMeta.Version201m, UcsPropertyMeta.ReadOnly, None, None, None, None, ["none", "slide-rule", "unrestricted"], ["0-4294967295"]),
	"Meta":UcsMoMeta("EquipmentUnifiedPortCapProvider", "equipmentUnifiedPortCapProvider", "unified-port-cap", _VersionMeta.Version201m, "InputOutput", 0x7fL, [], [], ["Get"], [""])
}
