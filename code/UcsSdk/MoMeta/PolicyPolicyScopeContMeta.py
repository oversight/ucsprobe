...
PROPERTY_DICT = {
	"AppType":UcsPropertyMeta("AppType", "appType", "string", _VersionMeta.Version211a, UcsPropertyMeta.Naming, 0x1L, 1, 510, None, [], ["0-4294967295"]),
	...
	"NeedRecovery":UcsPropertyMeta("NeedRecovery", "needRecovery", "string", _VersionMeta.Version211a, UcsPropertyMeta.ReadOnly, None, None, None, None, ["false", "no", "true", "yes"], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("PolicyPolicyScopeCont", "policyPolicyScopeCont", "scope-cont-[AppType]", _VersionMeta.Version211a, "InputOutput", 0x1fL, [], [u'policyPolicyScopeContext'], [None], ["admin"])
}
