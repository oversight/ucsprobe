...
PROPERTY_DICT = {
	...
	"Meta":UcsMoMeta("EquipmentIndicatorLed", "equipmentIndicatorLed", "indicator-led-[Id]", _VersionMeta.Version101e, "InputOutput", 0x3fL, [], [], ["Get"], ["admin", "pn-equipment", "pn-maintenance", "pn-policy", "read-only"])
}
