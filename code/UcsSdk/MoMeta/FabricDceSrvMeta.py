...
PROPERTY_DICT = {
	...
	"Id":UcsPropertyMeta("Id", "id", "string", _VersionMeta.Version101e, UcsPropertyMeta.CreateOnly, 0x4L, None, None, None, ["A", "B", "NONE"], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("FabricDceSrv", "fabricDceSrv", "server", _VersionMeta.Version101e, "InputOutput", 0x3fL, [], [u'etherSwIfConfig', u'fabricChassisEp', u'fabricComputePhEp', u'fabricDceSwSrv', u'fabricSwChPhEp', u'statsThresholdPolicy'], ["Get"], ["admin", "ls-network-policy"])
}
