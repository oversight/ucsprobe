...
PROPERTY_DICT = {
	...
	"Name":UcsPropertyMeta("Name", "name", "string", _VersionMeta.Version141i, UcsPropertyMeta.CreateOnly, 0x8L, None, None, """[\-\.:_a-zA-Z0-9]{0,16}""", [], ["0-4294967295"]),
	...
	"SessionsPerUser":UcsPropertyMeta("SessionsPerUser", "sessionsPerUser", "ushort", _VersionMeta.Version141i, UcsPropertyMeta.ReadWrite, 0x40L, None, None, None, [], ["1-256"]),
	...
	"TotalSessions":UcsPropertyMeta("TotalSessions", "totalSessions", "ushort", _VersionMeta.Version141i, UcsPropertyMeta.ReadWrite, 0x100L, None, None, None, [], ["1-256"]),
	"Meta":UcsMoMeta("CommWebSvcLimits", "commWebSvcLimits", "web-svc-limits", _VersionMeta.Version141i, "InputOutput", 0x1ffL, [], [], ["Get", "Set"], ["aaa", "admin"])
}
