...
PROPERTY_DICT = {
	...
	"Meta":UcsMoMeta("ComputeQual", "computeQual", "blade-qualifier-[Name]", _VersionMeta.Version101e, "InputOutput", 0x7fL, [], [u'adaptorQual', u'computeChassisQual', u'computePhysicalQual', u'computeRackQual', u'memoryQual', u'powerGroupQual', u'processorQual', u'storageQual'], ["Add", "Get", "Remove", "Set"], ["admin", "pn-policy"])
}
