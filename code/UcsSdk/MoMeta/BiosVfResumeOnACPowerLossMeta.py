...
PROPERTY_DICT = {
	...
	"VpResumeOnACPowerLoss":UcsPropertyMeta("VpResumeOnACPowerLoss", "vpResumeOnACPowerLoss", "string", _VersionMeta.Version111j, UcsPropertyMeta.ReadWrite, 0x10L, None, None, None, ["last-state", "platform-default", "platform-recommended", "reset", "stay-off"], ["0-4294967295"]),
	"Meta":UcsMoMeta("BiosVfResumeOnACPowerLoss", "biosVfResumeOnACPowerLoss", "Resume-on-AC-power-loss", _VersionMeta.Version111j, "InputOutput", 0x1fL, [], [], ["Get", "Set"], ["admin", "ls-compute", "ls-config", "ls-server", "ls-server-policy", "pn-policy"])
}
