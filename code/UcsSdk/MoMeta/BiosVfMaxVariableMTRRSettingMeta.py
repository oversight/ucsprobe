...
PROPERTY_DICT = {
	...
	"VpProcessorMtrr":UcsPropertyMeta("VpProcessorMtrr", "vpProcessorMtrr", "string", _VersionMeta.Version142b, UcsPropertyMeta.ReadWrite, 0x10L, None, None, None, ["8", "auto-max", "platform-default", "platform-recommended"], ["0-4294967295"]),
	"Meta":UcsMoMeta("BiosVfMaxVariableMTRRSetting", "biosVfMaxVariableMTRRSetting", "Max-Variable-MTRR-Setting", _VersionMeta.Version142b, "InputOutput", 0x1fL, [], [], ["Get", "Set"], ["admin", "ls-compute", "ls-config", "ls-server", "ls-server-policy", "pn-policy"])
}
