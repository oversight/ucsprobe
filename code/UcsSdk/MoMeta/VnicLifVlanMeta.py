...
PROPERTY_DICT = {
	...
	"Vnet":UcsPropertyMeta("Vnet", "vnet", "uint", _VersionMeta.Version101e, UcsPropertyMeta.Naming, 0x40L, None, None, None, [], ["1-4093"]),
	"Meta":UcsMoMeta("VnicLifVlan", "vnicLifVlan", "vlan-[Vnet]", _VersionMeta.Version101e, "InputOutput", 0x7fL, [], [], ["Get"], ["read-only"])
}
