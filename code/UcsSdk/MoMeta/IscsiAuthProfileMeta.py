...
PROPERTY_DICT = {
	...
	"Ctpassword":UcsPropertyMeta("Ctpassword", "ctpassword", "string", _VersionMeta.Version201m, UcsPropertyMeta.ReadOnly, None, 0, 510, None, [], ["0-4294967295"]),
	...
	"Name":UcsPropertyMeta("Name", "name", "string", _VersionMeta.Version201m, UcsPropertyMeta.Naming, 0x8L, None, None, """[\-\.:_a-zA-Z0-9]{1,16}""", [], ["0-4294967295"]),
	"Password":UcsPropertyMeta("Password", "password", "string", _VersionMeta.Version201m, UcsPropertyMeta.ReadWrite, 0x10L, None, None, """[!""#%&'\(\)\*\+,\-\./:;<>@\[\\\]\^_`\{\|\}~a-zA-Z0-9]{12,16}""", [], ["0-4294967295"]),
	...
	"UserId":UcsPropertyMeta("UserId", "userId", "string", _VersionMeta.Version201m, UcsPropertyMeta.ReadWrite, 0x100L, 1, 128, None, [], ["0-4294967295"]),
	"Meta":UcsMoMeta("IscsiAuthProfile", "iscsiAuthProfile", "iscsi-auth-profile-[Name]", _VersionMeta.Version201m, "InputOutput", 0x1ffL, [], [], ["Get"], ["admin", "ls-config-policy", "ls-server-policy"])
}
