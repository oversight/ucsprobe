...
PROPERTY_DICT = {
	...
	"Meta":UcsMoMeta("SysdebugEp", "sysdebugEp", "sysdebug", _VersionMeta.Version101e, "InputOutput", 0xfL, [], [u'sysdebugAutoCoreFileExportTarget', u'sysdebugLogControlEp', u'sysdebugLogExportPolicy'], ["Get"], ["read-only"])
}
