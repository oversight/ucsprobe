...
PROPERTY_DICT = {
	...
	"Name":UcsPropertyMeta("Name", "name", "string", _VersionMeta.Version211a, UcsPropertyMeta.Naming, None, None, None, None, ["RegisterFsmBegin", "RegisterFsmExecute", "RegisterFsmFail", "RegisterFsmSuccess", "nop", "repairCertBegin", "repairCertCleanOldData", "repairCertFail", "repairCertRequest", "repairCertSuccess", "repairCertUnregister", "repairCertVerify", "repairCertVerifyGuid"], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("ExtpolEpFsmStage", "extpolEpFsmStage", "stage-[Name]", _VersionMeta.Version211a, "OutputOnly", 0x0L, [], [], [None], [""])
}
