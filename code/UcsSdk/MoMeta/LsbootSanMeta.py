...
PROPERTY_DICT = {
	"Access":UcsPropertyMeta("Access", "access", "string", _VersionMeta.Version221b, UcsPropertyMeta.ReadOnly, None, None, None, None, ["read-only", "read-only-local", "read-only-remote", "read-only-remote-cimc", "read-write", "read-write-drive", "read-write-local", "read-write-remote", "read-write-remote-cimc"], ["0-4294967295"]),
	...
	"Type":UcsPropertyMeta("Type", "type", "string", _VersionMeta.Version221b, UcsPropertyMeta.ReadOnly, None, None, None, None, ["iscsi", "lan", "san", "storage", "virtual-media"], ["0-4294967295"]),
	"Meta":UcsMoMeta("LsbootSan", "lsbootSan", "san", _VersionMeta.Version221b, "InputOutput", 0x1fL, [], [u'lsbootSanCatSanImage'], ["Add", "Get", "Remove", "Set"], ["admin", "ls-compute", "ls-config", "ls-config-policy", "ls-server", "ls-server-policy", "ls-storage", "ls-storage-policy"])
}
