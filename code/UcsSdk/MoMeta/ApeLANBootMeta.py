...
PROPERTY_DICT = {
	...
	"VnicName":UcsPropertyMeta("VnicName", "vnicName", "string", _VersionMeta.Version101e, UcsPropertyMeta.Naming, 0x10L, None, None, """[\-\.:_a-zA-Z0-9]{1,16}""", [], ["0-4294967295"]),
	"Meta":UcsMoMeta("ApeLANBoot", "apeLANBoot", "lanboot-[VnicName]", _VersionMeta.Version101e, "InputOutput", 0x1fL, [], [], [None], ["admin"])
}
