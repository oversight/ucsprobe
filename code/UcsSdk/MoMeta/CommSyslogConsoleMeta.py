...
PROPERTY_DICT = {
	...
	"Severity":UcsPropertyMeta("Severity", "severity", "string", _VersionMeta.Version101e, UcsPropertyMeta.ReadWrite, 0x40L, None, None, None, ["alerts", "critical", "emergencies"], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("CommSyslogConsole", "commSyslogConsole", "console", _VersionMeta.Version101e, "InputOutput", 0xffL, [], [], ["Get", "Set"], ["admin", "operations"])
}
