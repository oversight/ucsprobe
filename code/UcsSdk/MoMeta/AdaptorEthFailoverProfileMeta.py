...
PROPERTY_DICT = {
	...
	"Timeout":UcsPropertyMeta("Timeout", "timeout", "uint", _VersionMeta.Version101e, UcsPropertyMeta.ReadWrite, 0x10L, None, None, None, [], ["0-600"]),
	"Meta":UcsMoMeta("AdaptorEthFailoverProfile", "adaptorEthFailoverProfile", "eth-failover", _VersionMeta.Version101e, "InputOutput", 0x1fL, [], [], ["Get", "Set"], ["admin", "ls-config-policy", "ls-network", "ls-server-policy"])
}
