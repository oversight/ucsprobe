...
PROPERTY_DICT = {
	...
	"Name":UcsPropertyMeta("Name", "name", "string", _VersionMeta.Version211a, UcsPropertyMeta.Naming, None, None, None, None, ["ActivateZoneSetBegin", "ActivateZoneSetFail", "ActivateZoneSetSuccess", "ActivateZoneSetUpdateZones", "DeployBegin", "DeployFail", "DeploySuccess", "DeployUpdateConnectivity", "nop"], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("SwFcSanBorderFsmStage", "swFcSanBorderFsmStage", "stage-[Name]", _VersionMeta.Version211a, "OutputOnly", 0x0L, [], [], [None], [""])
}
