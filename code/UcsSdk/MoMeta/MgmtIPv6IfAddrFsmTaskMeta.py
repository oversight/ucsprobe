...
PROPERTY_DICT = {
	...
	"Item":UcsPropertyMeta("Item", "item", "string", _VersionMeta.Version221b, UcsPropertyMeta.Naming, None, None, None, None, ["SwMgmtOobIpv6IfConfig", "nop"], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("MgmtIPv6IfAddrFsmTask", "mgmtIPv6IfAddrFsmTask", "task-[Item]", _VersionMeta.Version221b, "OutputOnly", 0x0L, [], [], [None], [""])
}
