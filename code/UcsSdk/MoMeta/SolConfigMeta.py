...
PROPERTY_DICT = {
	"AdminState":UcsPropertyMeta("AdminState", "adminState", "string", _VersionMeta.Version101e, UcsPropertyMeta.ReadWrite, 0x1L, None, None, None, ["disable", "enable"], ["0-4294967295"]),
	...
	"Speed":UcsPropertyMeta("Speed", "speed", "string", _VersionMeta.Version101e, UcsPropertyMeta.ReadWrite, 0x40L, None, None, None, ["115200", "19200", "38400", "57600", "9600"], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("SolConfig", "solConfig", "sol", _VersionMeta.Version101e, "InputOutput", 0xffL, [], [], ["Add", "Get", "Remove", "Set"], ["admin", "ls-compute", "ls-config", "ls-config-policy", "ls-server"])
}
