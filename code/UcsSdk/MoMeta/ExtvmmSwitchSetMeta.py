...
PROPERTY_DICT = {
	...
	"Meta":UcsMoMeta("ExtvmmSwitchSet", "extvmmSwitchSet", "virtual-switches", _VersionMeta.Version201m, "InputOutput", 0xfL, [], [u'vmSwitch'], ["Get"], ["admin", "ls-network", "ls-network-policy"])
}
