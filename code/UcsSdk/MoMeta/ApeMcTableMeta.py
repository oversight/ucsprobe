...
PROPERTY_DICT = {
	...
	"Name":UcsPropertyMeta("Name", "name", "string", _VersionMeta.Version101e, UcsPropertyMeta.ReadWrite, 0x8L, 0, 510, None, [], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("ApeMcTable", "apeMcTable", "mctable-[Id]", _VersionMeta.Version101e, "InputOutput", 0x3fL, [], [u'apeFru', u'apeParam', u'apeReading', u'apeSdr'], [None], ["read-only"])
}
