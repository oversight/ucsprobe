...
PROPERTY_DICT = {
	...
	"VpOSBootWatchdogTimerPolicy":UcsPropertyMeta("VpOSBootWatchdogTimerPolicy", "vpOSBootWatchdogTimerPolicy", "string", _VersionMeta.Version111j, UcsPropertyMeta.ReadWrite, 0x10L, None, None, None, ["platform-default", "platform-recommended", "power-off", "reset"], ["0-4294967295"]),
	"Meta":UcsMoMeta("BiosVfOSBootWatchdogTimerPolicy", "biosVfOSBootWatchdogTimerPolicy", "OS-Boot-Watchdog-Timer-Policy", _VersionMeta.Version111j, "InputOutput", 0x1fL, [], [], ["Get", "Set"], ["admin", "ls-compute", "ls-config", "ls-server", "ls-server-policy", "pn-policy"])
}
