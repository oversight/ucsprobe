...
PROPERTY_DICT = {
	...
	"Mask":UcsPropertyMeta("Mask", "mask", "string", _VersionMeta.Version212a, UcsPropertyMeta.ReadOnly, None, None, None, """((defaultValue|local|global),){0,2}(defaultValue|local|global){0,1}""", [], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("OrgSourceMask", "orgSourceMask", "src-mask", _VersionMeta.Version212a, "InputOutput", 0xfL, [], [], [None], ["read-only"])
}
