...
PROPERTY_DICT = {
	...
	"Role":UcsPropertyMeta("Role", "role", "string", _VersionMeta.Version201m, UcsPropertyMeta.ReadWrite, 0x40L, None, None, None, ["data", "full", "mgmt"], ["0-4294967295"]),
	...
	"Vendor":UcsPropertyMeta("Vendor", "vendor", "string", _VersionMeta.Version141i, UcsPropertyMeta.Naming, 0x100L, 1, 510, None, [], ["0-4294967295"]),
	"Meta":UcsMoMeta("EquipmentFexCapProvider", "equipmentFexCapProvider", "manufacturer-[Vendor]-model-[Model]-revision-[Revision]", _VersionMeta.Version141i, "InputOutput", 0x1ffL, [], [u'equipmentManufacturingDef', u'equipmentPhysicalDef', u'equipmentPicture', u'equipmentPortGroupAggregationDef', u'equipmentPortGroupDef', u'equipmentServiceDef', u'equipmentSlotArrayRef', u'firmwareType', u'firmwareUpgradeConstraint'], ["Get"], [""])
}
