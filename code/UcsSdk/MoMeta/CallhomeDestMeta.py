...
PROPERTY_DICT = {
	...
	"Email":UcsPropertyMeta("Email", "email", "string", _VersionMeta.Version101e, UcsPropertyMeta.Naming, 0x4L, None, None, None, [], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("CallhomeDest", "callhomeDest", "email-[Email]", _VersionMeta.Version101e, "InputOutput", 0x1fL, [], [], ["Add", "Get", "Remove"], ["admin", "operations"])
}
