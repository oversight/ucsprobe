...
PROPERTY_DICT = {
	...
	"Prot":UcsPropertyMeta("Prot", "prot", "string", _VersionMeta.Version141i, UcsPropertyMeta.ReadWrite, 0x8L, None, None, None, ["gpxe", "iSCSI", "pxe"], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("LsbootLan", "lsbootLan", "lan", _VersionMeta.Version101e, "InputOutput", 0x3fL, [], [u'lsbootLanImagePath'], ["Add", "Get", "Remove", "Set"], ["admin", "ls-compute", "ls-config", "ls-config-policy", "ls-server", "ls-server-policy", "ls-storage", "ls-storage-policy"])
}
