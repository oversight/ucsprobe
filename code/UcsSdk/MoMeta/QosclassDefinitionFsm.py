...
class QosclassDefinitionFsm(ManagedObject):
	def __init__(self):
		ManagedObject.__init__(self,"QosclassDefinitionFsm")

	@staticmethod
	def ClassId():
		return "qosclassDefinitionFsm"
	...
	CONST_CURRENT_FSM_CONFIG_GLOBAL_QO_S = "configGlobalQoS"
