...
PROPERTY_DICT = {
	...
	"Encap":UcsPropertyMeta("Encap", "encap", "string", _VersionMeta.Version141i, UcsPropertyMeta.ReadOnly, None, None, None, None, ["consolidated", "virtual"], ["0-4294967295"]),
	...
	"NsSize":UcsPropertyMeta("NsSize", "nsSize", "ushort", _VersionMeta.Version141i, UcsPropertyMeta.ReadOnly, None, None, None, None, [], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("SwAccessEp", "swAccessEp", "ep-slot-[SlotId]port-[PortId]", _VersionMeta.Version101e, "InputOutput", 0xffL, [], [u'portTrustMode', u'swUlan'], ["Get"], ["read-only"])
}
