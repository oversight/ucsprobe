...
class ExtpolRegistryFsm(ManagedObject):
	def __init__(self):
		ManagedObject.__init__(self,"ExtpolRegistryFsm")

	@staticmethod
	def ClassId():
		return "extpolRegistryFsm"
	...
	CONST_CURRENT_FSM_CROSS_DOMAIN_CONFIG = "crossDomainConfig"
	CONST_CURRENT_FSM_CROSS_DOMAIN_DELETE = "crossDomainDelete"
