...
PROPERTY_DICT = {
	...
	"Meta":UcsMoMeta("FabricFcEstcCloud", "fabricFcEstcCloud", "fc-estc", _VersionMeta.Version141i, "InputOutput", 0xfL, [], [u'fabricBHVlan', u'fabricFcEstc', u'fabricVsan', u'statsThresholdPolicy'], ["Get"], ["admin", "ext-san-config", "ext-san-policy"])
}
