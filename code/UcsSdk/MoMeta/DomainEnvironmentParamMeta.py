...
PROPERTY_DICT = {
	...
	"Name":UcsPropertyMeta("Name", "name", "string", _VersionMeta.Version221b, UcsPropertyMeta.Naming, 0x4L, 1, 510, None, [], ["0-4294967295"]),
	...
	"Value":UcsPropertyMeta("Value", "value", "string", _VersionMeta.Version221b, UcsPropertyMeta.ReadWrite, 0x20L, 0, 510, None, [], ["0-4294967295"]),
	"Meta":UcsMoMeta("DomainEnvironmentParam", "domainEnvironmentParam", "env-param-[Name]", _VersionMeta.Version221b, "InputOutput", 0x3fL, [], [], [None], ["admin"])
}
