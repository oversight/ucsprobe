...
PROPERTY_DICT = {
	...
	"Meta":UcsMoMeta("CimcvmediaActualMountList", "cimcvmediaActualMountList", "actual-mount-list", _VersionMeta.Version222c, "InputOutput", 0xfL, [], [u'cimcvmediaActualMountEntry', u'cimcvmediaExtMgmtRuleEntry'], [None], ["read-only"])
}
