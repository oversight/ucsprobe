...
class EquipmentBeaconLedFsm(ManagedObject):
	def __init__(self):
		ManagedObject.__init__(self,"EquipmentBeaconLedFsm")

	@staticmethod
	def ClassId():
		return "equipmentBeaconLedFsm"
	...
	CONST_CURRENT_FSM_ILLUMINATE = "Illuminate"
