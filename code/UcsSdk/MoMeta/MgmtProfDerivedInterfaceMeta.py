...
PROPERTY_DICT = {
	...
	"Meta":UcsMoMeta("MgmtProfDerivedInterface", "mgmtProfDerivedInterface", "spiface-[Mode]", _VersionMeta.Version221b, "InputOutput", 0x7fL, [], [u'mgmtVnet'], ["Get"], ["admin", "ls-compute", "ls-config", "ls-network", "ls-server"])
}
