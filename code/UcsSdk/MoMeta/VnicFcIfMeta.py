...
PROPERTY_DICT = {
	...
	"Name":UcsPropertyMeta("Name", "name", "string", _VersionMeta.Version101e, UcsPropertyMeta.ReadWrite, 0x4L, None, None, """[\-\.:_a-zA-Z0-9]{0,32}""", [], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("VnicFcIf", "vnicFcIf", "if-default", _VersionMeta.Version101e, "InputOutput", 0x1fL, [], [u'faultInst'], ["Add", "Get", "Remove", "Set"], ["admin", "ls-config", "ls-server", "ls-storage"])
}
