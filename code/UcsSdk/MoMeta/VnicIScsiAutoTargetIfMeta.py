...
PROPERTY_DICT = {
	...
	"DhcpVendorId":UcsPropertyMeta("DhcpVendorId", "dhcpVendorId", "string", _VersionMeta.Version201m, UcsPropertyMeta.ReadWrite, 0x2L, 0, 32, None, [], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("VnicIScsiAutoTargetIf", "vnicIScsiAutoTargetIf", "auto", _VersionMeta.Version201m, "InputOutput", 0x1fL, [], [], ["Add", "Get", "Remove", "Set"], ["admin", "ls-config", "ls-network", "ls-server", "ls-storage"])
}
