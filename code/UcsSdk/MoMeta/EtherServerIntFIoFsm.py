...
class EtherServerIntFIoFsm(ManagedObject):
	def __init__(self):
		ManagedObject.__init__(self,"EtherServerIntFIoFsm")

	@staticmethod
	def ClassId():
		return "etherServerIntFIoFsm"
	...
	CONST_CURRENT_FSM_CONFIG_SPEED = "ConfigSpeed"
