...
PROPERTY_DICT = {
	...
	"Meta":UcsMoMeta("LsServerAssocCtx", "lsServerAssocCtx", "ls-assoc-ctx", _VersionMeta.Version141i, "InputOutput", 0xfL, [], [u'adaptorUnitAssocCtx', u'computePhysicalAssocCtx', u'processorUnitAssocCtx'], ["Get"], ["read-only"])
}
