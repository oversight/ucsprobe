...
PROPERTY_DICT = {
	...
	"ConfigState":UcsPropertyMeta("ConfigState", "configState", "string", _VersionMeta.Version212a, UcsPropertyMeta.ReadOnly, None, None, None, None, ["not-applied", "ok"], ["0-4294967295"]),
	"ConfigStatusMessage":UcsPropertyMeta("ConfigStatusMessage", "configStatusMessage", "string", _VersionMeta.Version212a, UcsPropertyMeta.ReadOnly, None, 0, 510, None, [], ["0-4294967295"]),
	...
	"OrgDn":UcsPropertyMeta("OrgDn", "orgDn", "string", _VersionMeta.Version101e, UcsPropertyMeta.CreateOnly, 0x10L, 0, 256, None, [], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("AaaOrg", "aaaOrg", "org-[Name]", _VersionMeta.Version101e, "InputOutput", 0x7fL, [], [u'faultInst'], ["Add", "Get", "Remove"], ["aaa", "admin"])
}
