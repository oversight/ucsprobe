...
PROPERTY_DICT = {
	...
	"ScanOrder":UcsPropertyMeta("ScanOrder", "scanOrder", "byte", _VersionMeta.Version211a, UcsPropertyMeta.ReadWrite, 0x40L, None, None, None, [], ["0-4294967295"]),
	"SlotId":UcsPropertyMeta("SlotId", "slotId", "uint", _VersionMeta.Version211a, UcsPropertyMeta.Naming, 0x80L, None, None, None, [], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("ComputePciSlotScanDef", "computePciSlotScanDef", "slot-[SlotId]", _VersionMeta.Version211a, "InputOutput", 0x1ffL, [], [], [None], ["read-only"])
}
