...
PROPERTY_DICT = {
	...
	"Oldaddr":UcsPropertyMeta("Oldaddr", "oldaddr", "string", _VersionMeta.Version212a, UcsPropertyMeta.ReadOnly, None, 0, 256, """(([A-Fa-f0-9][A-Fa-f0-9]:){7}[A-Fa-f0-9][A-Fa-f0-9])|0""", [], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("VnicWwpnHistory", "vnicWwpnHistory", "wwpn-history", _VersionMeta.Version212a, "InputOutput", 0xfL, [], [], [None], ["read-only"])
}
