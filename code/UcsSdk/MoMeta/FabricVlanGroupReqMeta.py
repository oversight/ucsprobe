...
PROPERTY_DICT = {
	...
	"Meta":UcsMoMeta("FabricVlanGroupReq", "fabricVlanGroupReq", "vlan-group-req-[Name]", _VersionMeta.Version211a, "InputOutput", 0x1fL, [], [u'faultInst'], ["Add", "Get", "Remove"], ["admin", "ls-network"])
}
