...
PROPERTY_DICT = {
	...
	"Meta":UcsMoMeta("UuidpoolFormat", "uuidpoolFormat", "format-[Format]-[Mask]", _VersionMeta.Version101e, "InputOutput", 0x3fL, [], [], ["Get"], ["admin", "ls-storage", "ls-storage-policy"])
}
