...
PROPERTY_DICT = {
	...
	"Id":UcsPropertyMeta("Id", "id", "uint", _VersionMeta.Version141i, UcsPropertyMeta.ReadWrite, 0x4L, None, None, None, [], ["1-3967", "4048-4093"]),
	...
	"SwitchId":UcsPropertyMeta("SwitchId", "switchId", "string", _VersionMeta.Version141i, UcsPropertyMeta.ReadOnly, None, None, None, None, ["A", "B", "NONE", "dual"], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("FabricBHVlan", "fabricBHVlan", "bhnet", _VersionMeta.Version141i, "InputOutput", 0x1ffL, [], [], ["Get"], ["admin", "ext-san-config", "ext-san-policy"])
}
