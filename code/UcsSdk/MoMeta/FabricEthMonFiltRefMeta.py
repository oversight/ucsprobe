...
PROPERTY_DICT = {
	...
	"SrcFiltDn":UcsPropertyMeta("SrcFiltDn", "srcFiltDn", "string", _VersionMeta.Version141i, UcsPropertyMeta.ReadOnly, None, 0, 256, None, [], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("FabricEthMonFiltRef", "fabricEthMonFiltRef", "", _VersionMeta.Version141i, "InputOutput", 0xfL, [], [], ["Get"], ["read-only"])
}
