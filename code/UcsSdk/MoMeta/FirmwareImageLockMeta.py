...
PROPERTY_DICT = {
	"ImageNameDn":UcsPropertyMeta("ImageNameDn", "ImageNameDn", "string", _VersionMeta.Version222c, UcsPropertyMeta.ReadOnly, None, 0, 256, None, [], ["0-4294967295"]),
	...
	"Name":UcsPropertyMeta("Name", "name", "string", _VersionMeta.Version222c, UcsPropertyMeta.Naming, 0x4L, None, None, None, [], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("FirmwareImageLock", "firmwareImageLock", "fw-imagelock[Name]", _VersionMeta.Version222c, "InputOutput", 0x1fL, [], [], [None], ["admin"])
}
