...
PROPERTY_DICT = {
	...
	"Meta":UcsMoMeta("AdaptorExtIpV6RssHashProfile", "adaptorExtIpV6RssHashProfile", "ext-ipv6-rss-hash", _VersionMeta.Version101e, "InputOutput", 0xfL, [], [], ["Get"], ["admin", "ls-config-policy", "ls-network", "ls-server-policy"])
}
