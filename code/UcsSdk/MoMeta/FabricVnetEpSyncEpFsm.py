...
class FabricVnetEpSyncEpFsm(ManagedObject):
	def __init__(self):
		ManagedObject.__init__(self,"FabricVnetEpSyncEpFsm")

	@staticmethod
	def ClassId():
		return "fabricVnetEpSyncEpFsm"
	...
	CONST_CURRENT_FSM_PUSH_VNET_EP_DELETION = "PushVnetEpDeletion"
