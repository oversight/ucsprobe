...
PROPERTY_DICT = {
	...
	"Meta":UcsMoMeta("VnicDynamicConPolicy", "vnicDynamicConPolicy", "dynamic-con-[Name]", _VersionMeta.Version101e, "InputOutput", 0x3ffL, [], [], ["Add", "Get", "Remove", "Set"], ["admin", "ls-network", "ls-network-policy"])
}
