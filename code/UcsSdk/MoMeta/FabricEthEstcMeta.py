...
PROPERTY_DICT = {
	...
	"Id":UcsPropertyMeta("Id", "id", "string", _VersionMeta.Version141i, UcsPropertyMeta.Naming, 0x4L, None, None, None, ["A", "B", "NONE"], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("FabricEthEstc", "fabricEthEstc", "[Id]", _VersionMeta.Version141i, "InputOutput", 0x3fL, [], [u'fabricEthEstcEp', u'fabricEthEstcPc', u'fabricVlan'], ["Get"], ["admin", "ext-san-config", "ext-san-policy"])
}
