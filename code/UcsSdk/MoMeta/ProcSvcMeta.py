...
PROPERTY_DICT = {
	...
	"Id":UcsPropertyMeta("Id", "id", "uint", _VersionMeta.Version131c, UcsPropertyMeta.ReadOnly, None, None, None, None, [], ["0-4294967295"]),
	"Name":UcsPropertyMeta("Name", "name", "string", _VersionMeta.Version131c, UcsPropertyMeta.Naming, 0x4L, 1, 510, None, [], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("ProcSvc", "procSvc", "svc-[Name]", _VersionMeta.Version131c, "InputOutput", 0x1fL, [], [u'procStimulusCounts', u'procTxCounts'], ["Get"], ["read-only"])
}
