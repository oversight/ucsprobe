...
PROPERTY_DICT = {
	...
	"IsSupported":UcsPropertyMeta("IsSupported", "isSupported", "string", _VersionMeta.Version221b, UcsPropertyMeta.ReadOnly, None, None, None, None, ["no", "yes"], ["0-4294967295"]),
	...
	"MinCmcVersion":UcsPropertyMeta("MinCmcVersion", "minCmcVersion", "string", _VersionMeta.Version221b, UcsPropertyMeta.ReadOnly, None, 0, 510, None, [], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("EquipmentInbandMgmtCap", "equipmentInbandMgmtCap", "ib-mgmt-cap", _VersionMeta.Version221b, "InputOutput", 0xfL, [], [], [None], ["read-only"])
}
