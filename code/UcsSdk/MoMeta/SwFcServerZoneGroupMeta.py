...
PROPERTY_DICT = {
	...
	"ServerDn":UcsPropertyMeta("ServerDn", "serverDn", "string", _VersionMeta.Version211a, UcsPropertyMeta.ReadOnly, None, 0, 256, None, [], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("SwFcServerZoneGroup", "swFcServerZoneGroup", "zone-group-[Id]", _VersionMeta.Version211a, "InputOutput", 0x3fL, [], [u'swZoneInitiatorMember'], [None], ["read-only"])
}
