...
PROPERTY_DICT = {
	...
	"HostNvram":UcsPropertyMeta("HostNvram", "hostNvram", "string", _VersionMeta.Version101e, UcsPropertyMeta.ReadWrite, 0x4L, None, None, None, ["full", "none"], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("AdaptorSanCap", "adaptorSanCap", "san", _VersionMeta.Version101e, "InputOutput", 0x1fL, [], [], ["Get"], ["read-only"])
}
