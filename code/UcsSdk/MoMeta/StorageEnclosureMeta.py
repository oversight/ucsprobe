...
PROPERTY_DICT = {
	...
	"NumSlots":UcsPropertyMeta("NumSlots", "numSlots", "ushort", _VersionMeta.Version141i, UcsPropertyMeta.ReadOnly, None, None, None, None, [], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("StorageEnclosure", "storageEnclosure", "enc-[Id]", _VersionMeta.Version141i, "InputOutput", 0x1fL, [], [], ["Get"], ["read-only"])
}
