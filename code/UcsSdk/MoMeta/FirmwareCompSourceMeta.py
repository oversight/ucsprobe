...
PROPERTY_DICT = {
	...
	"Version":UcsPropertyMeta("Version", "version", "string", _VersionMeta.Version101e, UcsPropertyMeta.Naming, 0x100L, 1, 510, None, [], ["0-4294967295"]),
	"Meta":UcsMoMeta("FirmwareCompSource", "firmwareCompSource", "source-[InvTag]-ver-[Version]", _VersionMeta.Version101e, "InputOutput", 0x1ffL, [], [u'firmwareCompTarget'], [None], ["read-only"])
}
