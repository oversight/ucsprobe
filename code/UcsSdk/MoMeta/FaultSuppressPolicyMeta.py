...
PROPERTY_DICT = {
	...
	"Meta":UcsMoMeta("FaultSuppressPolicy", "faultSuppressPolicy", "fault-suppress-policy-[Name]", _VersionMeta.Version211a, "InputOutput", 0x7fL, [], [u'faultAffectedClass', u'faultSuppressPolicyItem'], [None], ["admin", "fault"])
}
