...
PROPERTY_DICT = {
	...
	"PortId":UcsPropertyMeta("PortId", "portId", "uint", _VersionMeta.Version201m, UcsPropertyMeta.Naming, 0x10L, None, None, None, [], ["1-33"]),
	...
	"Meta":UcsMoMeta("EtherServerIntFIoPcEp", "etherServerIntFIoPcEp", "ep-slot-[SlotId]-port-[PortId]", _VersionMeta.Version201m, "InputOutput", 0xffL, [], [], ["Get"], ["admin", "ext-lan-config", "ext-lan-policy", "pn-equipment", "pn-maintenance"])
}
