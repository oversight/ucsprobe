...
PROPERTY_DICT = {
	...
	"UplinkTrunking":UcsPropertyMeta("UplinkTrunking", "uplinkTrunking", "string", _VersionMeta.Version141i, UcsPropertyMeta.ReadWrite, 0x40L, None, None, None, ["disabled", "enabled"], ["0-4294967295"]),
	"Meta":UcsMoMeta("FabricFcSan", "fabricFcSan", "[Id]", _VersionMeta.Version101e, "InputOutput", 0x7fL, [], [u'fabricFcSanEp', u'fabricFcSanPc', u'fabricFcoeSanEp', u'fabricFcoeSanPc', u'fabricVsan'], ["Get", "Set"], ["admin", "ext-san-config", "ext-san-policy"])
}
