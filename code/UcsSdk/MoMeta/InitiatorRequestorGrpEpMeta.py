...
PROPERTY_DICT = {
	...
	"PolDn":UcsPropertyMeta("PolDn", "polDn", "string", _VersionMeta.Version211a, UcsPropertyMeta.ReadOnly, None, 0, 256, None, [], ["0-4294967295"]),
	...
	"Type":UcsPropertyMeta("Type", "type", "string", _VersionMeta.Version211a, UcsPropertyMeta.ReadOnly, None, None, None, None, ["dedicated", "policy", "shared"], ["0-4294967295"]),
	"Meta":UcsMoMeta("InitiatorRequestorGrpEp", "initiatorRequestorGrpEp", "req-grp-[Id]", _VersionMeta.Version211a, "InputOutput", 0x1fL, [], [u'initiatorMemberEp', u'initiatorUnitEp'], [None], ["read-only"])
}
