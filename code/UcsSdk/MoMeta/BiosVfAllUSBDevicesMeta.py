...
PROPERTY_DICT = {
	...
	"VpAllUSBDevices":UcsPropertyMeta("VpAllUSBDevices", "vpAllUSBDevices", "string", _VersionMeta.Version222c, UcsPropertyMeta.ReadWrite, 0x10L, None, None, None, ["disabled", "enabled", "platform-default", "platform-recommended"], ["0-4294967295"]),
	"Meta":UcsMoMeta("BiosVfAllUSBDevices", "biosVfAllUSBDevices", "All-USB-Devices", _VersionMeta.Version222c, "InputOutput", 0x1fL, [], [], [None], ["admin", "ls-compute", "ls-config", "ls-server", "ls-server-policy", "pn-policy"])
}
