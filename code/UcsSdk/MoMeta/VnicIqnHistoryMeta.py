...
PROPERTY_DICT = {
	...
	"OldInitiatorName":UcsPropertyMeta("OldInitiatorName", "oldInitiatorName", "string", _VersionMeta.Version212a, UcsPropertyMeta.ReadOnly, None, 0, 510, None, [], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("VnicIqnHistory", "vnicIqnHistory", "iqn-history", _VersionMeta.Version212a, "InputOutput", 0xfL, [], [], [None], ["read-only"])
}
