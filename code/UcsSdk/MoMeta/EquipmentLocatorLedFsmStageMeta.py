...
PROPERTY_DICT = {
	...
	"Name":UcsPropertyMeta("Name", "name", "string", _VersionMeta.Version211a, UcsPropertyMeta.Naming, None, None, None, None, ["SetFeLocatorLedBegin", "SetFeLocatorLedExecute", "SetFeLocatorLedFail", "SetFeLocatorLedSuccess", "SetFiLocatorLedBegin", "SetFiLocatorLedExecute", "SetFiLocatorLedFail", "SetFiLocatorLedSuccess", "SetLocatorLedBegin", "SetLocatorLedExecute", "SetLocatorLedFail", "SetLocatorLedSuccess", "nop"], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("EquipmentLocatorLedFsmStage", "equipmentLocatorLedFsmStage", "stage-[Name]", _VersionMeta.Version211a, "OutputOnly", 0x0L, [], [], [None], [""])
}
