...
PROPERTY_DICT = {
	...
	"VpSriov":UcsPropertyMeta("VpSriov", "vpSriov", "string", _VersionMeta.Version211a, UcsPropertyMeta.ReadOnly, None, None, None, None, ["disabled", "enabled", "platform-default", "platform-recommended"], ["0-4294967295"]),
	"Meta":UcsMoMeta("BiosVfSriovConfig", "biosVfSriovConfig", "Sriov-Config", _VersionMeta.Version211a, "InputOutput", 0xfL, [], [], [None], ["admin", "ls-compute", "ls-config", "ls-server", "ls-server-policy", "pn-policy"])
}
