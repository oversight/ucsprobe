...
PROPERTY_DICT = {
	...
	"Mac":UcsPropertyMeta("Mac", "mac", "string", _VersionMeta.Version101e, UcsPropertyMeta.ReadOnly, None, None, None, """(([0-9a-fA-F][0-9a-fA-F]:){5}([0-9a-fA-F][0-9a-fA-F]))|0""", ["derived"], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("AdaptorFcOEIf", "adaptorFcOEIf", "fcoe", _VersionMeta.Version101e, "InputOutput", 0xffL, [], [u'dcxVIf'], ["Get"], ["read-only"])
}
