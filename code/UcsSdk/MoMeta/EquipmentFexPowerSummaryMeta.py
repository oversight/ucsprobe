...
PROPERTY_DICT = {
	...
	"Meta":UcsMoMeta("EquipmentFexPowerSummary", "equipmentFexPowerSummary", "power-summary", _VersionMeta.Version141i, "OutputOnly", 0x0L, [], [u'equipmentFexPowerSummaryHist'], ["Get"], ["admin", "operations", "read-only"])
}
