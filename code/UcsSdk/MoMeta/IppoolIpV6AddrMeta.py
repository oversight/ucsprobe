...
PROPERTY_DICT = {
	...
	"Owner":UcsPropertyMeta("Owner", "owner", "string", _VersionMeta.Version221b, UcsPropertyMeta.ReadOnly, None, None, None, None, ["end-point", "pool"], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("IppoolIpV6Addr", "ippoolIpV6Addr", "[Id]", _VersionMeta.Version221b, "InputOutput", 0x1fL, [], [u'ippoolPoolable'], [None], ["read-only"])
}
