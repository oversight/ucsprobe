...
PROPERTY_DICT = {
	...
	"Meta":UcsMoMeta("ImgprovPolicy", "imgprovPolicy", "img-prov-policy-[Name]", _VersionMeta.Version141i, "InputOutput", 0x7fL, [], [u'imgprovTarget'], ["Get"], ["admin", "ls-compute", "ls-config", "ls-config-policy", "ls-server"])
}
