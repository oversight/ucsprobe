...
PROPERTY_DICT = {
	...
	"IsNative":UcsPropertyMeta("IsNative", "isNative", "string", _VersionMeta.Version141i, UcsPropertyMeta.ReadWrite, 0x20L, None, None, None, ["false", "no", "true", "yes"], ["0-4294967295"]),
	...
	"OperSpeed":UcsPropertyMeta("OperSpeed", "operSpeed", "string", _VersionMeta.Version141i, UcsPropertyMeta.ReadWrite, 0x80L, None, None, None, ["10gbps", "1gbps", "20gbps", "40gbps", "indeterminate"], ["0-4294967295"]),
	...
	"PortId":UcsPropertyMeta("PortId", "portId", "uint", _VersionMeta.Version141i, UcsPropertyMeta.Naming, 0x100L, None, None, None, [], ["1-256"]),
	...
	"SwitchId":UcsPropertyMeta("SwitchId", "switchId", "string", _VersionMeta.Version141i, UcsPropertyMeta.Naming, 0x800L, None, None, None, ["A", "B", "NONE"], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("FabricEthVlanPc", "fabricEthVlanPc", "pc-switch-[SwitchId]-pc-[PortId]", _VersionMeta.Version141i, "InputOutput", 0xfffL, [], [u'faultInst'], ["Add", "Get", "Remove", "Set"], ["admin", "ext-lan-config", "ext-lan-policy"])
}
