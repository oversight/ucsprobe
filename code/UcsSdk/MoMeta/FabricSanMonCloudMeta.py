...
PROPERTY_DICT = {
	...
	"Meta":UcsMoMeta("FabricSanMonCloud", "fabricSanMonCloud", "sanmon", _VersionMeta.Version141i, "InputOutput", 0xfL, [], [u'fabricFcMonSan', u'statsThresholdPolicy'], ["Get"], ["admin", "ext-san-config", "ext-san-policy"])
}
