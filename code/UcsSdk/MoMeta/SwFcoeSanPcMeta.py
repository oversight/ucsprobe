...
PROPERTY_DICT = {
	...
	"MonTrafDir":UcsPropertyMeta("MonTrafDir", "monTrafDir", "string", _VersionMeta.Version211a, UcsPropertyMeta.ReadOnly, None, None, None, None, ["both", "rx", "tx"], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("SwFcoeSanPc", "swFcoeSanPc", "fcoesan-pc-[PortId]", _VersionMeta.Version211a, "InputOutput", 0x7fL, [], [u'dcxFcoeVifEp', u'dcxVifEp', u'swVlan'], ["Add", "Get", "Remove", "Set"], ["read-only"])
}
