...
PROPERTY_DICT = {
	...
	"VpCPUPerformance":UcsPropertyMeta("VpCPUPerformance", "vpCPUPerformance", "string", _VersionMeta.Version141i, UcsPropertyMeta.ReadWrite, 0x10L, None, None, None, ["enterprise", "high-throughput", "hpc", "platform-default", "platform-recommended"], ["0-4294967295"]),
	"Meta":UcsMoMeta("BiosVfCPUPerformance", "biosVfCPUPerformance", "CPU-Performance", _VersionMeta.Version141i, "InputOutput", 0x1fL, [], [], ["Get", "Set"], ["admin", "ls-compute", "ls-config", "ls-server", "ls-server-policy", "pn-policy"])
}
