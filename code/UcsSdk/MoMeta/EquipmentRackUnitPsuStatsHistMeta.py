...
PROPERTY_DICT = {
	...
	"InputVoltage":UcsPropertyMeta("InputVoltage", "inputVoltage", "float", _VersionMeta.Version141i, UcsPropertyMeta.ReadOnly, None, None, None, None, [], ["0-4294967295"]),
	...
	"OutputVoltage":UcsPropertyMeta("OutputVoltage", "outputVoltage", "float", _VersionMeta.Version141i, UcsPropertyMeta.ReadOnly, None, None, None, None, [], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("EquipmentRackUnitPsuStatsHist", "equipmentRackUnitPsuStatsHist", "[Id]", _VersionMeta.Version141i, "OutputOnly", 0x0L, [], [], ["Get"], ["read-only"])
}
