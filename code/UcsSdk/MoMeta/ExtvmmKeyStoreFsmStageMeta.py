...
PROPERTY_DICT = {
	...
	"Name":UcsPropertyMeta("Name", "name", "string", _VersionMeta.Version211a, UcsPropertyMeta.Naming, None, None, None, None, ["certInstallBegin", "certInstallFail", "certInstallSetLocal", "certInstallSetPeer", "certInstallSuccess", "nop"], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("ExtvmmKeyStoreFsmStage", "extvmmKeyStoreFsmStage", "stage-[Name]", _VersionMeta.Version211a, "OutputOnly", 0x0L, [], [], [None], [""])
}
