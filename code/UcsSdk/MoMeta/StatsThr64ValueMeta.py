...
PROPERTY_DICT = {
	...
	"Deescalating":UcsPropertyMeta("Deescalating", "deescalating", "ulong", _VersionMeta.Version101e, UcsPropertyMeta.ReadWrite, 0x2L, None, None, None, [], ["0-4294967295"]),
	...
	"Escalating":UcsPropertyMeta("Escalating", "escalating", "ulong", _VersionMeta.Version101e, UcsPropertyMeta.ReadWrite, 0x20L, None, None, None, [], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("StatsThr64Value", "statsThr64Value", "[Direction]-[Severity]", _VersionMeta.Version101e, "InputOutput", 0x7ffL, [], [], ["Add", "Get", "Set"], ["admin", "operations"])
}
