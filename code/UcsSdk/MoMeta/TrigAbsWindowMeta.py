...
PROPERTY_DICT = {
	...
	"Date":UcsPropertyMeta("Date", "date", "string", _VersionMeta.Version141i, UcsPropertyMeta.ReadWrite, 0x4L, None, None, """([0-9]){4}-([0-9]){2}-([0-9]){2}T([0-9]){2}:([0-9]){2}:([0-9]){2}((\.([0-9]){3})){0,1}""", [], ["0-4294967295"]),
	...
	"ProcBreak":UcsPropertyMeta("ProcBreak", "procBreak", "string", _VersionMeta.Version141i, UcsPropertyMeta.ReadWrite, 0x20L, None, None, """[0-9]+:([0-1][0-9]|2[0-3]):[0-5][0-9]:[0-5][0-9](\.[0-9]{1,3})?""", ["none"], ["0-4294967295"]),
	"ProcCap":UcsPropertyMeta("ProcCap", "procCap", "string", _VersionMeta.Version141i, UcsPropertyMeta.ReadWrite, 0x40L, None, None, None, ["unlimited"], ["0-65535"]),
	...
	"TimeCap":UcsPropertyMeta("TimeCap", "timeCap", "string", _VersionMeta.Version141i, UcsPropertyMeta.ReadWrite, 0x200L, None, None, """[0-9]+:([0-1][0-9]|2[0-3]):[0-5][0-9]:[0-5][0-9](\.[0-9]{1,3})?""", ["none"], ["0-4294967295"]),
	"Meta":UcsMoMeta("TrigAbsWindow", "trigAbsWindow", "abs-[Name]", _VersionMeta.Version141i, "InputOutput", 0x3ffL, [], [], ["Add", "Get", "Remove", "Set"], ["admin", "ls-compute", "ls-config", "ls-server"])
}
