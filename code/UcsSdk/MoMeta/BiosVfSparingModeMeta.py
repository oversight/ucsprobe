...
PROPERTY_DICT = {
	...
	"VpSparingMode":UcsPropertyMeta("VpSparingMode", "vpSparingMode", "string", _VersionMeta.Version141i, UcsPropertyMeta.ReadWrite, 0x10L, None, None, None, ["dimm-sparing", "platform-default", "platform-recommended", "rank-sparing"], ["0-4294967295"]),
	"Meta":UcsMoMeta("BiosVfSparingMode", "biosVfSparingMode", "Sparing-Mode", _VersionMeta.Version141i, "InputOutput", 0x1fL, [], [], ["Get", "Set"], ["admin", "ls-compute", "ls-config", "ls-server", "ls-server-policy", "pn-policy"])
}
