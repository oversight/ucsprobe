...
PROPERTY_DICT = {
	...
	"FtrMoClassName":UcsPropertyMeta("FtrMoClassName", "ftrMoClassName", "string", _VersionMeta.Version141i, UcsPropertyMeta.ReadOnly, None, None, None, """[\-\.:_a-zA-Z0-9]{0,16}""", [], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("BiosFeatureRef", "biosFeatureRef", "feature-ref-[Name]", _VersionMeta.Version131c, "InputOutput", 0x1fL, [], [u'biosParameterRef'], ["Get"], [""])
}
