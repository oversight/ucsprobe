...
class ObserveObservedFsm(ManagedObject):
	def __init__(self):
		ManagedObject.__init__(self,"ObserveObservedFsm")

	@staticmethod
	def ClassId():
		return "observeObservedFsm"
	...
	CONST_CURRENT_FSM_RESOLVE_CONTROLLER_FSM = "ResolveControllerFsm"
	CONST_CURRENT_FSM_RESOLVE_POLICY_FSM = "ResolvePolicyFsm"
	CONST_CURRENT_FSM_RESOLVE_RESOURCE_FSM = "ResolveResourceFsm"
	CONST_CURRENT_FSM_RESOLVE_VMFSM = "ResolveVMFsm"
