...
PROPERTY_DICT = {
	...
	"Meta":UcsMoMeta("ObserveObservedFsmStage", "observeObservedFsmStage", "stage-[Name]", _VersionMeta.Version211a, "OutputOnly", 0x0L, [], [], [None], [""])
}
