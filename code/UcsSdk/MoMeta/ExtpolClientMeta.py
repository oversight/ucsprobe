...
PROPERTY_DICT = {
	...
	"GracePeriodUsed":UcsPropertyMeta("GracePeriodUsed", "gracePeriodUsed", "ulong", _VersionMeta.Version212a, UcsPropertyMeta.ReadOnly, None, None, None, None, [], ["0-4294967295"]),
	...
	"LicState":UcsPropertyMeta("LicState", "licState", "string", _VersionMeta.Version212a, UcsPropertyMeta.ReadOnly, None, None, None, None, ["license-expired", "license-graceperiod", "license-insufficient", "license-ok", "not-applicable", "unknown"], ["0-4294967295"]),
	...
	"SuspendState":UcsPropertyMeta("SuspendState", "suspendState", "string", _VersionMeta.Version211a, UcsPropertyMeta.ReadOnly, None, None, None, None, ["off", "on"], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("ExtpolClient", "extpolClient", "client-[Id]", _VersionMeta.Version211a, "InputOutput", 0x1fL, [], [u'faultInst', u'observeObserved', u'policyPolicyScopeCont'], ["Get"], ["admin"])
}
