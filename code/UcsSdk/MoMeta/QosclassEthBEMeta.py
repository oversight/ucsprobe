...
PROPERTY_DICT = {
	...
	"Mtu":UcsPropertyMeta("Mtu", "mtu", "string", _VersionMeta.Version101e, UcsPropertyMeta.ReadWrite, 0x4L, None, None, None, ["fc", "normal"], ["0-4294967295"]),
	"MulticastOptimize":UcsPropertyMeta("MulticastOptimize", "multicastOptimize", "string", _VersionMeta.Version101e, UcsPropertyMeta.ReadWrite, 0x8L, None, None, None, ["false", "no", "true", "yes"], ["0-4294967295"]),
	...
	"Weight":UcsPropertyMeta("Weight", "weight", "string", _VersionMeta.Version101e, UcsPropertyMeta.ReadWrite, 0x80L, None, None, None, ["best-effort", "none"], ["0-10"]),
	"Meta":UcsMoMeta("QosclassEthBE", "qosclassEthBE", "class-best-effort", _VersionMeta.Version101e, "InputOutput", 0xffL, [], [], ["Get", "Set"], ["admin", "ext-lan-qos", "ext-san-qos", "ls-network", "ls-network-policy", "ls-qos-policy"])
}
