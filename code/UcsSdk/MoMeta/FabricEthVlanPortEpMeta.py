...
PROPERTY_DICT = {
	...
	"IsNative":UcsPropertyMeta("IsNative", "isNative", "string", _VersionMeta.Version141i, UcsPropertyMeta.ReadWrite, 0x8L, None, None, None, ["false", "no", "true", "yes"], ["0-4294967295"]),
	...
	"SlotId":UcsPropertyMeta("SlotId", "slotId", "uint", _VersionMeta.Version141i, UcsPropertyMeta.Naming, 0x80L, None, None, None, [], ["1-5"]),
	...
	"SwitchId":UcsPropertyMeta("SwitchId", "switchId", "string", _VersionMeta.Version141i, UcsPropertyMeta.Naming, 0x200L, None, None, None, ["A", "B", "NONE"], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("FabricEthVlanPortEp", "fabricEthVlanPortEp", "phys-switch-[SwitchId]-slot-[SlotId]-port-[PortId]", _VersionMeta.Version141i, "InputOutput", 0x3ffL, [], [u'faultInst'], ["Add", "Get", "Remove", "Set"], ["admin", "ext-lan-config", "ext-lan-policy"])
}
