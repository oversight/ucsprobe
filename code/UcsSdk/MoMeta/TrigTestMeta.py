...
PROPERTY_DICT = {
	...
	"CreationDate":UcsPropertyMeta("CreationDate", "creationDate", "string", _VersionMeta.Version141i, UcsPropertyMeta.ReadOnly, None, None, None, """([0-9]){4}-([0-9]){2}-([0-9]){2}T([0-9]){2}:([0-9]){2}:([0-9]){2}((\.([0-9]){3})){0,1}""", [], ["0-4294967295"]),
	...
	"Name":UcsPropertyMeta("Name", "name", "string", _VersionMeta.Version141i, UcsPropertyMeta.Naming, 0x20L, None, None, """[\-\.:_a-zA-Z0-9]{1,16}""", [], ["0-4294967295"]),
	...
	"Scheduler":UcsPropertyMeta("Scheduler", "scheduler", "string", _VersionMeta.Version141i, UcsPropertyMeta.ReadWrite, 0x100L, None, None, """[\-\.:_a-zA-Z0-9]{0,16}""", [], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("TrigTest", "trigTest", "test-[Name]", _VersionMeta.Version141i, "InputOutput", 0x3ffL, [], [u'faultInst', u'trigLocalSched'], ["Get"], ["read-only"])
}
