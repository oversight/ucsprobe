...
PROPERTY_DICT = {
	...
	"StatsUpdateId":UcsPropertyMeta("StatsUpdateId", "statsUpdateId", "uint", _VersionMeta.Version131c, UcsPropertyMeta.ReadOnly, None, None, None, None, [], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("ApeManager", "apeManager", "ape", _VersionMeta.Version101e, "InputOutput", 0xfL, [], [u'apeControllerManager', u'apeDcosAgManager', u'apeHostAgent', u'apeLANBoot', u'apeLocalDiskBoot', u'apeMc', u'apeNicAgManager', u'apeSANBoot', u'apeVirtualMediaBoot'], [None], ["read-only"])
}
