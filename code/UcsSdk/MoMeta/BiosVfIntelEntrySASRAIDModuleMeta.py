...
PROPERTY_DICT = {
	...
	"VpSASRAID":UcsPropertyMeta("VpSASRAID", "vpSASRAID", "string", _VersionMeta.Version141i, UcsPropertyMeta.ReadWrite, 0x10L, None, None, None, ["disabled", "enabled", "platform-default", "platform-recommended"], ["0-4294967295"]),
	"VpSASRAIDModule":UcsPropertyMeta("VpSASRAIDModule", "vpSASRAIDModule", "string", _VersionMeta.Version141i, UcsPropertyMeta.ReadWrite, 0x20L, None, None, None, ["intel-esrtii", "it-ir-raid", "platform-default", "platform-recommended"], ["0-4294967295"]),
	"Meta":UcsMoMeta("BiosVfIntelEntrySASRAIDModule", "biosVfIntelEntrySASRAIDModule", "Intel-entry-SAS-RAID-module", _VersionMeta.Version111j, "InputOutput", 0x3fL, [], [], ["Get", "Set"], ["admin", "ls-compute", "ls-config", "ls-server", "ls-server-policy", "pn-policy"])
}
