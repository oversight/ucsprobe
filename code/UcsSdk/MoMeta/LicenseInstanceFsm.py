...
class LicenseInstanceFsm(ManagedObject):
	def __init__(self):
		ManagedObject.__init__(self,"LicenseInstanceFsm")

	@staticmethod
	def ClassId():
		return "licenseInstanceFsm"
	...
	CONST_CURRENT_FSM_UPDATE_FLEXLM = "UpdateFlexlm"
