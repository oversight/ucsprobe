...
PROPERTY_DICT = {
	...
	"MsgInterval":UcsPropertyMeta("MsgInterval", "msgInterval", "ushort", _VersionMeta.Version221b, UcsPropertyMeta.ReadWrite, 0x8L, None, None, None, [], ["7-90"]),
	...
	"RecoveryAction":UcsPropertyMeta("RecoveryAction", "recoveryAction", "string", _VersionMeta.Version221b, UcsPropertyMeta.ReadWrite, 0x40L, None, None, None, ["none", "reset"], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("FabricUdldPolicy", "fabricUdldPolicy", "udld-policy", _VersionMeta.Version221b, "InputOutput", 0x1ffL, [], [], [None], ["admin", "ext-lan-config", "ext-lan-policy"])
}
