...
PROPERTY_DICT = {
	...
	"ConstantName":UcsPropertyMeta("ConstantName", "constantName", "string", _VersionMeta.Version141i, UcsPropertyMeta.ReadOnly, None, None, None, """[\-\.:_a-zA-Z0-9]{0,16}""", [], ["0-4294967295"]),
	"Dn":UcsPropertyMeta("Dn", "dn", "string", _VersionMeta.Version131c, UcsPropertyMeta.ReadOnly, 0x2L, 0, 256, None, [], ["0-4294967295"]),
	"IsDefault":UcsPropertyMeta("IsDefault", "isDefault", "string", _VersionMeta.Version131c, UcsPropertyMeta.ReadOnly, None, None, None, None, ["no", "yes"], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("BiosSettingRef", "biosSettingRef", "setting-ref-[Name]", _VersionMeta.Version131c, "InputOutput", 0x1fL, [], [], ["Get"], [""])
}
