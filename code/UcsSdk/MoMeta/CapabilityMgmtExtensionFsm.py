...
class CapabilityMgmtExtensionFsm(ManagedObject):
	def __init__(self):
		ManagedObject.__init__(self,"CapabilityMgmtExtensionFsm")

	@staticmethod
	def ClassId():
		return "capabilityMgmtExtensionFsm"
	...
	CONST_CURRENT_FSM_ACTIVATE_MGMT_EXT = "ActivateMgmtExt"
