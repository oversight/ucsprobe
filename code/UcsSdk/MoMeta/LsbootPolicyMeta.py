...
PROPERTY_DICT = {
	"BootMode":UcsPropertyMeta("BootMode", "bootMode", "string", _VersionMeta.Version221b, UcsPropertyMeta.ReadWrite, 0x1L, None, None, None, ["legacy", "uefi"], ["0-4294967295"]),
	...
	"EnforceVnicName":UcsPropertyMeta("EnforceVnicName", "enforceVnicName", "string", _VersionMeta.Version102d, UcsPropertyMeta.ReadWrite, 0x10L, None, None, None, ["false", "no", "true", "yes"], ["0-4294967295"]),
	...
	"Purpose":UcsPropertyMeta("Purpose", "purpose", "string", _VersionMeta.Version101e, UcsPropertyMeta.CreateOnly, 0x80L, None, None, None, ["operational", "utility"], ["0-4294967295"]),
	"RebootOnUpdate":UcsPropertyMeta("RebootOnUpdate", "rebootOnUpdate", "string", _VersionMeta.Version101e, UcsPropertyMeta.ReadWrite, 0x100L, None, None, None, ["false", "no", "true", "yes"], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("LsbootPolicy", "lsbootPolicy", "boot-policy-[Name]", _VersionMeta.Version101e, "InputOutput", 0x7ffL, [], [u'lsbootBootSecurity', u'lsbootIScsi', u'lsbootLan', u'lsbootSan', u'lsbootStorage', u'lsbootVirtualMedia'], ["Add", "Get", "Remove", "Set"], ["admin", "ls-config-policy", "ls-server-policy", "ls-storage-policy"])
}
