...
PROPERTY_DICT = {
	"AuthProfileName":UcsPropertyMeta("AuthProfileName", "authProfileName", "string", _VersionMeta.Version211a, UcsPropertyMeta.ReadWrite, 0x1L, None, None, None, [], ["0-4294967295"]),
	...
	"InitiatorName":UcsPropertyMeta("InitiatorName", "initiatorName", "string", _VersionMeta.Version211a, UcsPropertyMeta.ReadWrite, 0x10L, None, None, """[0-9a-zA-Z\.:-]{0,223}$""", [], ["0-4294967295"]),
	...
	"IqnIdentPoolName":UcsPropertyMeta("IqnIdentPoolName", "iqnIdentPoolName", "string", _VersionMeta.Version211a, UcsPropertyMeta.ReadWrite, 0x20L, None, None, None, [], ["0-4294967295"]),
	...
	"OperAuthProfileName":UcsPropertyMeta("OperAuthProfileName", "operAuthProfileName", "string", _VersionMeta.Version211a, UcsPropertyMeta.ReadOnly, None, 0, 256, None, [], ["0-4294967295"]),
	"OperIqnIdentPoolName":UcsPropertyMeta("OperIqnIdentPoolName", "operIqnIdentPoolName", "string", _VersionMeta.Version211a, UcsPropertyMeta.ReadOnly, None, 0, 256, None, [], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("VnicIScsiBootVnic", "vnicIScsiBootVnic", "boot-vnic-[Name]", _VersionMeta.Version211a, "InputOutput", 0x3ffL, [], [u'faultInst', u'vnicIPv4If', u'vnicIScsiAutoTargetIf', u'vnicIScsiStaticTargetIf'], ["Add", "Get", "Remove", "Set"], ["admin", "ls-compute", "ls-config", "ls-network", "ls-server", "ls-storage"])
}
