...
PROPERTY_DICT = {
	...
	"VpDramRefreshRate":UcsPropertyMeta("VpDramRefreshRate", "vpDramRefreshRate", "string", _VersionMeta.Version212a, UcsPropertyMeta.ReadWrite, 0x10L, None, None, None, ["1x", "2x", "3x", "4x", "auto", "platform-default", "platform-recommended"], ["0-4294967295"]),
	"Meta":UcsMoMeta("BiosVfDramRefreshRate", "biosVfDramRefreshRate", "Dram-Refresh-Rate", _VersionMeta.Version212a, "InputOutput", 0x1fL, [], [], ["Get", "Set"], ["admin", "ls-compute", "ls-config", "ls-server", "ls-server-policy", "pn-policy"])
}
