...
PROPERTY_DICT = {
	"Apply":UcsPropertyMeta("Apply", "apply", "string", _VersionMeta.Version101e, UcsPropertyMeta.ReadWrite, 0x1L, None, None, None, ["onAssociation", "runTime"], ["0-4294967295"]),
	...
	"SrcTemplName":UcsPropertyMeta("SrcTemplName", "srcTemplName", "string", _VersionMeta.Version101e, UcsPropertyMeta.ReadWrite, 0x80L, None, None, """[\-\.:_a-zA-Z0-9]{0,32}""", [], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("LsTier", "lsTier", "tier-[Name]", _VersionMeta.Version101e, "InputOutput", 0x1ffL, [], [u'lsServer'], [None], ["admin", "ls-compute", "ls-config", "ls-config-policy", "ls-server", "ls-server-policy"])
}
