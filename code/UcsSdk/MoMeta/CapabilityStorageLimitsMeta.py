...
PROPERTY_DICT = {
	...
	"Meta":UcsMoMeta("CapabilityStorageLimits", "capabilityStorageLimits", "storage-limits", _VersionMeta.Version211a, "InputOutput", 0xfL, [], [u'capabilityFeatureLimits'], [None], ["read-only"])
}
