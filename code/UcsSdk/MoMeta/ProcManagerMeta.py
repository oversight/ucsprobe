...
PROPERTY_DICT = {
	...
	"Meta":UcsMoMeta("ProcManager", "procManager", "proc-info", _VersionMeta.Version101e, "InputOutput", 0xfL, [], [u'procDoer', u'procPrt', u'procPrtCounts', u'procStimulusCounts', u'procSvc', u'procTxCounts'], ["Get"], ["read-only"])
}
