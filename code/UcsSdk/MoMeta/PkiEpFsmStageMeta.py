...
PROPERTY_DICT = {
	...
	"Name":UcsPropertyMeta("Name", "name", "string", _VersionMeta.Version211a, UcsPropertyMeta.Naming, None, None, None, None, ["nop", "updateEpBegin", "updateEpFail", "updateEpPostSetKeyRingLocal", "updateEpPostSetKeyRingPeer", "updateEpSetKeyRingLocal", "updateEpSetKeyRingPeer", "updateEpSuccess"], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("PkiEpFsmStage", "pkiEpFsmStage", "stage-[Name]", _VersionMeta.Version211a, "OutputOnly", 0x0L, [], [], [None], [""])
}
