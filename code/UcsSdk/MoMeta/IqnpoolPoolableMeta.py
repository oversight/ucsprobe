...
PROPERTY_DICT = {
	...
	"Id":UcsPropertyMeta("Id", "id", "ulong", _VersionMeta.Version201m, UcsPropertyMeta.Naming, 0x4L, None, None, None, [], ["0-4294967295"]),
	"PoolDn":UcsPropertyMeta("PoolDn", "poolDn", "string", _VersionMeta.Version201m, UcsPropertyMeta.ReadOnly, None, 0, 256, None, [], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("IqnpoolPoolable", "iqnpoolPoolable", "pool-[Id]", _VersionMeta.Version201m, "InputOutput", 0x1fL, [], [], ["Get"], ["read-only"])
}
