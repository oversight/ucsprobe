...
PROPERTY_DICT = {
	...
	"VpProcessorC1E":UcsPropertyMeta("VpProcessorC1E", "vpProcessorC1E", "string", _VersionMeta.Version201m, UcsPropertyMeta.ReadWrite, 0x10L, None, None, None, ["disabled", "enabled", "platform-default", "platform-recommended"], ["0-4294967295"]),
	"Meta":UcsMoMeta("BiosVfProcessorC1E", "biosVfProcessorC1E", "Processor-C1E", _VersionMeta.Version201m, "InputOutput", 0x1fL, [], [], ["Get", "Set"], ["admin", "ls-compute", "ls-config", "ls-server", "ls-server-policy", "pn-policy"])
}
