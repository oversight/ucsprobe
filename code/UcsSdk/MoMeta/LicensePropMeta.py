...
PROPERTY_DICT = {
	...
	"Value":UcsPropertyMeta("Value", "value", "string", _VersionMeta.Version141i, UcsPropertyMeta.ReadOnly, None, 0, 510, None, [], ["0-4294967295"]),
	"Meta":UcsMoMeta("LicenseProp", "licenseProp", "prop-[Name]", _VersionMeta.Version141i, "InputOutput", 0x1fL, [], [], ["Get"], ["read-only"])
}
