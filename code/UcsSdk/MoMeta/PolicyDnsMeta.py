...
PROPERTY_DICT = {
	...
	"Meta":UcsMoMeta("PolicyDns", "policyDns", "dns-ctrl", _VersionMeta.Version211a, "InputOutput", 0x1fL, [], [u'policyControlledInstance', u'policyControlledType'], ["Add", "Get", "Set"], ["aaa", "admin", "ext-lan-config"])
}
