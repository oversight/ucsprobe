...
PROPERTY_DICT = {
	...
	"IsSupported":UcsPropertyMeta("IsSupported", "isSupported", "string", _VersionMeta.Version222c, UcsPropertyMeta.ReadOnly, None, None, None, None, ["no", "yes"], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("EquipmentKvmMgmtCap", "equipmentKvmMgmtCap", "kvm-mgmt-cap", _VersionMeta.Version222c, "InputOutput", 0xfL, [], [], [None], ["read-only"])
}
