...
PROPERTY_DICT = {
	...
	"Type":UcsPropertyMeta("Type", "type", "string", _VersionMeta.Version111j, UcsPropertyMeta.Naming, 0x40L, None, None, None, ["OBFL", "SEL", "Syslog"], ["0-4294967295"]),
	"Meta":UcsMoMeta("SysdebugMEpLogPolicy", "sysdebugMEpLogPolicy", "log-[Type]", _VersionMeta.Version111j, "InputOutput", 0x7fL, [], [u'sysdebugBackupBehavior'], ["Get"], ["admin", "operations"])
}
