...
PROPERTY_DICT = {
	...
	"FanCapacity":UcsPropertyMeta("FanCapacity", "fanCapacity", "ushort", _VersionMeta.Version201m, UcsPropertyMeta.ReadOnly, None, None, None, None, [], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("EquipmentFanModuleDef", "equipmentFanModuleDef", "fanmod", _VersionMeta.Version201m, "InputOutput", 0x7fL, [], [], ["Get"], [""])
}
