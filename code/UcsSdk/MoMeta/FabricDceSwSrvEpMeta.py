...
PROPERTY_DICT = {
	...
	"PortId":UcsPropertyMeta("PortId", "portId", "uint", _VersionMeta.Version101e, UcsPropertyMeta.Naming, 0x10L, None, None, None, [], ["1-48"]),
	"Rn":UcsPropertyMeta("Rn", "rn", "string", _VersionMeta.Version101e, UcsPropertyMeta.ReadOnly, 0x20L, 0, 256, None, [], ["0-4294967295"]),
	"SlotId":UcsPropertyMeta("SlotId", "slotId", "uint", _VersionMeta.Version101e, UcsPropertyMeta.Naming, 0x40L, None, None, None, [], ["1-4"]),
	...
	"Meta":UcsMoMeta("FabricDceSwSrvEp", "fabricDceSwSrvEp", "slot-[SlotId]-port-[PortId]", _VersionMeta.Version101e, "InputOutput", 0x1ffL, [], [u'fabricEthMonSrcEp', u'faultInst'], ["Add", "Get", "Remove", "Set"], ["admin", "ls-network", "ls-network-policy"])
}
