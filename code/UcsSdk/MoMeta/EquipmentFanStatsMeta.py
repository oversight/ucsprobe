...
PROPERTY_DICT = {
	...
	"Meta":UcsMoMeta("EquipmentFanStats", "equipmentFanStats", "stats", _VersionMeta.Version111j, "OutputOnly", 0x0L, [], [u'equipmentFanStatsHist'], ["Get"], ["admin", "operations", "read-only"])
}
