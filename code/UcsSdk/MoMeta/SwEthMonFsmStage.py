...
class SwEthMonFsmStage(ManagedObject):
	def __init__(self):
		ManagedObject.__init__(self,"SwEthMonFsmStage")

	@staticmethod
	def ClassId():
		return "swEthMonFsmStage"
	...
	CONST_NAME_DEPLOY_UPDATE_ETH_MON = "DeployUpdateEthMon"
	CONST_NAME_NOP = "nop"
