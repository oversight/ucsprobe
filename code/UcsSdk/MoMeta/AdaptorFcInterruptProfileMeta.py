...
PROPERTY_DICT = {
	...
	"Mode":UcsPropertyMeta("Mode", "mode", "string", _VersionMeta.Version111j, UcsPropertyMeta.ReadWrite, 0x4L, None, None, None, ["intx", "msi", "msi-x"], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("AdaptorFcInterruptProfile", "adaptorFcInterruptProfile", "fc-int", _VersionMeta.Version111j, "InputOutput", 0x1fL, [], [], ["Get", "Set"], ["admin", "ls-config-policy", "ls-server-policy", "ls-storage"])
}
