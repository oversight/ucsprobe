...
PROPERTY_DICT = {
	...
	"SyncTrigger":UcsPropertyMeta("SyncTrigger", "syncTrigger", "string", _VersionMeta.Version211a, UcsPropertyMeta.ReadOnly, None, None, None, None, ["false", "no", "true", "yes"], ["0-4294967295"]),
	"Meta":UcsMoMeta("FirmwareCatalogue", "firmwareCatalogue", "fw-catalogue", _VersionMeta.Version101e, "InputOutput", 0xfL, [], [u'firmwareCompSource', u'firmwareDistributable', u'firmwareDownloader', u'firmwareImage'], [None], ["read-only"])
}
