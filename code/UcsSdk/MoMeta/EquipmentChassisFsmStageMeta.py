...
PROPERTY_DICT = {
	...
	"Meta":UcsMoMeta("EquipmentChassisFsmStage", "equipmentChassisFsmStage", "stage-[Name]", _VersionMeta.Version211a, "OutputOnly", 0x0L, [], [], [None], [""])
}
