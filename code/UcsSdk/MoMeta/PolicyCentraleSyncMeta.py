...
PROPERTY_DICT = {
	...
	"LeftData":UcsPropertyMeta("LeftData", "leftData", "string", _VersionMeta.Version212a, UcsPropertyMeta.ReadOnly, None, 0, 510, None, [], ["0-4294967295"]),
	"RightData":UcsPropertyMeta("RightData", "rightData", "string", _VersionMeta.Version212a, UcsPropertyMeta.ReadOnly, None, 0, 510, None, [], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("PolicyCentraleSync", "policyCentraleSync", "centrale-sync", _VersionMeta.Version212a, "InputOutput", 0xfL, [], [], [None], ["read-only"])
}
