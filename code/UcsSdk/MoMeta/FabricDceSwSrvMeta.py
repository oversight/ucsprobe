...
PROPERTY_DICT = {
	...
	"Meta":UcsMoMeta("FabricDceSwSrv", "fabricDceSwSrv", "sw-[Id]", _VersionMeta.Version101e, "InputOutput", 0x3fL, [], [u'fabricDceSwSrvEp', u'fabricDceSwSrvPc'], ["Get"], ["admin", "ls-network-policy"])
}
