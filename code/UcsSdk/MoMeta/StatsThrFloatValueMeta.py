...
PROPERTY_DICT = {
	...
	"Deescalating":UcsPropertyMeta("Deescalating", "deescalating", "float", _VersionMeta.Version101e, UcsPropertyMeta.ReadWrite, 0x2L, None, None, None, [], ["0-4294967295"]),
	...
	"Escalating":UcsPropertyMeta("Escalating", "escalating", "float", _VersionMeta.Version101e, UcsPropertyMeta.ReadWrite, 0x20L, None, None, None, [], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("StatsThrFloatValue", "statsThrFloatValue", "[Direction]-[Severity]", _VersionMeta.Version101e, "InputOutput", 0x7ffL, [], [], ["Get"], ["admin", "operations"])
}
