...
PROPERTY_DICT = {
	...
	"Name":UcsPropertyMeta("Name", "name", "string", _VersionMeta.Version211a, UcsPropertyMeta.Naming, None, None, None, None, ["clusterRoleBegin", "clusterRoleFail", "clusterRoleSetLocal", "clusterRoleSetPeer", "clusterRoleSuccess", "nop"], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("ExtvmmEpFsmStage", "extvmmEpFsmStage", "stage-[Name]", _VersionMeta.Version211a, "OutputOnly", 0x0L, [], [], [None], [""])
}
