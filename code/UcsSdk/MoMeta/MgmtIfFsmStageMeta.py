...
PROPERTY_DICT = {
	...
	"Meta":UcsMoMeta("MgmtIfFsmStage", "mgmtIfFsmStage", "stage-[Name]", _VersionMeta.Version211a, "OutputOnly", 0x0L, [], [], [None], [""])
}
