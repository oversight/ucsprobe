...
PROPERTY_DICT = {
	"CanBeFRUed":UcsPropertyMeta("CanBeFRUed", "canBeFRUed", "string", _VersionMeta.Version101e, UcsPropertyMeta.ReadOnly, None, None, None, None, ["false", "no", "true", "yes"], ["0-4294967295"]),
	...
	"RemovalConditions":UcsPropertyMeta("RemovalConditions", "removalConditions", "string", _VersionMeta.Version101e, UcsPropertyMeta.ReadOnly, None, None, None, None, ["Not Applicable", "Removable when off", "Removable when on or off", "Unknown"], ["0-4294967295"]),
	"Rn":UcsPropertyMeta("Rn", "rn", "string", _VersionMeta.Version101e, UcsPropertyMeta.ReadOnly, 0x20L, 0, 256, None, [], ["0-4294967295"]),
	"ServicePhilosophy":UcsPropertyMeta("ServicePhilosophy", "servicePhilosophy", "string", _VersionMeta.Version101e, UcsPropertyMeta.ReadOnly, None, 0, 510, None, [], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("EquipmentServiceDef", "equipmentServiceDef", "service", _VersionMeta.Version101e, "InputOutput", 0x7fL, [], [], ["Get"], [""])
}
