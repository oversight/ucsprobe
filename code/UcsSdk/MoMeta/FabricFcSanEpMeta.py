...
PROPERTY_DICT = {
	...
	"FillPattern":UcsPropertyMeta("FillPattern", "fillPattern", "string", _VersionMeta.Version212a, UcsPropertyMeta.ReadWrite, 0x8L, None, None, None, ["arbff", "idle"], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("FabricFcSanEp", "fabricFcSanEp", "phys-slot-[SlotId]-port-[PortId]", _VersionMeta.Version101e, "InputOutput", 0x3ffL, [], [u'fabricFcMonSrcEp', u'fabricVsanEp', u'fabricVsanMembership', u'faultInst'], ["Add", "Get", "Set"], ["admin", "ext-san-config", "ext-san-policy"])
}
