...
PROPERTY_DICT = {
	...
	"Port":UcsPropertyMeta("Port", "port", "uint", _VersionMeta.Version101e, UcsPropertyMeta.ReadWrite, 0x20L, None, None, None, [], ["0-65535"]),
	...
	"Meta":UcsMoMeta("CommSmashCLP", "commSmashCLP", "smashclp-svc", _VersionMeta.Version101e, "InputOutput", 0xffL, [], [], ["Get"], ["aaa", "admin"])
}
