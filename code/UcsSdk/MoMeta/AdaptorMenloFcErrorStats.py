...
class AdaptorMenloFcErrorStats(ManagedObject):
	def __init__(self):
		ManagedObject.__init__(self,"AdaptorMenloFcErrorStats")

	@staticmethod
	def ClassId():
		return "adaptorMenloFcErrorStats"
	...
	CONST_MENLO_FC_INDEX_0 = "0"
	CONST_MENLO_FC_INDEX_0_A = "0_A"
	CONST_MENLO_FC_INDEX_0_B = "0_B"
	CONST_MENLO_FC_INDEX_1 = "1"
	CONST_MENLO_FC_INDEX_1_A = "1_A"
	CONST_MENLO_FC_INDEX_1_B = "1_B"
	CONST_MENLO_FC_INDEX_UNKNOWN = "unknown"
