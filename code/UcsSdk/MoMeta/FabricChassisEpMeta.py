...
PROPERTY_DICT = {
	...
	"ChassisDn":UcsPropertyMeta("ChassisDn", "chassisDn", "string", _VersionMeta.Version101e, UcsPropertyMeta.ReadOnly, None, 0, 256, None, [], ["0-4294967295"]),
	"ChassisId":UcsPropertyMeta("ChassisId", "chassisId", "string", _VersionMeta.Version101e, UcsPropertyMeta.Naming, 0x2L, None, None, None, ["N/A"], ["1-255"]),
	...
	"Meta":UcsMoMeta("FabricChassisEp", "fabricChassisEp", "chassis-[ChassisId]", _VersionMeta.Version101e, "InputOutput", 0x7fL, [], [u'fabricComputeSlotEp', u'faultInst'], ["Get"], ["read-only"])
}
