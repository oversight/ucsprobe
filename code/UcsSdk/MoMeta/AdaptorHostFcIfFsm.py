...
class AdaptorHostFcIfFsm(ManagedObject):
	def __init__(self):
		ManagedObject.__init__(self,"AdaptorHostFcIfFsm")

	@staticmethod
	def ClassId():
		return "adaptorHostFcIfFsm"
	...
	CONST_CURRENT_FSM_CIRCUIT_RESET = "CircuitReset"
	CONST_CURRENT_FSM_RESET_FC_PERS_BINDING = "ResetFcPersBinding"
