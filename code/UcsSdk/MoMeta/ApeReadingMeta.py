...
PROPERTY_DICT = {
	...
	"State":UcsPropertyMeta("State", "state", "ushort", _VersionMeta.Version211a, UcsPropertyMeta.ReadWrite, 0x10L, None, None, None, [], ["0-4294967295"]),
	...
	"Value":UcsPropertyMeta("Value", "value", "ushort", _VersionMeta.Version101e, UcsPropertyMeta.ReadWrite, 0x40L, None, None, None, [], ["0-4294967295"]),
	"Meta":UcsMoMeta("ApeReading", "apeReading", "reading-[Id]", _VersionMeta.Version101e, "InputOutput", 0x7fL, [], [], [None], ["read-only"])
}
