...
PROPERTY_DICT = {
	...
	"DefaultZoning":UcsPropertyMeta("DefaultZoning", "defaultZoning", "string", _VersionMeta.Version141i, UcsPropertyMeta.ReadOnly, None, None, None, None, ["disabled", "enabled"], ["0-4294967295"]),
	...
	"FcZoneSharingMode":UcsPropertyMeta("FcZoneSharingMode", "fcZoneSharingMode", "string", _VersionMeta.Version211a, UcsPropertyMeta.ReadWrite, 0x4L, None, None, None, ["clear-unmanaged-zone-all", "coalesce"], ["0-4294967295"]),
	"FcoeVlan":UcsPropertyMeta("FcoeVlan", "fcoeVlan", "uint", _VersionMeta.Version101e, UcsPropertyMeta.ReadWrite, 0x8L, None, None, None, [], ["1-3967", "4048-4093"]),
	...
	"Id":UcsPropertyMeta("Id", "id", "uint", _VersionMeta.Version101e, UcsPropertyMeta.ReadWrite, 0x10L, None, None, None, [], ["1-4093"]),
	...
	"PolicyOwner":UcsPropertyMeta("PolicyOwner", "policyOwner", "string", _VersionMeta.Version212a, UcsPropertyMeta.ReadWrite, 0x40L, None, None, None, ["local", "pending-policy", "policy"], ["0-4294967295"]),
	...
	"ZoningState":UcsPropertyMeta("ZoningState", "zoningState", "string", _VersionMeta.Version211a, UcsPropertyMeta.ReadWrite, 0x200L, None, None, None, ["disabled", "enabled"], ["0-4294967295"]),
	"Meta":UcsMoMeta("FabricVsan", "fabricVsan", "net-[Name]", _VersionMeta.Version101e, "InputOutput", 0x3ffL, [], [u'fabricFcMonFiltEp', u'fabricFcMonSrcEp', u'fabricFcVsanPc', u'fabricFcVsanPortEp', u'fabricFcoeVsanPc', u'fabricFcoeVsanPortEp', u'faultInst'], ["Add", "Get", "Remove", "Set"], ["admin", "ext-san-config", "ext-san-policy"])
}
