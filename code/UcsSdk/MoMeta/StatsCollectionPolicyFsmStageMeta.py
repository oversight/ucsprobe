...
PROPERTY_DICT = {
	...
	"Name":UcsPropertyMeta("Name", "name", "string", _VersionMeta.Version211a, UcsPropertyMeta.Naming, None, None, None, None, ["nop", "updateEpBegin", "updateEpFail", "updateEpSetEpA", "updateEpSetEpB", "updateEpSuccess"], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("StatsCollectionPolicyFsmStage", "statsCollectionPolicyFsmStage", "stage-[Name]", _VersionMeta.Version211a, "OutputOnly", 0x0L, [], [], [None], [""])
}
