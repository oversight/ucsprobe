...
PROPERTY_DICT = {
	...
	"PortModeBeacon":UcsPropertyMeta("PortModeBeacon", "portModeBeacon", "string", _VersionMeta.Version201m, UcsPropertyMeta.ReadOnly, None, None, None, None, ["false", "no", "true", "yes"], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("EquipmentBeaconCapProvider", "equipmentBeaconCapProvider", "beacon-cap", _VersionMeta.Version201m, "InputOutput", 0x7fL, [], [], ["Get"], [""])
}
