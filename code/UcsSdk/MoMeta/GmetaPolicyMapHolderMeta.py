...
PROPERTY_DICT = {
	...
	"Meta":UcsMoMeta("GmetaPolicyMapHolder", "gmetaPolicyMapHolder", "policymapholder", _VersionMeta.Version212a, "InputOutput", 0xfL, [], [u'gmetaPolicyMapElement'], [None], ["read-only"])
}
