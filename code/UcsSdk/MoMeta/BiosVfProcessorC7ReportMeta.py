...
PROPERTY_DICT = {
	...
	"VpProcessorC7Report":UcsPropertyMeta("VpProcessorC7Report", "vpProcessorC7Report", "string", _VersionMeta.Version202m, UcsPropertyMeta.ReadWrite, 0x10L, None, None, None, ["disabled", "enabled", "platform-default", "platform-recommended"], ["0-4294967295"]),
	"Meta":UcsMoMeta("BiosVfProcessorC7Report", "biosVfProcessorC7Report", "Processor-C7-Report", _VersionMeta.Version202m, "InputOutput", 0x1fL, [], [], ["Get", "Set"], ["admin", "ls-compute", "ls-config", "ls-server", "ls-server-policy", "pn-policy"])
}
