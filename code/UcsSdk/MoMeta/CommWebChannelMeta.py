...
PROPERTY_DICT = {
	"ChannelState":UcsPropertyMeta("ChannelState", "channelState", "string", _VersionMeta.Version101e, UcsPropertyMeta.ReadWrite, 0x1L, None, None, None, ["fullssl", "noencssl", "plain"], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("CommWebChannel", "commWebChannel", "svc-web-channel", _VersionMeta.Version101e, "InputOutput", 0xffL, [], [], ["Get"], ["aaa", "admin"])
}
