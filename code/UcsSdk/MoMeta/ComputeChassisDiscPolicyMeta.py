...
PROPERTY_DICT = {
	"Action":UcsPropertyMeta("Action", "action", "string", _VersionMeta.Version101e, UcsPropertyMeta.ReadWrite, 0x1L, None, None, None, ["1-link", "2-link", "4-link", "8-link", "immediate", "platform-max", "user-acknowledged"], ["0-4294967295"]),
	...
	"LinkAggregationPref":UcsPropertyMeta("LinkAggregationPref", "linkAggregationPref", "string", _VersionMeta.Version201m, UcsPropertyMeta.ReadWrite, 0x10L, None, None, None, ["none", "port-channel"], ["0-4294967295"]),
	...
	"Qualifier":UcsPropertyMeta("Qualifier", "qualifier", "string", _VersionMeta.Version101e, UcsPropertyMeta.ReadOnly, None, None, None, """[\-\.:_a-zA-Z0-9]{0,16}""", [], ["0-4294967295"]),
	"Rebalance":UcsPropertyMeta("Rebalance", "rebalance", "string", _VersionMeta.Version101e, UcsPropertyMeta.ReadWrite, 0x80L, None, None, None, ["immediate", "user-acknowledged"], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("ComputeChassisDiscPolicy", "computeChassisDiscPolicy", "chassis-discovery", _VersionMeta.Version101e, "InputOutput", 0x3ffL, [], [], ["Get", "Set"], ["admin", "pn-policy"])
}
