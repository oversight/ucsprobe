...
PROPERTY_DICT = {
	...
	"Name":UcsPropertyMeta("Name", "name", "string", _VersionMeta.Version141i, UcsPropertyMeta.Naming, 0x8L, 1, 256, None, [], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("EquipmentBladeAGLibrary", "equipmentBladeAGLibrary", "library-[Name]", _VersionMeta.Version141i, "InputOutput", 0x7fL, [], [], ["Get"], [""])
}
