...
PROPERTY_DICT = {
	...
	"Context":UcsPropertyMeta("Context", "context", "string", _VersionMeta.Version211a, UcsPropertyMeta.CreateOnly, 0x2L, 0, 256, None, [], ["0-4294967295"]),
	"Dn":UcsPropertyMeta("Dn", "dn", "string", _VersionMeta.Version211a, UcsPropertyMeta.ReadOnly, 0x4L, 0, 256, None, [], ["0-4294967295"]),
	"Name":UcsPropertyMeta("Name", "name", "string", _VersionMeta.Version211a, UcsPropertyMeta.Naming, 0x8L, 1, 510, None, [], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("PolicyPolicyScopeContext", "policyPolicyScopeContext", "context-[Name]", _VersionMeta.Version211a, "InputOutput", 0x3fL, [], [u'policyPolicyScope'], [None], ["admin"])
}
