...
PROPERTY_DICT = {
	...
	"Meta":UcsMoMeta("VnicFcGroupDef", "vnicFcGroupDef", "fc-group", _VersionMeta.Version211a, "InputOutput", 0x1ffL, [], [u'faultInst', u'storageConnectionDef'], ["Add", "Get", "Set"], ["admin", "ls-compute", "ls-config", "ls-server", "ls-storage"])
}
