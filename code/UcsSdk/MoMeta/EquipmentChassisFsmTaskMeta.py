...
PROPERTY_DICT = {
	...
	"Item":UcsPropertyMeta("Item", "item", "string", _VersionMeta.Version111j, UcsPropertyMeta.Naming, None, None, None, None, ["DynamicReallocation", "PowerCap", "PsuPolicyConfig", "RemoveChassis", "nop"], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("EquipmentChassisFsmTask", "equipmentChassisFsmTask", "task-[Item]", _VersionMeta.Version111j, "OutputOnly", 0x0L, [], [], [None], [""])
}
