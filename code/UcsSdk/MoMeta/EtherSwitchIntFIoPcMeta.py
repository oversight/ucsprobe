...
PROPERTY_DICT = {
	...
	"PortId":UcsPropertyMeta("PortId", "portId", "uint", _VersionMeta.Version201m, UcsPropertyMeta.Naming, 0x10L, None, None, None, [], ["1024-4096"]),
	...
	"Meta":UcsMoMeta("EtherSwitchIntFIoPc", "etherSwitchIntFIoPc", "pc-[PortId]", _VersionMeta.Version201m, "InputOutput", 0x7fL, [], [u'etherSwitchIntFIoPcEp'], ["Get"], ["admin", "ext-lan-config", "ext-lan-policy", "pn-equipment", "pn-maintenance"])
}
