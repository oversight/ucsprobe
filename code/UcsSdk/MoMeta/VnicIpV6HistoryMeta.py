...
PROPERTY_DICT = {
	...
	"OldIpV6Addr":UcsPropertyMeta("OldIpV6Addr", "oldIpV6Addr", "string", _VersionMeta.Version221b, UcsPropertyMeta.ReadOnly, None, 0, 256, None, [], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("VnicIpV6History", "vnicIpV6History", "ipv6-history", _VersionMeta.Version221b, "InputOutput", 0xfL, [], [], [None], ["read-only"])
}
