...
PROPERTY_DICT = {
	...
	"Meta":UcsMoMeta("AdaptorEthPortOutsizedStats", "adaptorEthPortOutsizedStats", "eth-port-outsized-stats-[TrafficDirection]", _VersionMeta.Version111j, "OutputOnly", 0x0L, [], [u'adaptorEthPortOutsizedStatsHist'], ["Get"], ["admin", "operations", "read-only"])
}
