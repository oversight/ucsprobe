...
PROPERTY_DICT = {
	...
	"Version":UcsPropertyMeta("Version", "version", "string", _VersionMeta.Version211a, UcsPropertyMeta.ReadWrite, 0x20L, 0, 510, None, [], ["0-4294967295"]),
	"Meta":UcsMoMeta("FirmwareBundleInfo", "firmwareBundleInfo", "bundle-[Type]", _VersionMeta.Version211a, "InputOutput", 0x3fL, [], [], [None], ["admin", "ls-config-policy", "ls-server-policy"])
}
