...
PROPERTY_DICT = {
	...
	"Meta":UcsMoMeta("ImgsecPolicy", "imgsecPolicy", "img-sec-policy-[Name]", _VersionMeta.Version141i, "InputOutput", 0x7fL, [], [u'imgsecKey'], ["Get"], ["admin", "ls-compute", "ls-config", "ls-config-policy", "ls-server"])
}
