...
PROPERTY_DICT = {
	...
	"ConfigState":UcsPropertyMeta("ConfigState", "configState", "string", _VersionMeta.Version211a, UcsPropertyMeta.ReadOnly, None, None, None, None, ["applied", "inconsistent"], ["0-4294967295"]),
	...
	"FcoeState":UcsPropertyMeta("FcoeState", "fcoeState", "string", _VersionMeta.Version211a, UcsPropertyMeta.ReadOnly, None, None, None, None, ["admin-down", "error-disabled", "failed", "hardware-failure", "indeterminate", "link-down", "link-up", "no-license", "sfp-not-present", "software-failure", "udld-aggr-down", "up"], ["0-4294967295"]),
	"FcoeStateReason":UcsPropertyMeta("FcoeStateReason", "fcoeStateReason", "string", _VersionMeta.Version211a, UcsPropertyMeta.ReadOnly, None, 0, 510, None, [], ["0-4294967295"]),
	...
	"LacpPolicyName":UcsPropertyMeta("LacpPolicyName", "lacpPolicyName", "string", _VersionMeta.Version222c, UcsPropertyMeta.ReadWrite, 0x10L, None, None, """[\-\.:_a-zA-Z0-9]{0,16}""", [], ["0-4294967295"]),
	...
	"Name":UcsPropertyMeta("Name", "name", "string", _VersionMeta.Version211a, UcsPropertyMeta.ReadWrite, 0x20L, None, None, """[\-\.:_a-zA-Z0-9]{0,16}""", [], ["0-4294967295"]),
	...
	"PortId":UcsPropertyMeta("PortId", "portId", "uint", _VersionMeta.Version211a, UcsPropertyMeta.Naming, 0x40L, None, None, None, [], ["1-256"]),
	...
	"Meta":UcsMoMeta("FabricFcoeSanPc", "fabricFcoeSanPc", "fcoesanpc-[PortId]", _VersionMeta.Version211a, "InputOutput", 0x1ffL, [], [u'etherFcoeInterfaceStats', u'fabricEthMonSrcEp', u'fabricFcoeSanPcEp', u'fabricVsanEp', u'fabricVsanMembership', u'faultInst'], ["Add", "Get", "Remove", "Set"], ["admin", "ext-san-config", "ext-san-policy"])
}
