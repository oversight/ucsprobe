...
PROPERTY_DICT = {
	...
	"Id":UcsPropertyMeta("Id", "id", "string", _VersionMeta.Version101e, UcsPropertyMeta.Naming, 0x4L, None, None, """(([0-9a-fA-F]){4}\-([0-9a-fA-F]){12})|0""", [], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("UuidpoolPooled", "uuidpoolPooled", "[Id]", _VersionMeta.Version101e, "InputOutput", 0x1fL, [], [], ["Get"], ["read-only"])
}
