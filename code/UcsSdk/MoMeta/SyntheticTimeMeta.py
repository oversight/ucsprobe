...
PROPERTY_DICT = {
	...
	"Ts":UcsPropertyMeta("Ts", "ts", "ulong", _VersionMeta.Version101e, UcsPropertyMeta.Naming, 0x10L, None, None, None, [], ["0-4294967295"]),
	"Meta":UcsMoMeta("SyntheticTime", "syntheticTime", "time-[Ts]", _VersionMeta.Version101e, "InputOutput", 0x1fL, [], [], ["Get"], ["admin"])
}
