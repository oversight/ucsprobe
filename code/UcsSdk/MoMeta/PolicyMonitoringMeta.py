...
PROPERTY_DICT = {
	...
	"Meta":UcsMoMeta("PolicyMonitoring", "policyMonitoring", "monitoring-ctrl", _VersionMeta.Version211a, "InputOutput", 0x1fL, [], [u'policyControlledInstance', u'policyControlledType'], ["Add", "Get", "Set"], ["admin", "operations"])
}
