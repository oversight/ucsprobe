...
class ExtpolEpFsm(ManagedObject):
	def __init__(self):
		ManagedObject.__init__(self,"ExtpolEpFsm")
	...
	CONST_CURRENT_FSM_REGISTER_FSM = "RegisterFsm"
	CONST_CURRENT_FSM_NOP = "nop"
	CONST_CURRENT_FSM_REPAIR_CERT = "repairCert"
