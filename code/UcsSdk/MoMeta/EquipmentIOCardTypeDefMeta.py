...
PROPERTY_DICT = {
	...
	"Type":UcsPropertyMeta("Type", "type", "string", _VersionMeta.Version202m, UcsPropertyMeta.ReadOnly, None, 0, 510, None, [], ["0-4294967295"]),
	"Meta":UcsMoMeta("EquipmentIOCardTypeDef", "equipmentIOCardTypeDef", "type", _VersionMeta.Version202m, "InputOutput", 0x7fL, [], [], ["Get"], [""])
}
