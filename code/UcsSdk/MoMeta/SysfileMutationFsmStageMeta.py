...
PROPERTY_DICT = {
	...
	"Name":UcsPropertyMeta("Name", "name", "string", _VersionMeta.Version211a, UcsPropertyMeta.Naming, None, None, None, None, ["GlobalBegin", "GlobalFail", "GlobalLocal", "GlobalPeer", "GlobalSuccess", "SingleBegin", "SingleExecute", "SingleFail", "SingleSuccess", "nop"], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("SysfileMutationFsmStage", "sysfileMutationFsmStage", "stage-[Name]", _VersionMeta.Version211a, "OutputOnly", 0x0L, [], [], [None], [""])
}
