...
class PolicyControlledTypeFsm(ManagedObject):
	def __init__(self):
		ManagedObject.__init__(self,"PolicyControlledTypeFsm")

	@staticmethod
	def ClassId():
		return "policyControlledTypeFsm"
	...
	CONST_CURRENT_FSM_OPERATE = "Operate"
