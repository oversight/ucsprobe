...
PROPERTY_DICT = {
	...
	"Item":UcsPropertyMeta("Item", "item", "string", _VersionMeta.Version141i, UcsPropertyMeta.Naming, None, None, None, None, ["DeleteTechSupFile", "Download", "Initiate", "nop"], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("SysdebugTechSupportFsmTask", "sysdebugTechSupportFsmTask", "task-[Item]", _VersionMeta.Version141i, "OutputOnly", 0x0L, [], [], [None], [""])
}
