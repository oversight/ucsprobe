...
PROPERTY_DICT = {
	...
	"Uptime":UcsPropertyMeta("Uptime", "uptime", "string", _VersionMeta.Version111j, UcsPropertyMeta.ReadOnly, None, None, None, """(([1-9]*[0-9]{2}:)|)([0-1][0-9]||[2][0-3]):([0-5][0-9]):([0-5][0-9])||(([0-5][0-9]):|)([0-5][0-9])""", [], ["0-4294967295"]),
	"Meta":UcsMoMeta("ProcessorRuntime", "processorRuntime", "cpu-rt", _VersionMeta.Version111j, "OutputOnly", 0x0L, [], [u'processorRuntimeHist'], ["Get"], ["admin", "operations", "read-only"])
}
