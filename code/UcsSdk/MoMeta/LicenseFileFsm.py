...
class LicenseFileFsm(ManagedObject):
	def __init__(self):
		ManagedObject.__init__(self,"LicenseFileFsm")

	@staticmethod
	def ClassId():
		return "licenseFileFsm"
	...
	CONST_CURRENT_FSM_CLEAR = "Clear"
	CONST_CURRENT_FSM_INSTALL = "Install"
