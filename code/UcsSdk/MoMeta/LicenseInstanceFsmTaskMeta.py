...
PROPERTY_DICT = {
	...
	"Item":UcsPropertyMeta("Item", "item", "string", _VersionMeta.Version141i, UcsPropertyMeta.Naming, None, None, None, None, ["UpdateFlexlm", "nop"], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("LicenseInstanceFsmTask", "licenseInstanceFsmTask", "task-[Item]", _VersionMeta.Version141i, "OutputOnly", 0x0L, [], [], [None], [""])
}
