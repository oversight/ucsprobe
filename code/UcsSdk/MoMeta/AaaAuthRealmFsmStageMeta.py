...
PROPERTY_DICT = {
	...
	"Name":UcsPropertyMeta("Name", "name", "string", _VersionMeta.Version211a, UcsPropertyMeta.Naming, None, None, None, None, ["nop", "updateRealmBegin", "updateRealmFail", "updateRealmSetRealmLocal", "updateRealmSetRealmPeer", "updateRealmSuccess"], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("AaaAuthRealmFsmStage", "aaaAuthRealmFsmStage", "stage-[Name]", _VersionMeta.Version211a, "OutputOnly", 0x0L, [], [], [None], [""])
}
