...
PROPERTY_DICT = {
	...
	"IsServiceTemplate":UcsPropertyMeta("IsServiceTemplate", "isServiceTemplate", "string", _VersionMeta.Version221b, UcsPropertyMeta.ReadOnly, None, None, None, None, ["false", "no", "true", "yes"], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("QueryresultUsage", "queryresultUsage", "usage-[RefConvertedDn]", _VersionMeta.Version221b, "InputOutput", 0x1fL, [], [], [None], ["admin"])
}
