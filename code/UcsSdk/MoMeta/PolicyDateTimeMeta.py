...
PROPERTY_DICT = {
	...
	"Source":UcsPropertyMeta("Source", "source", "string", _VersionMeta.Version211a, UcsPropertyMeta.ReadWrite, 0x8L, None, None, None, ["local", "pending-policy", "policy"], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("PolicyDateTime", "policyDateTime", "datetime-ctrl", _VersionMeta.Version211a, "InputOutput", 0x1fL, [], [u'policyControlledInstance', u'policyControlledType'], ["Add", "Get", "Set"], ["admin", "ext-lan-config", "ext-lan-security", "operations"])
}
