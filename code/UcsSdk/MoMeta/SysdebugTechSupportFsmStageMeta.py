...
PROPERTY_DICT = {
	...
	"Name":UcsPropertyMeta("Name", "name", "string", _VersionMeta.Version211a, UcsPropertyMeta.Naming, None, None, None, None, ["DeleteTechSupFileBegin", "DeleteTechSupFileFail", "DeleteTechSupFileLocal", "DeleteTechSupFilePeer", "DeleteTechSupFileSuccess", "DownloadBegin", "DownloadCopyPrimary", "DownloadCopySub", "DownloadDeletePrimary", "DownloadDeleteSub", "DownloadFail", "DownloadSuccess", "InitiateBegin", "InitiateFail", "InitiateLocal", "InitiateSuccess", "nop"], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("SysdebugTechSupportFsmStage", "sysdebugTechSupportFsmStage", "stage-[Name]", _VersionMeta.Version211a, "OutputOnly", 0x0L, [], [], [None], [""])
}
