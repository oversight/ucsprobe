...
PROPERTY_DICT = {
	"AdminSpeed":UcsPropertyMeta("AdminSpeed", "adminSpeed", "string", _VersionMeta.Version202m, UcsPropertyMeta.ReadOnly, None, None, None, None, ["10gbps", "1gbps", "20gbps", "40gbps", "indeterminate"], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("SwEthMonDestEp", "swEthMonDestEp", "mon-dest-[SlotId]-port-[PortId]", _VersionMeta.Version141i, "InputOutput", 0x1ffL, [], [], ["Get"], ["read-only"])
}
