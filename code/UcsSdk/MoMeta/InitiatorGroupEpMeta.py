...
PROPERTY_DICT = {
	...
	"PolName":UcsPropertyMeta("PolName", "polName", "string", _VersionMeta.Version211a, UcsPropertyMeta.ReadOnly, None, None, None, """[\-\.:_a-zA-Z0-9]{0,16}""", [], ["0-4294967295"]),
	"RmtDiskCfgName":UcsPropertyMeta("RmtDiskCfgName", "rmtDiskCfgName", "string", _VersionMeta.Version211a, UcsPropertyMeta.ReadOnly, None, None, None, """[\-\.:_a-zA-Z0-9]{0,16}""", [], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("InitiatorGroupEp", "initiatorGroupEp", "grp-[Name]", _VersionMeta.Version211a, "InputOutput", 0x1fL, [], [u'initiatorFcInitiatorEp', u'initiatorIScsiInitiatorEp', u'initiatorStoreEp', u'storageNodeEp'], [None], ["read-only"])
}
