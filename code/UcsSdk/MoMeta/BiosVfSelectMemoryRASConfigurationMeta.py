...
PROPERTY_DICT = {
	...
	"VpSelectMemoryRASConfiguration":UcsPropertyMeta("VpSelectMemoryRASConfiguration", "vpSelectMemoryRASConfiguration", "string", _VersionMeta.Version111j, UcsPropertyMeta.ReadWrite, 0x10L, None, None, None, ["lockstep", "maximum-performance", "mirroring", "platform-default", "platform-recommended", "sparing"], ["0-4294967295"]),
	"Meta":UcsMoMeta("BiosVfSelectMemoryRASConfiguration", "biosVfSelectMemoryRASConfiguration", "SelectMemory-RAS-configuration", _VersionMeta.Version111j, "InputOutput", 0x1fL, [], [], ["Get", "Set"], ["admin", "ls-compute", "ls-config", "ls-server", "ls-server-policy", "pn-policy"])
}
