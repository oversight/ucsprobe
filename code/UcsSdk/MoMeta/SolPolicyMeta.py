...
PROPERTY_DICT = {
	...
	"Speed":UcsPropertyMeta("Speed", "speed", "string", _VersionMeta.Version101e, UcsPropertyMeta.ReadWrite, 0x80L, None, None, None, ["115200", "19200", "38400", "57600", "9600"], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("SolPolicy", "solPolicy", "sol-[Name]", _VersionMeta.Version101e, "InputOutput", 0x1ffL, [], [], ["Add", "Get", "Remove", "Set"], ["admin", "ls-config-policy"])
}
