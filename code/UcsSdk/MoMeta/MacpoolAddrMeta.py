...
PROPERTY_DICT = {
	...
	"Id":UcsPropertyMeta("Id", "id", "string", _VersionMeta.Version101e, UcsPropertyMeta.Naming, 0x4L, None, None, """(([0-9a-fA-F][0-9a-fA-F]:){5}([0-9a-fA-F][0-9a-fA-F]))|0""", [], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("MacpoolAddr", "macpoolAddr", "[Id]", _VersionMeta.Version101e, "InputOutput", 0x1fL, [], [u'macpoolPoolable'], ["Get"], ["read-only"])
}
