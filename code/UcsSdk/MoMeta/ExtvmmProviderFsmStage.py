...
class ExtvmmProviderFsmStage(ManagedObject):
	def __init__(self):
		ManagedObject.__init__(self,"ExtvmmProviderFsmStage")

	@staticmethod
	def ClassId():
		return "extvmmProviderFsmStage"
	...
	CONST_NAME_CONFIG_GET_VERSION = "configGetVersion"
