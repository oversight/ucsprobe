...
PROPERTY_DICT = {
	...
	"Meta":UcsMoMeta("FabricSanPinTarget", "fabricSanPinTarget", "target-[FabricId]", _VersionMeta.Version101e, "InputOutput", 0x3fL, [], [u'faultInst'], ["Add", "Get", "Remove", "Set"], ["admin", "ext-san-config", "ext-san-policy"])
}
