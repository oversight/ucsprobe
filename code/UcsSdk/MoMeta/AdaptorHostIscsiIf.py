...
class AdaptorHostIscsiIf(ManagedObject):
	def __init__(self):
		ManagedObject.__init__(self,"AdaptorHostIscsiIf")

	@staticmethod
	def ClassId():
		return "adaptorHostIscsiIf"
	...
	CONST_HOST_VISIBLE_NO = "no"
	CONST_HOST_VISIBLE_OS_DEPENDENT = "os-dependent"
	CONST_HOST_VISIBLE_YES = "yes"
