...
PROPERTY_DICT = {
	...
	"Name":UcsPropertyMeta("Name", "name", "string", _VersionMeta.Version211a, UcsPropertyMeta.Naming, None, None, None, None, ["DeployBegin", "DeployFail", "DeployLocal", "DeployPeer", "DeploySuccess", "nop"], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("EpqosDefinitionFsmStage", "epqosDefinitionFsmStage", "stage-[Name]", _VersionMeta.Version211a, "OutputOnly", 0x0L, [], [], [None], [""])
}
