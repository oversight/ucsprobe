...
PROPERTY_DICT = {
	...
	"Message":UcsPropertyMeta("Message", "message", "string", _VersionMeta.Version211a, UcsPropertyMeta.ReadOnly, None, 0, 510, None, [], ["0-4294967295"]),
	...
	"TimeStamp":UcsPropertyMeta("TimeStamp", "timeStamp", "string", _VersionMeta.Version211a, UcsPropertyMeta.ReadOnly, None, None, None, """([0-9]){4}-([0-9]){2}-([0-9]){2}T([0-9]){2}:([0-9]){2}:([0-9]){2}((\.([0-9]){3})){0,1}""", ["never"], ["0-4294967295"]),
	"ValidateStatus":UcsPropertyMeta("ValidateStatus", "validateStatus", "string", _VersionMeta.Version211a, UcsPropertyMeta.ReadOnly, None, None, None, None, ["failed", "in-progress", "skipped", "success", "unknown", "warnings"], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("FirmwareUpgradeInfo", "firmwareUpgradeInfo", "validate-upgrade", _VersionMeta.Version211a, "InputOutput", 0xfL, [], [u'firmwareUpgradeDetail'], ["Get"], ["admin"])
}
