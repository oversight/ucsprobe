...
PROPERTY_DICT = {
	"AdminState":UcsPropertyMeta("AdminState", "adminState", "string", _VersionMeta.Version101e, UcsPropertyMeta.ReadOnly, None, None, None, None, ["completed", "created", "reqCreated", "started", "tpSet"], ["0-4294967295"]),
	"Cert":UcsPropertyMeta("Cert", "cert", "string", _VersionMeta.Version101e, UcsPropertyMeta.ReadWrite, 0x1L, None, None, None, [], ["0-4294967295"]),
	...
	"Key":UcsPropertyMeta("Key", "key", "string", _VersionMeta.Version101e, UcsPropertyMeta.ReadOnly, None, None, None, None, [], ["0-4294967295"]),
	"Modulus":UcsPropertyMeta("Modulus", "modulus", "string", _VersionMeta.Version101e, UcsPropertyMeta.ReadWrite, 0x10L, None, None, None, ["mod1024", "mod1536", "mod2048", "mod2560", "mod3072", "mod3584", "mod4096", "mod512", "modinvalid"], ["0-4294967295"]),
	...
	"Regen":UcsPropertyMeta("Regen", "regen", "string", _VersionMeta.Version101e, UcsPropertyMeta.ReadWrite, 0x80L, None, None, None, ["false", "no", "true", "yes"], ["0-4294967295"]),
	...
	"Tp":UcsPropertyMeta("Tp", "tp", "string", _VersionMeta.Version101e, UcsPropertyMeta.ReadWrite, 0x400L, None, None, """[\-\.:_a-zA-Z0-9]{0,16}""", [], ["0-4294967295"]),
	"Meta":UcsMoMeta("PkiKeyRing", "pkiKeyRing", "keyring-[Name]", _VersionMeta.Version101e, "InputOutput", 0x7ffL, [], [u'faultInst', u'pkiCertReq'], ["Add", "Get", "Remove", "Set"], ["aaa", "admin"])
}
