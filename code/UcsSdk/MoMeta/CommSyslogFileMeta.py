...
PROPERTY_DICT = {
	...
	"Size":UcsPropertyMeta("Size", "size", "uint", _VersionMeta.Version101e, UcsPropertyMeta.ReadWrite, 0x80L, None, None, None, [], ["4096-4194304"]),
	...
	"Meta":UcsMoMeta("CommSyslogFile", "commSyslogFile", "file", _VersionMeta.Version101e, "InputOutput", 0x1ffL, [], [], ["Get", "Set"], ["admin", "operations"])
}
