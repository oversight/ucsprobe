...
PROPERTY_DICT = {
	...
	"Meta":UcsMoMeta("AdaptorMenloQErrorStats", "adaptorMenloQErrorStats", "menlo-q-error-stats-comp-[MenloQueueComponent]index-[MenloQueueIndex]", _VersionMeta.Version111j, "OutputOnly", 0x0L, [], [u'adaptorMenloQErrorStatsHist'], ["Get"], ["admin", "operations", "read-only"])
}
