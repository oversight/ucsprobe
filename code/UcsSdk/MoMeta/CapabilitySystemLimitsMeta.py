...
PROPERTY_DICT = {
	...
	"Meta":UcsMoMeta("CapabilitySystemLimits", "capabilitySystemLimits", "system-limits", _VersionMeta.Version211a, "InputOutput", 0xfL, [], [u'capabilityFeatureLimits'], [None], ["read-only"])
}
