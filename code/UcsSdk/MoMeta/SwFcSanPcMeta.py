...
PROPERTY_DICT = {
	...
	"PortVsanId":UcsPropertyMeta("PortVsanId", "portVsanId", "uint", _VersionMeta.Version141i, UcsPropertyMeta.ReadOnly, None, None, None, None, [], ["1-4093"]),
	...
	"Meta":UcsMoMeta("SwFcSanPc", "swFcSanPc", "pc-[PortId]", _VersionMeta.Version141i, "InputOutput", 0x7fL, [], [], ["Get"], ["read-only"])
}
