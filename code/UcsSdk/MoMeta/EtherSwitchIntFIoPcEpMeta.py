...
PROPERTY_DICT = {
	"AckState":UcsPropertyMeta("AckState", "ackState", "string", _VersionMeta.Version201m, UcsPropertyMeta.ReadOnly, None, None, None, None, ["ack-in-progress", "acknowledged", "auto-ack", "evaluation", "ok", "removing", "un-acknowledged", "un-initialized", "unsupported-connectivity"], ["0-4294967295"]),
	...
	"PortId":UcsPropertyMeta("PortId", "portId", "uint", _VersionMeta.Version201m, UcsPropertyMeta.Naming, 0x10L, None, None, None, [], ["1-8"]),
	"Rn":UcsPropertyMeta("Rn", "rn", "string", _VersionMeta.Version201m, UcsPropertyMeta.ReadOnly, 0x20L, 0, 256, None, [], ["0-4294967295"]),
	"SlotId":UcsPropertyMeta("SlotId", "slotId", "uint", _VersionMeta.Version201m, UcsPropertyMeta.Naming, 0x40L, None, None, None, [], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("EtherSwitchIntFIoPcEp", "etherSwitchIntFIoPcEp", "ep-slot-[SlotId]-port-[PortId]", _VersionMeta.Version201m, "InputOutput", 0xffL, [], [], ["Get"], ["admin", "ext-lan-config", "ext-lan-policy", "pn-equipment", "pn-maintenance"])
}
