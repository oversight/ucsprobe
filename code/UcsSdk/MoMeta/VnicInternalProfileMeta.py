...
PROPERTY_DICT = {
	...
	"MaxPorts":UcsPropertyMeta("MaxPorts", "maxPorts", "ushort", _VersionMeta.Version201m, UcsPropertyMeta.ReadWrite, 0x8L, None, None, None, [], ["1-4096"]),
	"Name":UcsPropertyMeta("Name", "name", "string", _VersionMeta.Version201m, UcsPropertyMeta.Naming, 0x10L, None, None, """[\-\.:_a-zA-Z0-9]{1,31}""", [], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("VnicInternalProfile", "vnicInternalProfile", "vnic-[Name]", _VersionMeta.Version201m, "InputOutput", 0xffL, [], [], ["Get"], ["read-only"])
}
