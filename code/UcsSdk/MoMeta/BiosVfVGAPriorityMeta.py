...
PROPERTY_DICT = {
	...
	"VpVGAPriority":UcsPropertyMeta("VpVGAPriority", "vpVGAPriority", "string", _VersionMeta.Version222c, UcsPropertyMeta.ReadWrite, 0x10L, None, None, None, ["offboard", "onboard", "onboard-vga-disabled", "platform-default", "platform-recommended"], ["0-4294967295"]),
	"Meta":UcsMoMeta("BiosVfVGAPriority", "biosVfVGAPriority", "VGA-Priority", _VersionMeta.Version222c, "InputOutput", 0x1fL, [], [], [None], ["admin", "ls-compute", "ls-config", "ls-server", "ls-server-policy", "pn-policy"])
}
