...
PROPERTY_DICT = {
	...
	"MenloEthIndex":UcsPropertyMeta("MenloEthIndex", "menloEthIndex", "string", _VersionMeta.Version111j, UcsPropertyMeta.Naming, None, None, None, None, ["0", "0_A", "0_B", "1", "1_A", "1_B", "unknown"], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("AdaptorMenloEthErrorStats", "adaptorMenloEthErrorStats", "menlo-eth-error-stats-[MenloEthIndex]", _VersionMeta.Version111j, "OutputOnly", 0x0L, [], [u'adaptorMenloEthErrorStatsHist'], ["Get"], ["admin", "operations", "read-only"])
}
