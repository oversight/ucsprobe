...
PROPERTY_DICT = {
	...
	"Meta":UcsMoMeta("FirmwareBundleTypeCapProvider", "firmwareBundleTypeCapProvider", "bundle-type-cap", _VersionMeta.Version141i, "InputOutput", 0xfL, [], [u'firmwareBundleType'], ["Get"], [""])
}
