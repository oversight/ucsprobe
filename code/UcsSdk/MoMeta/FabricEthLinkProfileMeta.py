...
PROPERTY_DICT = {
	"CdpLinkPolicyName":UcsPropertyMeta("CdpLinkPolicyName", "cdpLinkPolicyName", "string", _VersionMeta.Version221b, UcsPropertyMeta.ReadWrite, 0x1L, None, None, """[\-\.:_a-zA-Z0-9]{0,16}""", [], ["0-4294967295"]),
	...
	"OperCdpLinkPolicyName":UcsPropertyMeta("OperCdpLinkPolicyName", "operCdpLinkPolicyName", "string", _VersionMeta.Version221b, UcsPropertyMeta.ReadOnly, None, 0, 256, None, [], ["0-4294967295"]),
	"OperUdldLinkPolicyName":UcsPropertyMeta("OperUdldLinkPolicyName", "operUdldLinkPolicyName", "string", _VersionMeta.Version221b, UcsPropertyMeta.ReadOnly, None, 0, 256, None, [], ["0-4294967295"]),
	...
	"UdldLinkPolicyName":UcsPropertyMeta("UdldLinkPolicyName", "udldLinkPolicyName", "string", _VersionMeta.Version221b, UcsPropertyMeta.ReadWrite, 0x100L, None, None, """[\-\.:_a-zA-Z0-9]{0,16}""", [], ["0-4294967295"]),
	"Meta":UcsMoMeta("FabricEthLinkProfile", "fabricEthLinkProfile", "eth-link-prof-[Name]", _VersionMeta.Version221b, "InputOutput", 0x1ffL, [], [u'faultInst'], ["Add", "Get", "Remove", "Set"], ["admin", "ext-lan-config", "ext-lan-policy"])
}
