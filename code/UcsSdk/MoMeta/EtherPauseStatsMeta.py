...
PROPERTY_DICT = {
	...
	"Meta":UcsMoMeta("EtherPauseStats", "etherPauseStats", "pause-stats", _VersionMeta.Version111j, "OutputOnly", 0x0L, [], [u'etherPauseStatsHist'], ["Get"], ["admin", "operations", "read-only"])
}
