...
PROPERTY_DICT = {
	...
	"Speed":UcsPropertyMeta("Speed", "speed", "uint", _VersionMeta.Version141i, UcsPropertyMeta.ReadOnly, None, None, None, None, [], ["0-4294967295"]),
	"SpeedAvg":UcsPropertyMeta("SpeedAvg", "speedAvg", "uint", _VersionMeta.Version141i, UcsPropertyMeta.ReadOnly, None, None, None, None, [], ["0-4294967295"]),
	"SpeedMax":UcsPropertyMeta("SpeedMax", "speedMax", "uint", _VersionMeta.Version141i, UcsPropertyMeta.ReadOnly, None, None, None, None, [], ["0-4294967295"]),
	"SpeedMin":UcsPropertyMeta("SpeedMin", "speedMin", "uint", _VersionMeta.Version141i, UcsPropertyMeta.ReadOnly, None, None, None, None, [], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("EquipmentRackUnitFanStats", "equipmentRackUnitFanStats", "stats", _VersionMeta.Version141i, "OutputOnly", 0x0L, [], [u'equipmentRackUnitFanStatsHist'], ["Get"], ["admin", "operations", "read-only"])
}
