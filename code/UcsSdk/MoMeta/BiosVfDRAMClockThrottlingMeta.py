...
PROPERTY_DICT = {
	...
	"VpDRAMClockThrottling":UcsPropertyMeta("VpDRAMClockThrottling", "vpDRAMClockThrottling", "string", _VersionMeta.Version222c, UcsPropertyMeta.ReadWrite, 0x10L, None, None, None, ["auto", "balanced", "energy-efficient", "performance", "platform-default", "platform-recommended"], ["0-4294967295"]),
	"Meta":UcsMoMeta("BiosVfDRAMClockThrottling", "biosVfDRAMClockThrottling", "DRAM-Clock-Throttling", _VersionMeta.Version222c, "InputOutput", 0x1fL, [], [], [None], ["admin", "ls-compute", "ls-config", "ls-server", "ls-server-policy", "pn-policy"])
}
