...
PROPERTY_DICT = {
	...
	"Generation":UcsPropertyMeta("Generation", "generation", "uint", _VersionMeta.Version211a, UcsPropertyMeta.ReadOnly, None, None, None, None, [], ["0-4294967295"]),
	"IsSync":UcsPropertyMeta("IsSync", "isSync", "string", _VersionMeta.Version211a, UcsPropertyMeta.ReadOnly, None, None, None, None, ["false", "no", "true", "yes"], ["0-4294967295"]),
	"IsSyncAllowed":UcsPropertyMeta("IsSyncAllowed", "isSyncAllowed", "string", _VersionMeta.Version211a, UcsPropertyMeta.ReadWrite, 0x4L, None, None, None, ["false", "no", "true", "yes"], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("IdentSysInfo", "identSysInfo", "", _VersionMeta.Version211a, "InputOutput", 0x1fL, [], [], [None], ["read-only"])
}
