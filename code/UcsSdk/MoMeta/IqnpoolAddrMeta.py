...
PROPERTY_DICT = {
	...
	"Owner":UcsPropertyMeta("Owner", "owner", "string", _VersionMeta.Version201m, UcsPropertyMeta.ReadOnly, None, None, None, None, ["end-point", "pool"], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("IqnpoolAddr", "iqnpoolAddr", "[Name]", _VersionMeta.Version201m, "InputOutput", 0x1fL, [], [u'iqnpoolPoolable'], ["Get"], ["read-only"])
}
