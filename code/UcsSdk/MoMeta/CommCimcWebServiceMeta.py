...
PROPERTY_DICT = {
	...
	"Name":UcsPropertyMeta("Name", "name", "string", _VersionMeta.Version221b, UcsPropertyMeta.CreateOnly, 0x10L, None, None, """[\-\.:_a-zA-Z0-9]{0,16}""", [], ["0-4294967295"]),
	"OperPort":UcsPropertyMeta("OperPort", "operPort", "uint", _VersionMeta.Version221b, UcsPropertyMeta.ReadOnly, None, None, None, None, [], ["0-65535"]),
	...
	"Port":UcsPropertyMeta("Port", "port", "uint", _VersionMeta.Version221b, UcsPropertyMeta.ReadWrite, 0x40L, None, None, None, [], ["0-65535"]),
	"Proto":UcsPropertyMeta("Proto", "proto", "string", _VersionMeta.Version221b, UcsPropertyMeta.ReadOnly, None, None, None, None, ["all", "none", "tcp", "udp"], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("CommCimcWebService", "commCimcWebService", "cimc-web-svc", _VersionMeta.Version221b, "InputOutput", 0x1ffL, [], [], [None], ["aaa", "admin"])
}
