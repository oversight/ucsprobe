...
PROPERTY_DICT = {
	...
	"ImgLoc":UcsPropertyMeta("ImgLoc", "imgLoc", "string", _VersionMeta.Version202m, UcsPropertyMeta.ReadOnly, None, None, None, None, [], ["0-4294967295"]),
	"ImgName":UcsPropertyMeta("ImgName", "imgName", "string", _VersionMeta.Version202m, UcsPropertyMeta.ReadOnly, None, None, None, None, [], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("ComputePnuOSImage", "computePnuOSImage", "pnuos", _VersionMeta.Version202m, "InputOutput", 0xfL, [], [], ["Get"], ["read-only"])
}
