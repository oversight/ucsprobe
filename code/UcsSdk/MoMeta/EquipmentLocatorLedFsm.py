...
class EquipmentLocatorLedFsm(ManagedObject):
	def __init__(self):
		ManagedObject.__init__(self,"EquipmentLocatorLedFsm")

	@staticmethod
	def ClassId():
		return "equipmentLocatorLedFsm"
	...
	CONST_CURRENT_FSM_SET_FE_LOCATOR_LED = "SetFeLocatorLed"
	CONST_CURRENT_FSM_SET_FI_LOCATOR_LED = "SetFiLocatorLed"
	CONST_CURRENT_FSM_SET_LOCATOR_LED = "SetLocatorLed"
