...
PROPERTY_DICT = {
	"AdminSpeed":UcsPropertyMeta("AdminSpeed", "adminSpeed", "string", _VersionMeta.Version141i, UcsPropertyMeta.ReadOnly, None, None, None, None, ["10gbps", "1gbps", "20gbps", "40gbps", "indeterminate"], ["0-4294967295"]),
	...
	"BorderPortId":UcsPropertyMeta("BorderPortId", "borderPortId", "uint", _VersionMeta.Version141i, UcsPropertyMeta.ReadWrite, 0x2L, None, None, None, [], ["0-4294967295"]),
	"BorderSlotId":UcsPropertyMeta("BorderSlotId", "borderSlotId", "uint", _VersionMeta.Version141i, UcsPropertyMeta.ReadWrite, 0x4L, None, None, None, [], ["0-4294967295"]),
	...
	"LacpFastTimer":UcsPropertyMeta("LacpFastTimer", "lacpFastTimer", "string", _VersionMeta.Version222c, UcsPropertyMeta.ReadOnly, None, None, None, None, ["false", "no", "true", "yes"], ["0-4294967295"]),
	"LacpSuspendIndividual":UcsPropertyMeta("LacpSuspendIndividual", "lacpSuspendIndividual", "string", _VersionMeta.Version222c, UcsPropertyMeta.ReadOnly, None, None, None, None, ["false", "no", "true", "yes"], ["0-4294967295"]),
	...
	"PortId":UcsPropertyMeta("PortId", "portId", "uint", _VersionMeta.Version141i, UcsPropertyMeta.Naming, 0x40L, None, None, None, [], ["0-4294967295"]),
	"PortMode":UcsPropertyMeta("PortMode", "portMode", "string", _VersionMeta.Version141i, UcsPropertyMeta.ReadWrite, 0x80L, None, None, None, ["access", "trunk"], ["0-4294967295"]),
	...
	"Protocol":UcsPropertyMeta("Protocol", "protocol", "string", _VersionMeta.Version142b, UcsPropertyMeta.ReadOnly, None, None, None, None, ["lacp", "static"], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("SwEthEstcPc", "swEthEstcPc", "pc-[PortId]", _VersionMeta.Version141i, "InputOutput", 0x3ffL, [], [u'swEthTargetEp', u'swVlan'], ["Get"], ["read-only"])
}
