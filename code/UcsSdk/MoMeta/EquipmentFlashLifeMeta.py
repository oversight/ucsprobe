...
PROPERTY_DICT = {
	"CardParamType":UcsPropertyMeta("CardParamType", "cardParamType", "uint", _VersionMeta.Version222c, UcsPropertyMeta.Naming, 0x1L, None, None, None, [], ["0-4294967295"]),
	...
	"SuportType":UcsPropertyMeta("SuportType", "suportType", "uint", _VersionMeta.Version222c, UcsPropertyMeta.Naming, 0x100L, None, None, None, [], ["0-4294967295"]),
	"Meta":UcsMoMeta("EquipmentFlashLife", "equipmentFlashLife", "[SuportType][CardParamType]", _VersionMeta.Version222c, "InputOutput", 0x1ffL, [], [], [None], [""])
}
