...
PROPERTY_DICT = {
	...
	"Meta":UcsMoMeta("VnicDynamicIdUniverse", "vnicDynamicIdUniverse", "dynamic-id-universe-[Name]", _VersionMeta.Version101e, "InputOutput", 0x7fL, [], [], ["Get"], ["admin", "ls-network", "ls-network-policy"])
}
