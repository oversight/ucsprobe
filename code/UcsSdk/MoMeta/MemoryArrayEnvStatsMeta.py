...
PROPERTY_DICT = {
	...
	"Meta":UcsMoMeta("MemoryArrayEnvStats", "memoryArrayEnvStats", "array-env-stats", _VersionMeta.Version111j, "OutputOnly", 0x0L, [], [u'memoryArrayEnvStatsHist'], ["Get"], ["admin", "operations", "read-only"])
}
