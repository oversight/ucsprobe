...
PROPERTY_DICT = {
	...
	"Meta":UcsMoMeta("EquipmentChassisStats", "equipmentChassisStats", "stats", _VersionMeta.Version111j, "OutputOnly", 0x0L, [], [u'equipmentChassisStatsHist'], ["Get"], ["admin", "operations", "read-only"])
}
