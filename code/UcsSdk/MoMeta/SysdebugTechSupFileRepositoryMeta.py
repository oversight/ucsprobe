...
PROPERTY_DICT = {
	...
	"Meta":UcsMoMeta("SysdebugTechSupFileRepository", "sysdebugTechSupFileRepository", "tech-support-files", _VersionMeta.Version141i, "InputOutput", 0xfL, [], [u'sysdebugTechSupport'], ["Get"], ["admin", "operations"])
}
