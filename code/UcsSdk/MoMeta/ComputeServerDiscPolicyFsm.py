...
class ComputeServerDiscPolicyFsm(ManagedObject):
	def __init__(self):
		ManagedObject.__init__(self,"ComputeServerDiscPolicyFsm")

	@staticmethod
	def ClassId():
		return "computeServerDiscPolicyFsm"
	...
	CONST_CURRENT_FSM_RESOLVE_SCRUB_POLICY = "ResolveScrubPolicy"
