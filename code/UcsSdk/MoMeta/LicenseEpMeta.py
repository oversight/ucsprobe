...
PROPERTY_DICT = {
	...
	"Meta":UcsMoMeta("LicenseEp", "licenseEp", "license", _VersionMeta.Version141i, "InputOutput", 0xfL, [], [u'licenseDownloader', u'licenseFeature', u'licenseFile', u'licenseServerHostId'], ["Get"], ["admin"])
}
