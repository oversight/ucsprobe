...
PROPERTY_DICT = {
	...
	"VpFrequencyFloorOverride":UcsPropertyMeta("VpFrequencyFloorOverride", "vpFrequencyFloorOverride", "string", _VersionMeta.Version222c, UcsPropertyMeta.ReadWrite, 0x10L, None, None, None, ["disabled", "enabled", "platform-default", "platform-recommended"], ["0-4294967295"]),
	"Meta":UcsMoMeta("BiosVfFrequencyFloorOverride", "biosVfFrequencyFloorOverride", "Frequency-Floor-Override", _VersionMeta.Version222c, "InputOutput", 0x1fL, [], [], [None], ["admin", "ls-compute", "ls-config", "ls-server", "ls-server-policy", "pn-policy"])
}
