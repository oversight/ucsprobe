...
PROPERTY_DICT = {
	...
	"IsSupported":UcsPropertyMeta("IsSupported", "isSupported", "string", _VersionMeta.Version222c, UcsPropertyMeta.Naming, 0x8L, None, None, None, ["false", "no", "true", "yes"], ["0-4294967295"]),
	"MinBiosVersion":UcsPropertyMeta("MinBiosVersion", "minBiosVersion", "string", _VersionMeta.Version222c, UcsPropertyMeta.ReadOnly, None, 0, 510, None, [], ["0-4294967295"]),
	"MinCimcVersion":UcsPropertyMeta("MinCimcVersion", "minCimcVersion", "string", _VersionMeta.Version222c, UcsPropertyMeta.ReadOnly, None, 0, 510, None, [], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("EquipmentCimcVmedia", "equipmentCimcVmedia", "cimcvmediasupp-[IsSupported]", _VersionMeta.Version222c, "InputOutput", 0xffL, [], [], [None], [""])
}
