...
class EquipmentChassisFsm(ManagedObject):
	def __init__(self):
		ManagedObject.__init__(self,"EquipmentChassisFsm")

	@staticmethod
	def ClassId():
		return "equipmentChassisFsm"
	...
	CONST_CURRENT_FSM_DYNAMIC_REALLOCATION = "DynamicReallocation"
	CONST_CURRENT_FSM_POWER_CAP = "PowerCap"
	CONST_CURRENT_FSM_PSU_POLICY_CONFIG = "PsuPolicyConfig"
	CONST_CURRENT_FSM_REMOVE_CHASSIS = "RemoveChassis"
