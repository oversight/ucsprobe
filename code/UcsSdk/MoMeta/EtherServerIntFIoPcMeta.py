...
PROPERTY_DICT = {
	...
	"Meta":UcsMoMeta("EtherServerIntFIoPc", "etherServerIntFIoPc", "pc-[PortId]", _VersionMeta.Version201m, "InputOutput", 0x3fL, [], [u'etherServerIntFIoPcEp'], ["Get"], ["admin", "ext-lan-config", "ext-lan-policy", "pn-equipment", "pn-maintenance"])
}
