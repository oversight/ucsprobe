...
PROPERTY_DICT = {
	...
	"Index":UcsPropertyMeta("Index", "index", "uint", _VersionMeta.Version101e, UcsPropertyMeta.Naming, 0x4L, None, None, None, [], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("ApeControllerChassis", "apeControllerChassis", "Chassis-[Index]", _VersionMeta.Version101e, "InputOutput", 0x1fL, [], [u'apeControllerEeprom'], [None], ["read-only"])
}
