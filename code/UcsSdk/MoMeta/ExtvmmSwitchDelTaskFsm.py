...
class ExtvmmSwitchDelTaskFsm(ManagedObject):
	def __init__(self):
		ManagedObject.__init__(self,"ExtvmmSwitchDelTaskFsm")

	@staticmethod
	def ClassId():
		return "extvmmSwitchDelTaskFsm"
	...
	CONST_CURRENT_FSM_REMOVE_PROVIDER = "removeProvider"
