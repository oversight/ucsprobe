...
class PolicyControlEp(ManagedObject):
	def __init__(self):
		ManagedObject.__init__(self,"PolicyControlEp")

	@staticmethod
	def ClassId():
		return "policyControlEp"
	...
	CONST_ACK_STATE_ACKED = "acked"
	CONST_ACK_STATE_NO_ACK = "no-ack"
	CONST_CLEANUP_MODE_DEEP_REMOVE_GLOBAL = "deep-remove-global"
	CONST_CLEANUP_MODE_LOCALIZE_GLOBAL = "localize-global"
	CONST_FSM_PREV_OPERATE_BEGIN = "OperateBegin"
	CONST_FSM_PREV_OPERATE_FAIL = "OperateFail"
	CONST_FSM_PREV_OPERATE_RESOLVE = "OperateResolve"
	CONST_FSM_PREV_OPERATE_SUCCESS = "OperateSuccess"
	...
	CONST_FSM_STATUS_OPERATE_BEGIN = "OperateBegin"
	CONST_FSM_STATUS_OPERATE_FAIL = "OperateFail"
	CONST_FSM_STATUS_OPERATE_RESOLVE = "OperateResolve"
	CONST_FSM_STATUS_OPERATE_SUCCESS = "OperateSuccess"
	CONST_FSM_STATUS_NOP = "nop"
	CONST_REGISTRATION_STATE_FAILED = "failed"
	CONST_REGISTRATION_STATE_LOST_VISIBILITY = "lost-visibility"
	CONST_REGISTRATION_STATE_REGISTERED = "registered"
	CONST_REGISTRATION_STATE_REGISTERING = "registering"
	CONST_REGISTRATION_STATE_UNREGISTERED = "unregistered"
	CONST_REPAIR_STATE_DONE = "done"
	CONST_REPAIR_STATE_NOT_DONE = "not-done"
	CONST_STATE_OK = "ok"
	CONST_STATE_OUT_OF_SYNC = "out-of-sync"
