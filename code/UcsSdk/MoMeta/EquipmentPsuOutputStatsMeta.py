...
PROPERTY_DICT = {
	...
	"OutputStatus":UcsPropertyMeta("OutputStatus", "outputStatus", "string", _VersionMeta.Version201m, UcsPropertyMeta.ReadOnly, None, 0, 510, None, [], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("EquipmentPsuOutputStats", "equipmentPsuOutputStats", "output-stats", _VersionMeta.Version201m, "OutputOnly", 0x0L, [], [u'equipmentPsuOutputStatsHist'], ["Get"], ["admin", "operations", "read-only"])
}
