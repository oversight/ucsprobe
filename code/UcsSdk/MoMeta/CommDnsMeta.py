...
PROPERTY_DICT = {
	...
	"Domain":UcsPropertyMeta("Domain", "domain", "string", _VersionMeta.Version101e, UcsPropertyMeta.ReadWrite, 0x10L, None, None, None, [], ["0-4294967295"]),
	...
	"Name":UcsPropertyMeta("Name", "name", "string", _VersionMeta.Version101e, UcsPropertyMeta.CreateOnly, 0x20L, None, None, """[\-\.:_a-zA-Z0-9]{0,16}""", [], ["0-4294967295"]),
	...
	"Port":UcsPropertyMeta("Port", "port", "uint", _VersionMeta.Version101e, UcsPropertyMeta.ReadWrite, 0x80L, None, None, None, [], ["0-65535"]),
	...
	"Meta":UcsMoMeta("CommDns", "commDns", "dns-svc", _VersionMeta.Version101e, "InputOutput", 0x3ffL, [], [u'commDnsProvider'], ["Get", "Set"], ["aaa", "admin", "ext-lan-config"])
}
