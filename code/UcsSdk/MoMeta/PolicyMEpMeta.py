...
PROPERTY_DICT = {
	...
	"Meta":UcsMoMeta("PolicyMEp", "policyMEp", "mep-ctrl", _VersionMeta.Version211a, "InputOutput", 0x1fL, [], [u'policyControlledInstance', u'policyControlledType'], ["Add", "Get", "Set"], ["admin", "operations"])
}
