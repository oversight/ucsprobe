...
class CommSvcEpFsm(ManagedObject):
	def __init__(self):
		ManagedObject.__init__(self,"CommSvcEpFsm")
	...
	CONST_CURRENT_FSM_RESTART_WEB_SVC = "restartWebSvc"
	CONST_CURRENT_FSM_UPDATE_SVC_EP = "updateSvcEp"
