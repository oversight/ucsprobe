...
PROPERTY_DICT = {
	...
	"Meta":UcsMoMeta("LsbootLocalStorage", "lsbootLocalStorage", "local-storage", _VersionMeta.Version101e, "InputOutput", 0xfL, [], [u'lsbootDefaultLocalImage', u'lsbootLocalHddImage', u'lsbootUsbExternalImage', u'lsbootUsbFlashStorageImage', u'lsbootUsbInternalImage'], ["Add", "Get", "Remove"], ["admin", "ls-compute", "ls-config", "ls-config-policy", "ls-server", "ls-server-policy", "ls-storage", "ls-storage-policy"])
}
