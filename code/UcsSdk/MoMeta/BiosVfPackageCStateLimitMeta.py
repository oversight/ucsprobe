...
PROPERTY_DICT = {
	...
	"VpPackageCStateLimit":UcsPropertyMeta("VpPackageCStateLimit", "vpPackageCStateLimit", "string", _VersionMeta.Version202m, UcsPropertyMeta.ReadWrite, 0x10L, None, None, None, ["c0", "c1", "c3", "c6", "no-limit", "platform-default", "platform-recommended"], ["0-4294967295"]),
	"Meta":UcsMoMeta("BiosVfPackageCStateLimit", "biosVfPackageCStateLimit", "Package-C-State-Limit", _VersionMeta.Version202m, "InputOutput", 0x1fL, [], [], ["Get", "Set"], ["admin", "ls-compute", "ls-config", "ls-server", "ls-server-policy", "pn-policy"])
}
