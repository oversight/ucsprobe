...
PROPERTY_DICT = {
	...
	"Vendor":UcsPropertyMeta("Vendor", "vendor", "string", _VersionMeta.Version101e, UcsPropertyMeta.Naming, 0x20L, 1, 510, None, [], ["0-4294967295"]),
	"Version":UcsPropertyMeta("Version", "version", "string", _VersionMeta.Version101e, UcsPropertyMeta.Naming, 0x40L, 1, 510, None, [], ["0-4294967295"]),
	"Meta":UcsMoMeta("AdaptorFwCapProvider", "adaptorFwCapProvider", "fw-vendor-[Vendor]-model-[Model]-version-[Version]", _VersionMeta.Version101e, "InputOutput", 0x7fL, [], [], ["Get"], [""])
}
