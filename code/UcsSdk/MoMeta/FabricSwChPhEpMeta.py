...
PROPERTY_DICT = {
	...
	"ChassisId":UcsPropertyMeta("ChassisId", "chassisId", "string", _VersionMeta.Version101e, UcsPropertyMeta.ReadWrite, 0x2L, None, None, None, ["N/A"], ["1-40"]),
	...
	"Lc":UcsPropertyMeta("Lc", "lc", "string", _VersionMeta.Version101e, UcsPropertyMeta.ReadOnly, None, None, None, None, ["in-service", "out-of-service", "out-of-service-slave"], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("FabricSwChPhEp", "fabricSwChPhEp", "chassis-ep-ven-[Vendor]-mod[Model]-ser-[Serial]", _VersionMeta.Version101e, "InputOutput", 0x3ffL, [], [u'faultInst'], ["Get", "Set"], ["admin", "pn-equipment", "pn-maintenance", "pn-policy"])
}
