...
PROPERTY_DICT = {
	...
	"ConPolicyName":UcsPropertyMeta("ConPolicyName", "conPolicyName", "string", _VersionMeta.Version221b, UcsPropertyMeta.ReadWrite, 0x2L, None, None, """[\-\.:_a-zA-Z0-9]{0,16}""", [], ["0-4294967295"]),
	"Dn":UcsPropertyMeta("Dn", "dn", "string", _VersionMeta.Version221b, UcsPropertyMeta.ReadOnly, 0x4L, 0, 256, None, [], ["0-4294967295"]),
	"OperConPolicyName":UcsPropertyMeta("OperConPolicyName", "operConPolicyName", "string", _VersionMeta.Version221b, UcsPropertyMeta.ReadOnly, None, 0, 256, None, [], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("VnicUsnicConPolicyRef", "vnicUsnicConPolicyRef", "usnic-con-ref", _VersionMeta.Version221b, "InputOutput", 0x1fL, [], [u'faultInst'], ["Add", "Get", "Remove"], ["admin", "ls-compute", "ls-config", "ls-network", "ls-server"])
}
