...
PROPERTY_DICT = {
	...
	"GracePeriod":UcsPropertyMeta("GracePeriod", "gracePeriod", "ulong", _VersionMeta.Version141i, UcsPropertyMeta.ReadOnly, None, None, None, None, [], ["0-4294967295"]),
	...
	"Name":UcsPropertyMeta("Name", "name", "string", _VersionMeta.Version141i, UcsPropertyMeta.Naming, 0x8L, None, None, """[\-\.:_a-zA-Z0-9]{1,64}""", [], ["0-4294967295"]),
	...
	"Type":UcsPropertyMeta("Type", "type", "string", _VersionMeta.Version141i, UcsPropertyMeta.ReadOnly, None, None, None, None, ["boolean", "counted"], ["0-4294967295"]),
	"Vendor":UcsPropertyMeta("Vendor", "vendor", "string", _VersionMeta.Version141i, UcsPropertyMeta.Naming, 0x80L, None, None, None, [], ["0-4294967295"]),
	"Version":UcsPropertyMeta("Version", "version", "string", _VersionMeta.Version141i, UcsPropertyMeta.Naming, 0x100L, 1, 510, None, [], ["0-4294967295"]),
	"Meta":UcsMoMeta("LicenseFeature", "licenseFeature", "feature-[Name]-[Vendor]-[Version]", _VersionMeta.Version141i, "InputOutput", 0x1ffL, [], [u'licenseInstance'], ["Get"], ["admin"])
}
