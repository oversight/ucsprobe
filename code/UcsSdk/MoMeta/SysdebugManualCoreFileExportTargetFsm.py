...
class SysdebugManualCoreFileExportTargetFsm(ManagedObject):
	def __init__(self):
		ManagedObject.__init__(self,"SysdebugManualCoreFileExportTargetFsm")

	@staticmethod
	def ClassId():
		return "sysdebugManualCoreFileExportTargetFsm"
	...
	CONST_CURRENT_FSM_EXPORT = "Export"
