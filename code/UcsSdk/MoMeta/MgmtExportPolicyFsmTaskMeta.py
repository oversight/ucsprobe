...
PROPERTY_DICT = {
	...
	"Item":UcsPropertyMeta("Item", "item", "string", _VersionMeta.Version211a, UcsPropertyMeta.Naming, None, None, None, None, ["ReportConfigCopy", "nop"], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("MgmtExportPolicyFsmTask", "mgmtExportPolicyFsmTask", "task-[Item]", _VersionMeta.Version211a, "OutputOnly", 0x0L, [], [], [None], [""])
}
