...
class CapabilityCatalogueFsm(ManagedObject):
	def __init__(self):
		ManagedObject.__init__(self,"CapabilityCatalogueFsm")

	@staticmethod
	def ClassId():
		return "capabilityCatalogueFsm"
	...
	CONST_CURRENT_FSM_ACTIVATE_CATALOG = "ActivateCatalog"
	CONST_CURRENT_FSM_DEPLOY_CATALOGUE = "DeployCatalogue"
