...
PROPERTY_DICT = {
	...
	"Meta":UcsMoMeta("StorageConnectionPolicy", "storageConnectionPolicy", "storage-connpolicy-[Name]", _VersionMeta.Version211a, "InputOutput", 0xffL, [], [u'faultInst', u'storageFcTargetEp'], ["Add", "Get", "Remove", "Set"], ["admin", "ext-san-config", "ext-san-policy", "ls-storage", "ls-storage-policy"])
}
