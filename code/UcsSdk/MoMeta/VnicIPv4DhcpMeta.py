...
PROPERTY_DICT = {
	...
	"Meta":UcsMoMeta("VnicIPv4Dhcp", "vnicIPv4Dhcp", "ipv4-dhcp", _VersionMeta.Version101e, "InputOutput", 0xfL, [], [], ["Add", "Get", "Remove"], ["admin", "ls-compute", "ls-config", "ls-network", "ls-server", "ls-storage"])
}
