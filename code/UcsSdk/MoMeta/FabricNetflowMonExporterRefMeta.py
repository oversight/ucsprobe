...
PROPERTY_DICT = {
	...
	"Index":UcsPropertyMeta("Index", "index", "uint", _VersionMeta.Version221b, UcsPropertyMeta.ReadWrite, 0x4L, None, None, None, [], ["0-2"]),
	"NfMonExporterName":UcsPropertyMeta("NfMonExporterName", "nfMonExporterName", "string", _VersionMeta.Version221b, UcsPropertyMeta.Naming, 0x8L, None, None, """[\-\.:_a-zA-Z0-9]{1,16}""", [], ["0-4294967295"]),
	"OperNfMonExporterName":UcsPropertyMeta("OperNfMonExporterName", "operNfMonExporterName", "string", _VersionMeta.Version221b, UcsPropertyMeta.ReadOnly, None, 0, 256, None, [], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("FabricNetflowMonExporterRef", "fabricNetflowMonExporterRef", "flow-exporter-[NfMonExporterName]", _VersionMeta.Version221b, "InputOutput", 0x3fL, [], [u'faultInst'], [None], ["admin", "ext-lan-config", "ext-lan-policy"])
}
