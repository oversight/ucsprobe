...
PROPERTY_DICT = {
	...
	"OperVersion":UcsPropertyMeta("OperVersion", "operVersion", "string", _VersionMeta.Version211a, UcsPropertyMeta.ReadOnly, None, 0, 510, None, [], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("FirmwareInfra", "firmwareInfra", "fw-infra", _VersionMeta.Version211a, "InputOutput", 0x3ffL, [], [u'faultInst', u'trigLocalSched'], ["Get"], ["admin"])
}
