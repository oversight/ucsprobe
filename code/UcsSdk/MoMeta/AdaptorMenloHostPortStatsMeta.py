...
PROPERTY_DICT = {
	...
	"Meta":UcsMoMeta("AdaptorMenloHostPortStats", "adaptorMenloHostPortStats", "menlo-host-port-stats-[MenloPortIndex]", _VersionMeta.Version111j, "OutputOnly", 0x0L, [], [u'adaptorMenloHostPortStatsHist'], ["Get"], ["admin", "operations", "read-only"])
}
