...
PROPERTY_DICT = {
	...
	"Meta":UcsMoMeta("PolicySecurity", "policySecurity", "security-ctrl", _VersionMeta.Version211a, "InputOutput", 0x1fL, [], [u'policyControlledInstance', u'policyControlledType'], ["Add", "Get", "Set"], ["aaa", "admin"])
}
