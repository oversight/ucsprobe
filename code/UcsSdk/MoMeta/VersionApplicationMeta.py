...
PROPERTY_DICT = {
	...
	"Detail":UcsPropertyMeta("Detail", "detail", "string", _VersionMeta.Version211a, UcsPropertyMeta.ReadOnly, None, 0, 510, None, [], ["0-4294967295"]),
	...
	"Time":UcsPropertyMeta("Time", "time", "string", _VersionMeta.Version211a, UcsPropertyMeta.ReadOnly, None, 0, 510, None, [], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("VersionApplication", "versionApplication", "application", _VersionMeta.Version211a, "InputOutput", 0xfL, [], [], [None], ["read-only"])
}
