...
PROPERTY_DICT = {
	...
	"Item":UcsPropertyMeta("Item", "item", "string", _VersionMeta.Version141i, UcsPropertyMeta.Naming, None, None, None, None, ["ActivateAdaptor", "ActivateBIOS", "Associate", "BiosRecovery", "CimcSessionDelete", "CmosReset", "ConfigBoard", "ConfigSoL", "Decommission", "DiagnosticInterrupt", "Disassociate", "FlashController", "FwUpgrade", "HardShutdown", "Hardreset", "PowerCap", "Powercycle", "ResetBmc", "ResetIpmi", "ResetKvm", "ResetMemoryErrors", "ServiceInfraDeploy", "ServiceInfraWithdraw", "SoftShutdown", "Softreset", "SwConnUpd", "Turnup", "UnconfigSoL", "UpdateAdaptor", "UpdateBIOS", "UpdateBoardController", "nop", "updateExtUsers"], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("ComputePhysicalFsmTask", "computePhysicalFsmTask", "task-[Item]", _VersionMeta.Version141i, "OutputOnly", 0x0L, [], [], [None], [""])
}
