...
PROPERTY_DICT = {
	...
	"PortId":UcsPropertyMeta("PortId", "portId", "uint", _VersionMeta.Version141i, UcsPropertyMeta.Naming, 0x20L, None, None, None, [], ["1-256"]),
	...
	"SwitchId":UcsPropertyMeta("SwitchId", "switchId", "string", _VersionMeta.Version141i, UcsPropertyMeta.Naming, 0x100L, None, None, None, ["A", "B", "NONE"], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("FabricFcVsanPc", "fabricFcVsanPc", "pc-switch-[SwitchId]-pc-[PortId]", _VersionMeta.Version141i, "InputOutput", 0x1ffL, [], [u'faultInst'], ["Add", "Get", "Remove", "Set"], ["admin", "ext-san-config", "ext-san-policy"])
}
