...
PROPERTY_DICT = {
	...
	"Meta":UcsMoMeta("PolicyCommunication", "policyCommunication", "comm-ctrl", _VersionMeta.Version211a, "InputOutput", 0x1fL, [], [u'policyControlledInstance', u'policyControlledType'], ["Add", "Get", "Set"], ["aaa", "admin"])
}
