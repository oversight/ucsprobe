...
PROPERTY_DICT = {
	...
	"Meta":UcsMoMeta("MemoryBufferUnitEnvStats", "memoryBufferUnitEnvStats", "buffer-unit-env-stats", _VersionMeta.Version131c, "OutputOnly", 0x0L, [], [u'memoryBufferUnitEnvStatsHist'], ["Get"], ["admin", "operations", "read-only"])
}
