...
PROPERTY_DICT = {
	...
	"Meta":UcsMoMeta("FabricFcMonSrcEp", "fabricFcMonSrcEp", "mon-src-[Name]", _VersionMeta.Version141i, "InputOutput", 0x7fL, [], [], ["Add", "Get", "Remove", "Set"], ["admin", "ext-san-config", "ext-san-policy"])
}
