...
PROPERTY_DICT = {
	...
	"VpUSBIdlePowerOptimizing":UcsPropertyMeta("VpUSBIdlePowerOptimizing", "vpUSBIdlePowerOptimizing", "string", _VersionMeta.Version142b, UcsPropertyMeta.ReadWrite, 0x10L, None, None, None, ["high-performance", "lower-idle-power", "platform-default", "platform-recommended"], ["0-4294967295"]),
	"Meta":UcsMoMeta("BiosVfUSBSystemIdlePowerOptimizingSetting", "biosVfUSBSystemIdlePowerOptimizingSetting", "USB-System-Idle-Power-Optimizing-Setting", _VersionMeta.Version142b, "InputOutput", 0x1fL, [], [], ["Get", "Set"], ["admin", "ls-compute", "ls-config", "ls-server", "ls-server-policy", "pn-policy"])
}
