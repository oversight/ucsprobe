...
PROPERTY_DICT = {
	...
	"Enacp":UcsPropertyMeta("Enacp", "enacp", "string", _VersionMeta.Version111j, UcsPropertyMeta.ReadOnly, None, None, None, None, ["consolidated", "virtual"], ["0-4294967295"]),
	"Id":UcsPropertyMeta("Id", "id", "byte", _VersionMeta.Version101e, UcsPropertyMeta.Naming, 0x4L, None, None, None, [], ["0-4294967295"]),
	...
	"NsSize":UcsPropertyMeta("NsSize", "nsSize", "ushort", _VersionMeta.Version111j, UcsPropertyMeta.ReadOnly, None, None, None, None, [], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("FabricPath", "fabricPath", "path-[Id]", _VersionMeta.Version101e, "InputOutput", 0x3fL, [], [u'dcxVc', u'fabricPathConn', u'fabricPathEp'], ["Get"], ["read-only"])
}
