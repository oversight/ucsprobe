...
PROPERTY_DICT = {
	...
	"Id":UcsPropertyMeta("Id", "id", "string", _VersionMeta.Version101e, UcsPropertyMeta.Naming, 0x8L, 1, 32, None, [], ["0-4294967295"]),
	...
	"LocalHost":UcsPropertyMeta("LocalHost", "localHost", "string", _VersionMeta.Version101e, UcsPropertyMeta.ReadOnly, None, None, None, None, [], ["0-4294967295"]),
	...
	"RemoteHost":UcsPropertyMeta("RemoteHost", "remoteHost", "string", _VersionMeta.Version101e, UcsPropertyMeta.ReadOnly, None, None, None, None, [], ["0-4294967295"]),
	"Rn":UcsPropertyMeta("Rn", "rn", "string", _VersionMeta.Version101e, UcsPropertyMeta.ReadOnly, 0x40L, 0, 256, None, [], ["0-4294967295"]),
	"Session":UcsPropertyMeta("Session", "session", "string", _VersionMeta.Version101e, UcsPropertyMeta.ReadOnly, None, None, None, None, ["ipmi", "local", "remote"], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("AaaShellLogin", "aaaShellLogin", "sh-login-[Name]-[Id]", _VersionMeta.Version101e, "InputOutput", 0xffL, [], [], [None], ["read-only"])
}
