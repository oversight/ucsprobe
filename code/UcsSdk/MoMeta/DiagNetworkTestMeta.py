...
PROPERTY_DICT = {
	...
	"SwitchId":UcsPropertyMeta("SwitchId", "switchId", "string", _VersionMeta.Version131c, UcsPropertyMeta.ReadWrite, 0x40L, None, None, None, ["A", "B", "NONE"], ["0-4294967295"]),
	"Type":UcsPropertyMeta("Type", "type", "string", _VersionMeta.Version131c, UcsPropertyMeta.ReadWrite, 0x80L, None, None, None, ["eth", "fc"], ["0-4294967295"]),
	"Meta":UcsMoMeta("DiagNetworkTest", "diagNetworkTest", "network-test-[Order]", _VersionMeta.Version131c, "InputOutput", 0xffL, [], [], ["Get"], ["admin", "pn-policy"])
}
