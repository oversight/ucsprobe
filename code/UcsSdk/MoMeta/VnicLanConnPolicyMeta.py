...
PROPERTY_DICT = {
	...
	"Meta":UcsMoMeta("VnicLanConnPolicy", "vnicLanConnPolicy", "lan-conn-pol-[Name]", _VersionMeta.Version211a, "InputOutput", 0x7fL, [], [u'vnicEther', u'vnicIScsiLCP', u'vnicIScsiNode'], ["Add", "Get", "Remove"], ["admin", "ls-config", "ls-network", "ls-server"])
}
