...
PROPERTY_DICT = {
	...
	"Type":UcsPropertyMeta("Type", "type", "string", _VersionMeta.Version221b, UcsPropertyMeta.ReadOnly, None, None, None, None, ["eth-flow-monitoring", "span", "unknown"], ["0-4294967295"]),
	"Meta":UcsMoMeta("FabricEthLanFlowMonitoring", "fabricEthLanFlowMonitoring", "eth-flow-monitoring", _VersionMeta.Version221b, "InputOutput", 0x1fL, [], [u'fabricEthFlowMonLan', u'fabricFlowMonDefinition', u'fabricFlowMonExporterProfile', u'fabricNetflowCollector', u'fabricNetflowMonExporter', u'fabricNetflowMonSession', u'fabricNetflowMonitor', u'fabricNetflowTimeoutPolicy'], [None], ["admin", "ext-lan-config", "ext-lan-policy"])
}
