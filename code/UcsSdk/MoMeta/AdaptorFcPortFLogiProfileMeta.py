...
PROPERTY_DICT = {
	...
	"Retries":UcsPropertyMeta("Retries", "retries", "string", _VersionMeta.Version101e, UcsPropertyMeta.ReadWrite, 0x4L, None, None, None, ["infinite"], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("AdaptorFcPortFLogiProfile", "adaptorFcPortFLogiProfile", "fc-port-flogi", _VersionMeta.Version101e, "InputOutput", 0x3fL, [], [], ["Get", "Set"], ["admin", "ls-config-policy", "ls-server-policy", "ls-storage"])
}
