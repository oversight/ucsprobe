...
class EquipmentIOCardFsm(ManagedObject):
	def __init__(self):
		ManagedObject.__init__(self,"EquipmentIOCardFsm")

	@staticmethod
	def ClassId():
		return "equipmentIOCardFsm"
	...
	CONST_CURRENT_FSM_FE_CONN = "FeConn"
	CONST_CURRENT_FSM_FE_PRESENCE = "FePresence"
	CONST_CURRENT_FSM_RESET_CMC = "ResetCmc"
	CONST_CURRENT_FSM_RESET_IOM = "ResetIom"
	CONST_CURRENT_FSM_MUX_OFFLINE = "muxOffline"
