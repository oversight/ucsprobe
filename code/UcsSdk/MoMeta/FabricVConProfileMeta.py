...
PROPERTY_DICT = {
	...
	"MezzMapping":UcsPropertyMeta("MezzMapping", "mezzMapping", "string", _VersionMeta.Version211a, UcsPropertyMeta.ReadWrite, 0x8L, None, None, None, ["linear-ordered", "linear-ordered-to-round-robin", "round-robin", "round-robin-to-linear-ordered"], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("FabricVConProfile", "fabricVConProfile", "vcon-profile-[Name]", _VersionMeta.Version111j, "InputOutput", 0xffL, [], [u'fabricVCon'], ["Add", "Get", "Remove", "Set"], ["admin", "ext-lan-policy", "ls-network", "ls-network-policy", "ls-server-policy", "ls-storage-policy"])
}
