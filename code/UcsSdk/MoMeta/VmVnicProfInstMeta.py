...
PROPERTY_DICT = {
	...
	"MaxPorts":UcsPropertyMeta("MaxPorts", "maxPorts", "ushort", _VersionMeta.Version111j, UcsPropertyMeta.ReadOnly, None, None, None, None, [], ["0-4294967295"]),
	"Name":UcsPropertyMeta("Name", "name", "string", _VersionMeta.Version111j, UcsPropertyMeta.Naming, 0x8L, None, None, """[\-\.:_a-zA-Z0-9]{1,31}""", [], ["0-4294967295"]),
	...
	"ProfDn":UcsPropertyMeta("ProfDn", "profDn", "string", _VersionMeta.Version111j, UcsPropertyMeta.ReadOnly, None, 0, 256, None, [], ["0-4294967295"]),
	"ProfileType":UcsPropertyMeta("ProfileType", "profileType", "string", _VersionMeta.Version221b, UcsPropertyMeta.ReadWrite, 0x20L, None, None, None, ["regular", "sla-only"], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("VmVnicProfInst", "vmVnicProfInst", "vnic-prof-[Name]", _VersionMeta.Version111j, "InputOutput", 0xffL, [], [u'vnicOProfileAlias', u'vnicProfileAlias'], ["Get"], ["read-only"])
}
