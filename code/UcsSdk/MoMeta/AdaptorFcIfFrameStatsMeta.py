...
PROPERTY_DICT = {
	...
	"Meta":UcsMoMeta("AdaptorFcIfFrameStats", "adaptorFcIfFrameStats", "fc-if-frame-stats", _VersionMeta.Version111j, "OutputOnly", 0x0L, [], [u'adaptorFcIfFrameStatsHist'], ["Get"], ["admin", "operations", "read-only"])
}
