...
PROPERTY_DICT = {
	...
	"Meta":UcsMoMeta("ComputeBladeInheritPolicy", "computeBladeInheritPolicy", "blade-inherit-[Name]", _VersionMeta.Version101e, "InputOutput", 0x1ffL, [], [], ["Add", "Get", "Remove", "Set"], ["admin", "pn-policy"])
}
