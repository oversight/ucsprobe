...
PROPERTY_DICT = {
	...
	"ErrValue":UcsPropertyMeta("ErrValue", "errValue", "string", _VersionMeta.Version221b, UcsPropertyMeta.ReadOnly, None, None, None, None, ["FAILURE", "SUCCESS"], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("BiosBootDev", "biosBootDev", "[Order]", _VersionMeta.Version101e, "InputOutput", 0x1fL, [], [], ["Get"], ["read-only"])
}
