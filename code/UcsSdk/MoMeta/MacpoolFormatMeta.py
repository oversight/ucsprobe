...
PROPERTY_DICT = {
	...
	"Format":UcsPropertyMeta("Format", "format", "string", _VersionMeta.Version101e, UcsPropertyMeta.Naming, 0x4L, None, None, """(([0-9a-fA-F][0-9a-fA-F]:){5}([0-9a-fA-F][0-9a-fA-F]))|0""", [], ["0-4294967295"]),
	"Mask":UcsPropertyMeta("Mask", "mask", "string", _VersionMeta.Version101e, UcsPropertyMeta.Naming, 0x8L, None, None, None, ["FF-FF-FF-FF-FF-Fx", "FF-FF-FF-FF-FF-xx", "FF-FF-FF-FF-Fx-xx", "FF-FF-FF-FF-xx-xx", "FF-FF-FF-Fx-xx-xx", "FF-FF-FF-xx-xx-xx", "FF-FF-Fx-xx-xx-xx", "FF-FF-xx-xx-xx-xx", "FF-Fx-xx-xx-xx-xx", "FF-xx-xx-xx-xx-xx", "Fx-xx-xx-xx-xx-xx"], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("MacpoolFormat", "macpoolFormat", "format-[Format]-[Mask]", _VersionMeta.Version101e, "InputOutput", 0x3fL, [], [], ["Get"], ["admin", "ext-lan-config", "ext-lan-policy", "ls-network", "ls-network-policy"])
}
