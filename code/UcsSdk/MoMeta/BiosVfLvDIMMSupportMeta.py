...
PROPERTY_DICT = {
	...
	"VpLvDDRMode":UcsPropertyMeta("VpLvDDRMode", "vpLvDDRMode", "string", _VersionMeta.Version131c, UcsPropertyMeta.ReadWrite, 0x10L, None, None, None, ["auto", "performance-mode", "platform-default", "platform-recommended", "power-saving-mode"], ["0-4294967295"]),
	"Meta":UcsMoMeta("BiosVfLvDIMMSupport", "biosVfLvDIMMSupport", "LvDIMM-Support", _VersionMeta.Version131c, "InputOutput", 0x1fL, [], [], ["Get", "Set"], ["admin", "ls-compute", "ls-config", "ls-server", "ls-server-policy", "pn-policy"])
}
