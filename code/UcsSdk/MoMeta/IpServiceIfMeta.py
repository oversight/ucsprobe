...
PROPERTY_DICT = {
	...
	"Port":UcsPropertyMeta("Port", "port", "uint", _VersionMeta.Version211a, UcsPropertyMeta.Naming, 0x8L, None, None, None, [], ["1-65535"]),
	...
	"Meta":UcsMoMeta("IpServiceIf", "ipServiceIf", "serv-ip-[Addr]-port-[Port]", _VersionMeta.Version211a, "InputOutput", 0x7fL, [], [], [None], ["admin"])
}
