...
PROPERTY_DICT = {
	...
	"Item":UcsPropertyMeta("Item", "item", "string", _VersionMeta.Version211a, UcsPropertyMeta.Naming, None, None, None, None, ["ReleaseAllOperationFsm", "ReleaseAllPolicyFsm", "ReleaseAllStorageFsm", "ReleaseManyOperationFsm", "ReleaseManyPolicyFsm", "ReleaseManyStorageFsm", "ReleaseOperationFsm", "ReleasePolicyFsm", "ReleaseStorageFsm", "ResolveAllOperationFsm", "ResolveAllPolicyFsm", "ResolveAllStorageFsm", "ResolveManyOperationFsm", "ResolveManyPolicyFsm", "ResolveManyStorageFsm", "nop"], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("PolicyPolicyScopeFsmTask", "policyPolicyScopeFsmTask", "task-[Item]", _VersionMeta.Version211a, "OutputOnly", 0x0L, [], [], [None], [""])
}
