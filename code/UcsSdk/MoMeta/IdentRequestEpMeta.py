...
PROPERTY_DICT = {
	...
	"ReqDn":UcsPropertyMeta("ReqDn", "reqDn", "string", _VersionMeta.Version211a, UcsPropertyMeta.ReadOnly, None, 0, 256, None, [], ["0-4294967295"]),
	"ReqId":UcsPropertyMeta("ReqId", "reqId", "uint", _VersionMeta.Version211a, UcsPropertyMeta.ReadOnly, None, None, None, None, [], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("IdentRequestEp", "identRequestEp", "IdentQ", _VersionMeta.Version211a, "InputOutput", 0xfL, [], [], [None], ["read-only"])
}
