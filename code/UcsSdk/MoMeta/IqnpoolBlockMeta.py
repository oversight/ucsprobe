...
PROPERTY_DICT = {
	...
	"From":UcsPropertyMeta("From", "from", "ushort", _VersionMeta.Version201m, UcsPropertyMeta.Naming, 0x4L, None, None, None, [], ["0-65535"]),
	...
	"Suffix":UcsPropertyMeta("Suffix", "suffix", "string", _VersionMeta.Version201m, UcsPropertyMeta.Naming, 0x20L, None, None, """[0-9a-zA-Z\.:-]{0,64}$""", [], ["0-4294967295"]),
	"To":UcsPropertyMeta("To", "to", "ushort", _VersionMeta.Version201m, UcsPropertyMeta.Naming, 0x40L, None, None, None, [], ["0-65535"]),
	"Meta":UcsMoMeta("IqnpoolBlock", "iqnpoolBlock", "block-[Suffix]-from-[From]-to-[To]", _VersionMeta.Version201m, "InputOutput", 0x7fL, [], [], ["Add", "Get", "Remove"], ["admin", "ls-storage-policy"])
}
