...
PROPERTY_DICT = {
	...
	"ConfigIssue":UcsPropertyMeta("ConfigIssue", "configIssue", "string", _VersionMeta.Version221b, UcsPropertyMeta.ReadWrite, 0x2L, None, None, None, ["Default Package Missing", "No Issues", "Versions Empty in Default Package"], ["0-4294967295"]),
	...
	"Name":UcsPropertyMeta("Name", "name", "string", _VersionMeta.Version221b, UcsPropertyMeta.ReadWrite, 0x10L, None, None, """[\-\.:_a-zA-Z0-9]{0,16}""", [], ["0-4294967295"]),
	...
	"SyncState":UcsPropertyMeta("SyncState", "syncState", "string", _VersionMeta.Version221b, UcsPropertyMeta.ReadWrite, 0x100L, None, None, None, ["Auto Acknowledge", "No Actions", "User Acknowledge"], ["0-4294967295"]),
	"Meta":UcsMoMeta("FirmwareAutoSyncPolicy", "firmwareAutoSyncPolicy", "fw-auto-sync", _VersionMeta.Version221b, "InputOutput", 0x1ffL, [], [u'faultInst'], ["Get", "Set"], ["admin"])
}
