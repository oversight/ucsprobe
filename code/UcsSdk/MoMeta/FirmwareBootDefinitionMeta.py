...
PROPERTY_DICT = {
	...
	"Meta":UcsMoMeta("FirmwareBootDefinition", "firmwareBootDefinition", "fw-boot-def", _VersionMeta.Version101e, "InputOutput", 0xfL, [], [u'firmwareBootUnit', u'firmwareUcscInfo'], ["Get"], ["admin"])
}
