...
PROPERTY_DICT = {
	...
	"Redundancy":UcsPropertyMeta("Redundancy", "redundancy", "string", _VersionMeta.Version101e, UcsPropertyMeta.ReadWrite, 0x10L, None, None, None, ["grid", "n+1", "non-redundant"], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("ComputePsuPolicy", "computePsuPolicy", "psu-policy", _VersionMeta.Version101e, "InputOutput", 0x7fL, [], [], ["Get", "Set"], ["admin", "pn-equipment", "pn-policy"])
}
