...
PROPERTY_DICT = {
	...
	"GenNum":UcsPropertyMeta("GenNum", "genNum", "uint", _VersionMeta.Version221b, UcsPropertyMeta.ReadOnly, None, None, None, None, [], ["0-4294967295"]),
	...
	"Meta":UcsMoMeta("ExtvmmVMNetworkSets", "extvmmVMNetworkSets", "vm-network-sets", _VersionMeta.Version221b, "InputOutput", 0xfL, [], [u'extvmmVMNetwork'], [None], ["admin", "ls-network", "ls-network-policy"])
}
