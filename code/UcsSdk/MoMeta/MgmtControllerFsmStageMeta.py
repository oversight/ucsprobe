...
PROPERTY_DICT = {
	...
	"Meta":UcsMoMeta("MgmtControllerFsmStage", "mgmtControllerFsmStage", "stage-[Name]", _VersionMeta.Version211a, "OutputOnly", 0x0L, [], [], [None], [""])
}
