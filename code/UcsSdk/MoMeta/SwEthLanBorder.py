...
class SwEthLanBorder(ManagedObject):
	def __init__(self):
		ManagedObject.__init__(self,"SwEthLanBorder")

	@staticmethod
	def ClassId():
		return "swEthLanBorder"
	...
	CONST_FSM_PREV_DEPLOY_UPDATE_VLAN_GROUPS = "DeployUpdateVlanGroups"
	...
	CONST_FSM_STATUS_DEPLOY_UPDATE_VLAN_GROUPS = "DeployUpdateVlanGroups"
	CONST_FSM_STATUS_NOP = "nop"
	CONST_SWITCH_ID_A = "A"
	CONST_SWITCH_ID_B = "B"
	CONST_SWITCH_ID_NONE = "NONE"
	CONST_UDLD_RECOVERY_ACTION_NONE = "none"
	CONST_UDLD_RECOVERY_ACTION_RESET = "reset"
