...
# Usage: watchUcsManagerEventsWithTimeout.py [options]
#
# Options:
...
def callback_timeout(mce):
	print 'Received an Event within timeout of ClassId: ' + str(mce.mo.classId)
...
if __name__ == "__main__":
	...
	try:
		...
		# Add an event handle "ev_all" to montitor the events generated by
		# UCS for any of the ClassIds within in a stipulated Time <timeoutSec>.
		ev_all = handle.AddEventHandler(timeoutSec = 30, 
